...
INSERT INTO `banners` (`bannerid`, `campaignid`, `active`, `contenttype`, `pluginversion`, `storagetype`, `filename`, `imageurl`, `htmltemplate`, `htmlcache`, `width`, `height`, `weight`, `seq`, `target`, `url`, `alt`, `status`, `bannertext`, `description`, `autohtml`, `adserver`, `block`, `capping`, `session_capping`, `compiledlimitation`, `acl_plugins`, `append`, `appendtype`, `bannertype`, `alt_filename`, `alt_imageurl`, `alt_contenttype`, `comments`, `updated`, `acls_updated`) VALUES (1, 1, 't', '', 0, 'html', '', '', 'ROS Publisher Banner No. 1', 'ROS Publisher Banner No. 1', 468, 60, 1, 0, '_blank', 'http://m3.net', '', '', '', 'HTML Banner 1', 't', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2006-11-06 12:00:21', '0000-00-00 00:00:00');
TRUNCATE TABLE  `campaigns`;
INSERT INTO `campaigns` (`campaignid`, `campaignname`, `clientid`, `views`, `clicks`, `conversions`, `expire`, `activate`, `active`, `priority`, `weight`, `target_impression`, `target_click`, `target_conversion`, `anonymous`, `companion`, `comments`, `revenue`, `revenue_type`, `updated`) VALUES (1, 'ROS Test Advertiser - Default Campaign', 1, 1000, -1, -1, '0000-00-00', '0000-00-00', 't', 5, 0, 100, 0, 0, 'f', 0, '', 10.0000, 1, '2006-11-06 11:57:30');
