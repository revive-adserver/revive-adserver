...
INSERT INTO `acls` (`bannerid`, `logical`, `type`, `comparison`, `data`, `executionorder`) VALUES (1,'and','Site:Channel','==','1',0),(1,'and','Site:Channel','==','2',1);
INSERT INTO `acls_channel` (`channelid`, `logical`, `type`, `comparison`, `data`, `executionorder`) VALUES (1,'and','Site:Pageurl','=~','example',0),(2,'and','Site:Referingpage','=~','refer.com',0);
INSERT INTO `ad_zone_assoc` (`ad_zone_assoc_id`, `zone_id`, `ad_id`, `priority`, `link_type`) VALUES (1,0,1,0,0),(11,1,1,0,1);
...
INSERT INTO `banners` (`bannerid`, `campaignid`, `active`, `contenttype`, `pluginversion`, `storagetype`, `filename`, `imageurl`, `htmltemplate`, `htmlcache`, `width`, `height`, `weight`, `seq`, `target`, `url`, `alt`, `status`, `bannertext`, `description`, `autohtml`, `adserver`, `block`, `capping`, `session_capping`, `compiledlimitation`, `acl_plugins`, `append`, `appendtype`, `bannertype`, `alt_filename`, `alt_imageurl`, `alt_contenttype`, `comments`, `arrival_capable`, `updated`, `acls_updated`) VALUES (1,1,'t','',0,'html','','','test 1','test 1',468,60,1,0,'_blank','http://www.m3.net','','','','targeted 100000 ','t','',0,0,0,'(MAX_checkSite_Channel(\'1\', \'==\')) and (MAX_checkSite_Channel(\'2\', \'==\'))','Site:Channel','',0,0,'','','','','f','2006-12-04 15:13:43','2007-01-08 13:28:07');
INSERT INTO `campaigns` (`campaignid`, `campaignname`, `clientid`, `views`, `clicks`, `conversions`, `expire`, `activate`, `active`, `priority`, `weight`, `target_impression`, `target_click`, `target_conversion`, `anonymous`, `companion`, `comments`, `revenue`, `revenue_type`, `updated`) VALUES (1,'Test Advertiser - Default Campaign',1,100000,-1,-1,'0000-00-00','0000-00-00','t',5,0,700,0,0,'f',0,'','0.0000',0,'2006-12-04 15:13:28');
INSERT INTO `channel` (`channelid`, `agencyid`, `affiliateid`, `name`, `description`, `compiledlimitation`, `acl_plugins`, `active`, `comments`, `updated`, `acls_updated`) VALUES (1,0,1,'Test Channel - page url','','MAX_checkSite_Pageurl(\'example\', \'=~\')','Site:Pageurl',1,'','0000-00-00 00:00:00','2007-01-08 12:09:17'),(2,0,1,'Test Channel - Referrer','Test Channel - referrer = www.referrer.com','MAX_checkSite_Referingpage(\'refer.com\', \'=~\')','Site:Referingpage',1,'','0000-00-00 00:00:00','2007-01-08 12:32:27');
...
INSERT INTO `trackers` (`trackerid`, `trackername`, `description`, `clientid`, `arrivalwindow`, `viewwindow`, `clickwindow`, `blockwindow`, `status`, `type`, `linkcampaigns`, `variablemethod`, `appendcode`, `updated`) VALUES (1,'Test Advertiser - Default Tracker','Test Tracker',1,0,0,2592000,0,4,1,'t','dom','','2007-01-05 15:11:42');
...
INSERT INTO `log_maintenance_statistics` (`log_maintenance_statistics_id`, `start_run`, `end_run`, `duration`, `adserver_run_type`, `search_run_type`, `tracker_run_type`, `updated_to`) VALUES (1, '1970-01-01 01:00:00', '1970-01-01 01:00:00', 0, 2, NULL, NULL, '1970-01-01 01:00:00');UPDATE `ad_zone_assoc` SET priority=0;
