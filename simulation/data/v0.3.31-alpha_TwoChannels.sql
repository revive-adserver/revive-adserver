...
INSERT INTO banners (bannerid, campaignid, active, contenttype, pluginversion, storagetype, filename, imageurl, htmltemplate, htmlcache, width, height, weight, seq, target, url, alt, status, bannertext, description, autohtml, adserver, block, capping, session_capping, compiledlimitation, acl_plugins, append, appendtype, bannertype, alt_filename, alt_imageurl, alt_contenttype, comments, updated, acls_updated) VALUES (1,1,'t','',0,'html','','','test 1','test 1',468,60,1,0,'_blank','http://www.openads.org','','','','targeted 100000 ','t','',0,0,0,'(MAX_checkSite_Channel(\'1\', \'==\')) and (MAX_checkSite_Channel(\'2\', \'==\'))','Site:Channel','',0,0,'','','','','2006-12-04 15:13:43','2007-01-08 13:28:07');
