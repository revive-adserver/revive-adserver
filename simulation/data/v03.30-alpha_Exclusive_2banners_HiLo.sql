...
INSERT INTO `campaigns` (`campaignid`, `campaignname`, `clientid`, `views`, `clicks`, `conversions`, `expire`, `activate`, `active`, `priority`, `weight`, `target_impression`, `target_click`, `target_conversion`, `anonymous`, `companion`, `comments`, `revenue`, `revenue_type`, `updated`) VALUES (1, 'Test Advertiser - Default Campaign', 1, 20000, -1, -1, '0000-00-00', '0000-00-00', 't', -1, 1, 0, 0, 0, 'f', 0, '', 0.0000, 0, '2006-11-27 13:47:27'),
(2, 'Test Advertiser - 2', 1, 20000, -1, -1, '0000-00-00', '0000-00-00', 't', 0, 1, 0, 0, 0, 'f', 0, '', 0.0000, 0, '2006-11-27 13:51:01');
