...
TRUNCATE TABLE `acls`;
--INSERT INTO `acls` (`bannerid`, `logical`, `type`, `comparison`, `data`, `executionorder`) VALUES (3, 'and', 'Site:Channel', '=~', '1', 0);

TRUNCATE TABLE `acls_channel`;
--INSERT INTO `acls_channel` (`channelid`, `logical`, `type`, `comparison`, `data`, `executionorder`) VALUES (1, 'and', 'Site:Pageurl', '=~', 'matteo', 0);
...
INSERT INTO `affiliates` (`affiliateid`, `agencyid`, `name`, `mnemonic`, `comments`, `contact`, `email`, `website`, `username`, `password`, `permissions`, `language`, `publiczones`, `last_accepted_agency_agreement`, `updated`) VALUES (1, 0, 'Matteo', '', '', 'Matteo', 'matteo@beccati.com', 'http://beccati.com', '', '', 0, '', 'f', '0000-00-00 00:00:00', '2007-02-06 16:54:38');
...
(1, 1, 't', 'txt', 0, 'txt', '', '', '', '', 0, 0, 1, 0, '', 'http://beccati.com/', '', '', 'Exclusive ad, campaign capped to 2, blocked for 2 hours', 'Exclusive ad, campaign capped to 2, blocked for 2 hours', 'f', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2007-02-06 16:56:17', '0000-00-00 00:00:00'),
(2, 2, 't', 'txt', 0, 'txt', '', '', '', '', 0, 0, 1, 0, '', 'http://beccati.com/', '', '', 'High (7) 300 impressions target', 'High (7) 300 impressions target', 'f', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2007-02-06 16:52:19', '0000-00-00 00:00:00'),
(3, 3, 't', 'txt', 0, 'txt', '', '', '', '', 0, 0, 1, 0, '', 'http://beccati.com/', '', '', 'High (5) 300 impressions target', 'High (5) 300 impressions target', 'f', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2007-02-06 16:53:26', '2007-02-06 16:57:37'),
(4, 4, 't', 'txt', 0, 'txt', '', '', '', '', 0, 0, 1, 0, '', 'http://beccati.com/', '', '', 'Low pri', 'Low pri', 'f', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2007-02-06 16:54:03', '0000-00-00 00:00:00');
...
(1, 'Matteo - Default Campaign', 1, -1, -1, -1, '0000-00-00', '0000-00-00', 't', -1, 1, 0, 0, 0, 'f', 0, '', 0.0000, 0, '2007-02-06 16:50:48', 7200, 2, 0),
(2, 'Matteo - Default Campaign 2', 1, 10000, -1, -1, '0000-00-00', '0000-00-00', 't', 7, 0, 300, 0, 0, 'f', 0, '', 0.0000, 0, '2007-02-06 16:51:52', 0, 0, 0),
(3, 'Matteo - Default Campaign 3', 1, -1, -1, -1, '0000-00-00', '0000-00-00', 't', 5, 0, 300, 0, 0, 'f', 0, '', 0.0000, 0, '2007-02-06 16:52:56', 0, 0, 0),
(4, 'Matteo - Default Campaign 4', 1, -1, -1, -1, '0000-00-00', '0000-00-00', 't', 0, 1, 0, 0, 0, 'f', 0, '', 0.0000, 0, '2007-02-06 16:53:43', 0, 0, 0);

TRUNCATE TABLE `channel`;
INSERT INTO `channel` (`channelid`, `agencyid`, `affiliateid`, `name`, `description`, `compiledlimitation`, `acl_plugins`, `active`, `comments`, `updated`, `acls_updated`) VALUES (1, 0, 0, 'PageURL', '', 'MAX_checkSite_Pageurl(''matteo'', ''=~'')', 'Site:Pageurl', 1, '', '0000-00-00 00:00:00', '2007-02-06 16:57:14');

TRUNCATE TABLE `clients`;
INSERT INTO `clients` (`clientid`, `agencyid`, `clientname`, `contact`, `email`, `clientusername`, `clientpassword`, `permissions`, `language`, `report`, `reportinterval`, `reportlastdate`, `reportdeactivate`, `comments`, `updated`) VALUES (1, 0, 'Matteo', 'Matteo', 'matteo@beccati.com', '', '', 0, '', 'f', 7, '2007-02-06', 't', '', '2007-02-06 16:48:58');
