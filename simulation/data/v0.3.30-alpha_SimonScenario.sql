...
--
-- Host: localhost
-- Generation Time: Dec 06, 2006 at 12:28 PM
...
(2, 'and', 'Site:Channel', '=~', '1', 0),
(3, 'and', 'Site:Channel', '=~', '1', 0);


TRUNCATE TABLE acls_channel;
INSERT INTO acls_channel (channelid, logical, type, comparison, data, executionorder) VALUES (1, 'and', 'Site:Pageurl', '=~', 'simon', 0);
...
INSERT INTO banners (bannerid, campaignid, active, contenttype, pluginversion, storagetype, filename, imageurl, htmltemplate, htmlcache, width, height, weight, seq, target, url, alt, status, bannertext, description, autohtml, adserver, block, capping, session_capping, compiledlimitation, acl_plugins, append, appendtype, bannertype, alt_filename, alt_imageurl, alt_contenttype, comments, updated, acls_updated) VALUES (1, 1, 't', '', 0, 'html', '', '', 'test 1', 'test 1', 468, 60, 1, 0, '_blank', 'http://www.openx.org', '', '', '', 'targeted 100000 ', 't', '', 0, 0, 0, '(MAX_checkSite_Channel(''1'', ''=~''))', 'Site:Channel', '', 0, 0, '', '', '', '', '2006-12-04 15:13:43', '2006-12-04 14:40:11'),
(2, 2, 't', '', 0, 'html', '', '', 'test2', 'test2', 468, 60, 1, 0, '_blank', 'http://www.openx.org', '', '', '', 'targeted 1000 ', 't', '', 0, 0, 0, '(MAX_checkSite_Channel(''1'', ''=~''))', 'Site:Channel', '', 0, 0, '', '', '', '', '2006-12-04 15:13:07', '2006-12-04 14:40:29'),
...
(2, 'Test Advertiser - 2', 1, 1000, -1, -1, '2000-01-01', '2000-01-01', 't', 5, 0, 1000, 0, 0, 'f', 0, '', 0.0000, 0, '2006-12-04 14:41:27'),
(3, 'tes3', 1, 1000000, -1, -1, '2000-01-01', '2000-01-01', 't', 5, 0, 100000, 0, 0, 'f', 0, '', 0.0000, 0, '2006-12-04 14:42:19'),
(4, 'ros1', 1, 100000, -1, -1, '2000-01-01', '2000-01-01', 't', 5, 0, 25000, 0, 0, 'f', 0, '', 0.0000, 0, '2006-12-04 14:44:19'),
(5, 'lp1', 1, -1, -1, -1, '2000-01-01', '2000-01-01', 't', 0, 1, 0, 0, 0, 'f', 0, '', 0.0000, 0, '2006-12-04 14:45:02');


TRUNCATE TABLE channel;
INSERT INTO channel (channelid, agencyid, affiliateid, name, description, compiledlimitation, acl_plugins, active, comments, acls_updated) VALUES (1, 0, 1, 'Test Channel - page url', '', 'MAX_checkSite_Pageurl(''simon'', ''=~'')', 'Site:Pageurl', 1, '', '2006-12-04 14:32:05');
