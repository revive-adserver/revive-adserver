...
(3, 3, 't', '', 0, 'html', '', '', 'TEST 2', 'TEST 2', 468, 60, 1, 0, '_blank', '', '', '', '', '', 't', '', 0, 0, 0, '', NULL, '', 0, 0, '', '', '', '', '2006-11-10 15:44:34', '0000-00-00 00:00:00');

TRUNCATE TABLE `campaigns`;
INSERT INTO `campaigns` (`campaignid`, `campaignname`, `clientid`, `views`, `clicks`, `conversions`, `expire`, `activate`, `active`, `priority`, `weight`, `target_impression`, `target_click`, `target_conversion`, `anonymous`, `companion`, `comments`, `revenue`, `revenue_type`, `updated`) VALUES (2, 'ROS Test Advertiser - Default Campaign', 1, 23000, -1, -1, '0000-00-00', '0000-00-00', 't', 10, 0, 100, 0, 0, 'f', 0, '', 0.0000, 0, '2006-11-10 15:43:10'),
(3, 'ROS Test Advertiser - Default Campaign2', 1, 23000, -1, -1, '0000-00-00', '0000-00-00', 't', 10, 0, 100, 0, 0, 'f', 0, '', 0.0000, 0, '2006-11-10 15:44:01');
