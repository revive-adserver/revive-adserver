 ...
 */
class OX_Plugins_DeliveryLog_Setup_Test extends UnitTestCase
{
     function OX_Plugins_DeliveryLog_Setup_Test()
    {
        $this->UnitTestCase();
    }
    ...
    function testGetDependencyOrderedPlugins()
    {
        Mock::generatePartial(
            'OX_Plugins_DeliveryLog_Setup',
            $mockSetup = 'OX_Plugins_DeliveryLog_Setup'.__CLASS__.__FUNCTION__,
    ...
    function testGetExtensionGroupComponentFromId()
    {
        ...
        $ret = OX_Plugins_DeliveryLog_Setup::getExtensionGroupComponentFromId('extensionName:groupName:componentName');
    ...
    function testGeneratePluginsCode()
    {
        ...
        $testDataDir = '/extensions/deliveryLog/tests/data/';
        $oSetup->setReturnValue('getFilePathToPlugin',
            MAX_PATH . $testDataDir . 'logBoo.delivery.php',
            array('extension1','group1','component1'));
        $oSetup->setReturnValue('getFilePathToPlugin',
            MAX_PATH . $testDataDir . 'logFoo.delivery.php',
            array('extension1','group1','component2'));
 ...
 *
 */
abstract class PluginTestComponentCommon extends Plugins_DeliveryLog_LogCommon
{
    ...
    function getBucketName() { return 'foo'; }
    function getTableBucketColumns() { return array(); }
}
