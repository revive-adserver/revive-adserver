...
$GLOBALS['phpAds_hlp_insert_delayed'] = "
        それがデータを挿入している時、".$phpAds_dbmsname." はテーブルをロックします。If have many visitors to your site, 
...
$GLOBALS['phpAds_hlp_language'] = "
        ".$phpAds_productname." が使用するべきデフォルト言語を指定します。
        この言語はデフォルトとして管理者および広告主インタフェースに使用されるでしょう。
        注意してください: 
...
$GLOBALS['phpAds_hlp_company_name'] = "
        この名前は ".$phpAds_productname." が電子メールの送信に使用します。
		";
...
$GLOBALS['phpAds_hlp_p3p_policy_location'] = "
        十分なプライバシーポリシーを使用したい場合、ポリシーの場所を指定することができます。
		";
...
$GLOBALS['phpAds_hlp_log_beacon'] = "
		...
		because a delivered banner doesn稚 always have to be displayed on the screen. 
		";
...
$GLOBALS['phpAds_hlp_block_adviews'] = "
		...
		to 300 seconds, ".$phpAds_productname." will only log AdViews if the same banner isn稚 already 
...
$GLOBALS['phpAds_hlp_block_adclicks'] = "
		...
		to 300 seconds, ".$phpAds_productname." will only log AdClicks if the visitor didn稚 click on the same 
...
$GLOBALS['phpAds_hlp_log_iponly'] = "
		...
		less space consuming IP address only. This option isn稚 available if the hostname isn't
...
$GLOBALS['phpAds_hlp_admin'] = "
        管理者のユーザー名を入力してください。With this username you can log into 
		the administrator interface.
		";
		
$GLOBALS['phpAds_hlp_admin_pw'] =
$GLOBALS['phpAds_hlp_admin_pw2'] = "
        管理者インターフェースへのログインに使用したいパスワードを入力てください。
