...
$GLOBALS['strMailHeader'] = "Egr. Sig. ".$clients[$i][contact].",\n";
$GLOBALS['strMailBannerStats'] = "ecco le statistiche dei banner per ".$clients[$i]["clientname"].":";
$GLOBALS['strMailFooter'] = 'Distinti saluti,\n   $phpAds_admin_fullname';
$GLOBALS['strMailNothingLeft'] = 'Tutte le visualizzazioni da Voi acquistate sono state eseguite, pertanto i Vostri banner sono stati disabilitati.\n\nSe desiderate acquistare altre visualizzazioni Vi preghiamo di contattarci.';
