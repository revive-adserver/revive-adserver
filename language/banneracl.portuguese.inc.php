<?
// portuguese doc file for Banner ACL administration
?>
<BR>
<table border="0" width="100%">
        <TR>
          ...
          <td bgcolor="#FFFFFF">Mostra o an&uacute;ncio apenas para uma regi&atilde;o
          ...
          <td bgcolor="#FFFFFF">Express&atilde;o coincidente com o navegador de
            um utilizador. Ex.: ^Mozilla/4.? ou ^MSIE/5.?</td>

          <td bgcolor="#FFFFFF">Mostra o an&uacute;ncio apenas para o navegador especificado</td>
                                </tr>
                                <tr>
          ...
          <td bgcolor="#FFFFFF">Mostra o an&uacute;ncio apenas no dia da semana determinado</td>
                                </tr>
                                <tr>
          ...
          <td bgcolor="#FFFFFF">Exibe o an&uacute;ncio apenas para os dom&iacute;nios
            determinados </td>
                                </tr>
                                <tr>
          ...
          <td bgcolor="#FFFFFF">Exibe o an&uacute;ncio apenas em determinadas p&aacute;ginas</td>
                                </tr>
                <tr>
          ...
          <td bgcolor="#FFFFFF">Mostra o an&uacute;ncio apenas nas horas determinadas</td>
                </tr>
                        </table>
                </TD>
        </TR>
</table>
<p>Por exemplo, se voc&ecirc; deseja que um an&uacute;ncio seja exibido apenas nos fins-de-semana,
...
Qualquer LCA
<? echo $strDeny; ?>
* seria suficiente para bloquear um an&uacute;ncio que n&atilde;o tenha um LCA
<? echo $strAllow; ?>
associado
<p>Para exibir o an&uacute;ncio entre 5 da tarde e 8 da noite:</p>
<ul>
  <li>Hora,
    <? echo $strAllow; ?>
    , argumento 17</li>
...
<?
// EOF poruguese doc file for Banner ACL administration
?>