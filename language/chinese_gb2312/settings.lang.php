...
/*                                                                      */
/* Translated by liaobin<liaobin@jite.net>                              */
/* Lastmodify    2002-1-9                                               */
/*                                                                      */
...
$GLOBALS['strDatabaseSettings']			= "数据库选择";
$GLOBALS['strAdminSettings']			= "管理员配置";
$GLOBALS['strAdvancedSettings']			= "高级配置";
$GLOBALS['strOtherSettings']			= "其他配置";
...
// Global
$GLOBALS['strChooseSection']			= "选择配置类别";
$GLOBALS['strDayFullNames'] 			= array("星期天","星期一","星期二","星期三","星期四","星期五","星期六");
