...
$GLOBALS[strMailHeader] = 'Dear ".$clients[$i]["contact"].",\n';
$GLOBALS[strMailBannerStats] = 'following you\'ll find the banner-statistics for ".$clients[$i]["clientname"].":';
$GLOBALS[strMailFooter] = 'Best,\n   $phpAds_admin_fullname';
$GLOBALS[strMailNothingLeft] = "you have no AdViews left on your account with us. Therefore, your banners have been disabled.\n\nIf you would like to acquire additional ad views, please feel free to contact us. We'd be glad to hear from you.";
