...
$GLOBALS['strMailHeader'] = 'Prezado ".$clients[$i]["contact"].",\n';
$GLOBALS['strMailBannerStats'] = 'seguem estatísitcas do banner de ".$clients[$i]["clientname"].":';
$GLOBALS['strMailFooter'] = 'Atenciosamente,\n   $phpAds_admin_fullname';
$GLOBALS['strMailNothingLeft'] = "você não tem mais Impressões restantes em sua conta publicitária conosco. Desta forma, seus banners serão desativados.\n\nSe voc6e deseja adquirir novas Impressões, por favor, entre em contato. Ficaremos felizes em ouví-lo.\n\nOs banners ficarão armazenados por um período de 30 dias. Após esse período eles seerão deletados e será necessário o envio de novas peças publicitárias.";
