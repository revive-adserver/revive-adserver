...
$GLOBALS['phpAds_hlp_dbuser'] = "
        Spezifiziere den Usernamen, der von phpPgAds genutzt werden muß, um auf den MySQL Datenbank-Server zuzugreifen.
		";
		
$GLOBALS['phpAds_hlp_dbpassword'] = "
        Spezifiziere das Passwort, das von phpPgAds genutzt werden muß, um auf den MySQL Datenbank-Server zuzugreifen.
		";
