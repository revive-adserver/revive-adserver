...
$GLOBALS[strMailHeader] = "Drogi(a) ".$clients[$i][contact].",\n";
$GLOBALS[strMailBannerStats] = "Poni¿ej znajduje siê statystyka dla ".$clients[$i]["clientname"].":";
$GLOBALS[strMailFooter] = "Z pozdrowieniami,\n   $phpAds_admin_fullname";
$GLOBALS[strMailNothingLeft] = 'Nie posiadasz ju¿ op³aconych wy¶wietleñ na swoim koncie. Twoje bannery zosta³y wy³±czone.\n\nJe¿eli porzebujesz dodatkowych wy¶wietleñ prosze sie z nami skontaktowaæ. Bardzo chêtnie bedzie to nam slyszeæ.\n';
