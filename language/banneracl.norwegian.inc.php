...
Legg merke til at den siste posten trenger ikke å være &quot;Ukedag&quot;. Hvilken som helst <? echo $strDeny; ?> *
ACL vil være nok til å hindre banner hvis en tilordnet <? echo $strAllow; ?> ikke allerede er matchet.

<p>For å vise et banner mellom kl 17 og 20:</p>
<ul>
    <li>Tid, <? echo $strAllow; ?>, argument 17</li>  (17:00 - 17:59)
    <li>Tid, <? echo $strAllow; ?>, argument 18</li>  (18:00pm - 18:59)
