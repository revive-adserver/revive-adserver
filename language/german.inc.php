...
$GLOBALS['strMailBannerStats'] = "Hiermit senden wir Ihnen die Banner-Statistik fuer ".$clients[$i]["clientname"].":";
$GLOBALS['strMailFooter'] = "Mit freundlichen Gruessen\n\n   $phpAds_admin_fullname";
$GLOBALS['strMailNothingLeft'] = 'Die AdViews Ihrer Banner haben das vorgegebene Ziel erreicht. Ihre Banner wurden deshalb deaktiviert.\n\nWenn Sie die Kampagne weiterhin fortsetzen moechten, setzen Sie sich bitte mit uns in Verbindung.\n\nWir freuen uns auf Ihre Antwort.';
