...
$GLOBALS['strMailHeader'] = "Kedves ".$clients[$i]["contact"].",\n";
$GLOBALS['strMailBannerStats'] = "a következöekben megtalálja a banner-statisztikát a ".$clients[$i]["clientname"]."-hoz :";
$GLOBALS['strMailFooter'] = "Tisztelettel,\n   $phpAds_admin_fullname";
$GLOBALS['strMailNothingLeft'] = "Nincs több bannermegjelenítése. Emiatt a bannerek megjelenítése ki lett kapcsolva.\n\n Ha szeretne több bannermegjelenítést megrendelni, kérjük lépjen kapcsolatba velünk!";
