    ...
    */
    function call()
    {
        ...
        if ($data !== false) {
            ...
            // If the function returns a "known" error, then use the old cache for the next cache lifetime
            if ($array['result'] === CACHE_LITE_FUNCTION_ERROR) {
                unset($data, $array, $output, $result);
