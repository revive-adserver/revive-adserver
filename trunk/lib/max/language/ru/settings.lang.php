...
$GLOBALS['strNotSamePasswords']			= "Пароли не совпадают";
...
$GLOBALS['strGeotargeting']                     = "Гео-таргетинг";
...
$GLOBALS['strAdminEmailHeaders']		= "Добавлять в каждое письмо заголовок message sent by ' . ";
...
$GLOBALS['strOpenadsIdYour'] = "Ваш ".MAX_PRODUCT_NAME." ID";
...
$GLOBALS['strInstallIntro'] = "Добро пожаловать в <a href='http://MAX_PRODUCT_URL' target='_blank'><strong>".MAX_PRODUCT_NAME."</strong></a>! Скоро вы станете частью крупнейшего рекламного сообщества в сети Интернет.\n<p>Мы очень старались сделать процесс инсталляции и обновления максимально простым. Следуйте инструкциям на экране, если вам понадобится помощь - посетите страничку <a href='http://MAX_PRODUCT_DOCSURL' target='_blank'><strong></strong></a>.</p>\n<p>если у вас останутся вопросы после прочтения документации - обратитесь к разделу <a href='http://MAX_PRODUCT_URL/support/overview.html' target='_blank'><strong></strong></a> нашего веб-сайта, а также к <a href='http://MAX_PRODUCT_FORUMURL' target='_blank'><strong>форумам </strong></a>.</p>\n<p>Спасибо, что вы выбрали ".MAX_PRODUCT_NAME.".</p>";
...
$GLOBALS['strTermsTitle'] = "Лицензионная информация";
$GLOBALS['strPolicyTitle'] = "Политика Óти и использования личных данных";
$GLOBALS['strPolicyIntro'] = "Пожалуйста, прочтите Политику Óти и использования личных данных для продолжения инсталляции.";
$GLOBALS['strDbSetupTitle'] = "Настройки БД";
$GLOBALS['strDbUpgradeIntro'] = "Ниже указаны данные для подключения к БД текущей инсталляции ".MAX_PRODUCT_NAME.". проверьте их, пожалуйста. Когда вы нажмете кнопку \"продолжить\", ".MAX_PRODUCT_NAME." произведет обновление структуры ваших данных. Пожалуйста, убедитесь, что у вас есть актуальная резервная копия ваших данных.";
$GLOBALS['strOaUpToDate'] = "Файловая структура и схема данных вашей инсталляции не нуждаются в обновлении. Нажмите \"продолжить\" для перехода в À панель.";
...
$GLOBALS['strDbSuccessIntro'] = "Была создана БД для ".MAX_PRODUCT_NAME.". Нажмите кнопку \"Продолжить\" для Ñ настроек Éя и доставки баннеров.";
...
$GLOBALS['strImageDirLockedDetected'] = "<b>папка для </b>недоступна для записи. <br>Необходимо изменить настройки доступа, или создать папку.";
...
$GLOBALS['strUserlogEmail'] = "Протоколироватьвсе исходящие сообщения электронной почты";
$GLOBALS['strTimezoneInformation'] = "Информация о часовом поясе (изменения скажутся на статистике)";
$GLOBALS['strTimezone'] = "þасовой пояс";
$GLOBALS['strTimezoneEstimated'] = "Выбранный часовой пояс";
$GLOBALS['strTimezoneGuessedValue'] = "þасовой пояс сервера в PHP настроен некорректно";
...
$GLOBALS['strLoginSettingsIntro'] = "Для продолжения процесса обновления введите Å логин и пароль";
$GLOBALS['strAdminSettingsTitle'] = "Ваш аккаунт администратора";
$GLOBALS['strAdminSettingsIntro'] = "Ê аккаунт используется в MAX_PRODUCT_NAME для изменения настроек, просмотра статистики и т.п. Пожалуйста, заполните поля \"логин\", \"пароль\" и \"адрес электронной почты\".";
...
$GLOBALS['strDemoDataIntro'] = "В БД ".MAX_PRODUCT_NAME." могут быть Îы демо-данные, для того, чтобы помочь вам освоится с программой. Будут загружены и настроены основные типы баннеров, а также несколько демо-кампаний. Мы очень рекомендуем использовать демо-данные для новых инсталляций.";
...
$GLOBALS['strWebPath'] = "Глобальные пути доступа сервера ";
...
$GLOBALS['strInventory'] = "Éе";
$GLOBALS['strShowCampaignInfo'] = "Показывать дополнительную информацию на странице <i>обзора </i>";
$GLOBALS['strShowBannerInfo'] = "Показывать дополнительную информацию на странице <i>обзора </i>";
$GLOBALS['strShowCampaignPreview'] = "Показывать превью баннеров на странице <i>обзора </i>";
...
$GLOBALS['strGUIShowMatchingBanners'] = "Показывать баннеры на странице <i>Связанные </i>";
$GLOBALS['strGUIShowParentCampaigns'] = "Показывать кампании на странице <i>Связанные </i>";
...
$GLOBALS['strSniff'] = "Извлекать информацию о È браузере и ОС при помощи phpSniff";
...
$GLOBALS['strWarnLimitDaysErr'] = "þисло дней должно быть положительным целым числом";
