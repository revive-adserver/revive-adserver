...
if(typeof org.openx == "undefined") org.openx = new Object();
if(typeof org.openx.util == "undefined") org.openx.util = new Object();
if(typeof org.openx.SWFObjectUtil == "undefined") org.openx.SWFObjectUtil = new Object();
org.openx.SWFObject = function(swf, id, w, h, ver, c, quality, xiRedirectUrl, redirectUrl, detectKey) {
	...
	if(ver) { this.setAttribute('version', new org.openx.PlayerVersion(ver.toString().split("."))); }
