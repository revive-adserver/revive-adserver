...
--
-- Create schema maxv0331alphapr3
--

-- CREATE DATABASE IF NOT EXISTS maxv0331alphapr3;
-- USE maxv0331alphapr3;
...
INSERT INTO `ox_ad_zone_assoc` (`ad_zone_assoc_id`,`zone_id`,`ad_id`,`priority`,`link_type`) VALUES 
 (1,0,1,0,0),
 (2,0,2,0,0),
 (3,0,3,0,0),
 (4,1,1,0,1),
...
INSERT INTO `ox_affiliates` (`affiliateid`,`agencyid`,`name`,`mnemonic`,`comments`,`contact`,`email`,`website`,`username`,`password`,`permissions`,`language`,`publiczones`,`last_accepted_agency_agreement`,`updated`) VALUES 
 (1,0,'Agency Publisher 1','Agenc','','Andrew Hill','andrew.hill@openads.org','http://85.221.229.114:1280',NULL,'',127,'','f',NULL,'2008-08-28 12:21:43');
...
INSERT INTO `ox_banners` (`bannerid`,`campaignid`,`active`,`contenttype`,`pluginversion`,`storagetype`,`filename`,`imageurl`,`htmltemplate`,`htmlcache`,`width`,`height`,`weight`,`seq`,`target`,`url`,`alt`,`status`,`bannertext`,`description`,`autohtml`,`adserver`,`block`,`capping`,`session_capping`,`compiledlimitation`,`acl_plugins`,`append`,`appendtype`,`bannertype`,`alt_filename`,`alt_imageurl`,`alt_contenttype`,`comments`,`updated`,`acls_updated`) VALUES 
 (1,1,'t','',0,'html','','','Test HTML Banner!','Test HTML Banner!',468,60,1,0,'','','','','','Test HTML Banner!','t','',0,0,0,'',NULL,'',0,0,'','','','','2008-08-28 12:04:52','0000-00-00 00:00:00'),
 (2,2,'t','',0,'html','','','html test banner','html test banner',468,60,1,0,'','https://developer.openx.org/','','','','test banner','t','max',0,0,0,'',NULL,'',0,0,'','','','','2008-08-28 12:05:42','0000-00-00 00:00:00'),
 (3,3,'t','gif',0,'sql','468x60.gif','','','',468,60,1,0,'','https://developer.openx.org/','alt text','','','sample gif banner','f','',0,0,0,'',NULL,'',0,0,'','','','','2008-08-28 12:18:37','0000-00-00 00:00:00');
...
INSERT INTO `ox_campaigns` (`campaignid`,`campaignname`,`clientid`,`views`,`clicks`,`conversions`,`expire`,`activate`,`active`,`priority`,`weight`,`target_impression`,`target_click`,`target_conversion`,`anonymous`,`companion`,`comments`,`revenue`,`revenue_type`,`updated`) VALUES 
 (1,'Advertiser 1 - Default Campaign',1,-1,-1,-1,'2008-07-01','0000-00-00','f',0,1,0,0,0,'f',0,'','0.0000',0,'2008-08-28 12:02:41'),
 (2,'test campaign',1,-1,-1,-1,'0000-00-00','0000-00-00','t',0,1,0,0,0,'f',0,'','0.0000',0,'2008-08-28 12:03:35'),
 (3,'campaign 2 (gif)',1,-1,-1,-1,'0000-00-00','0000-00-00','t',0,1,0,0,0,'f',0,'','0.0000',0,'2008-08-28 12:04:04');
...
INSERT INTO `ox_clients` (`clientid`,`agencyid`,`clientname`,`contact`,`email`,`clientusername`,`clientpassword`,`permissions`,`language`,`report`,`reportinterval`,`reportlastdate`,`reportdeactivate`,`comments`,`updated`) VALUES 
 (1,0,'Advertiser 1','advertiser','example@example.com','advertiser','02452e3484c42211b1c2884ad9b60c93',187,'','f',7,'2008-08-28','t','','2008-08-28 12:01:43');
CREATE TABLE `ox_data_intermediate_ad` (
  ...
  `total_num_items` int(10) unsigned NOT NULL default '0',
  `updated` datetime NOT NULL,
...
CREATE TABLE `ox_data_summary_ad_hourly` (
  ...
  `total_num_items` int(10) unsigned default NULL,
...
INSERT INTO `ox_log_maintenance_priority` (`log_maintenance_priority_id`,`start_run`,`end_run`,`operation_interval`,`duration`,`run_type`,`updated_to`) VALUES 
 (1,'2008-08-28 12:04:52','2008-08-28 12:04:52',60,0,0,'2008-08-28 12:59:59'),
 (2,'2008-08-28 12:05:42','2008-08-28 12:05:42',60,0,0,'2008-08-28 12:59:59'),
 (3,'2008-08-28 12:18:37','2008-08-28 12:18:37',60,0,0,'2008-08-28 12:59:59');
...
CREATE TABLE `ox_plugins_channel_delivery_domains` (
  ...
  KEY `domain_name` (`domain_name`(100))
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `ox_preference` (
  ...
  `more_reports` varchar(1) NOT NULL default 't',
  `gui_column_id` text,
...
INSERT INTO `ox_preference` (`agencyid`,`config_version`,`my_header`,`my_footer`,`my_logo`,`language`,`name`,`company_name`,`override_gd_imageformat`,`begin_of_week`,`percentage_decimals`,`type_sql_allow`,`type_url_allow`,`type_web_allow`,`type_html_allow`,`type_txt_allow`,`banner_html_auto`,`admin`,`admin_pw`,`admin_fullname`,`admin_email`,`warn_admin`,`warn_agency`,`warn_client`,`warn_limit`,`admin_email_headers`,`admin_novice`,`default_banner_weight`,`default_campaign_weight`,`default_banner_url`,`default_banner_destination`,`client_welcome`,`client_welcome_msg`,`publisher_welcome`,`publisher_welcome_msg`,`content_gzip_compression`,`userlog_email`,`gui_show_campaign_info`,`gui_show_campaign_preview`,`gui_campaign_anonymous`,`gui_show_banner_info`,`gui_show_banner_preview`,`gui_show_banner_html`,`gui_show_matching`,`gui_show_parents`,`gui_hide_inactive`,`gui_link_compact_limit`,`gui_header_background_color`,`gui_header_foreground_color`,`gui_header_active_tab_color`,`gui_header_text_color`,`gui_invocation_3rdparty_default`,`qmail_patch`,`updates_enabled`,`updates_cache`,`updates_timestamp`,`updates_last_seen`,`allow_invocation_plain`,`allow_invocation_plain_nocookies`,`allow_invocation_js`,`allow_invocation_frame`,`allow_invocation_xmlrpc`,`allow_invocation_local`,`allow_invocation_interstitial`,`allow_invocation_popup`,`allow_invocation_clickonly`,`auto_clean_tables`,`auto_clean_tables_interval`,`auto_clean_userlog`,`auto_clean_userlog_interval`,`auto_clean_tables_vacuum`,`autotarget_factor`,`maintenance_timestamp`,`compact_stats`,`statslastday`,`statslasthour`,`default_tracker_status`,`default_tracker_type`,`default_tracker_linkcampaigns`,`publisher_agreement`,`publisher_agreement_text`,`publisher_payment_modes`,`publisher_currencies`,`publisher_categories`,`publisher_help_files`,`publisher_default_tax_id`,`publisher_default_approved`,`more_reports`,`gui_column_id`,`gui_column_requests`,`gui_column_impressions`,`gui_column_clicks`,`gui_column_ctr`,`gui_column_conversions`,`gui_column_conversions_pending`,`gui_column_sr_views`,`gui_column_sr_clicks`,`gui_column_revenue`,`gui_column_cost`,`gui_column_bv`,`gui_column_num_items`,`gui_column_revcpc`,`gui_column_costcpc`,`gui_column_technology_cost`,`gui_column_income`,`gui_column_income_margin`,`gui_column_profit`,`gui_column_margin`,`gui_column_erpm`,`gui_column_erpc`,`gui_column_erps`,`gui_column_eipm`,`gui_column_eipc`,`gui_column_eips`,`gui_column_ecpm`,`gui_column_ecpc`,`gui_column_ecps`,`gui_column_epps`,`instance_id`) VALUES 
 (0,'0.300',NULL,NULL,NULL,'english',NULL,'mysite.com',NULL,1,2,'t','t','f','t','t','t','openx','7a89a595cfc6cb85480202a143e37d2e','Your Name','your@email.com','t','t','t',100,NULL,'t',1,1,NULL,NULL,'t',NULL,'t',NULL,'f','t','t','f','f','t','t','f','t','f','f',50,'','','','',0,'f','t',NULL,0,NULL,'f','t','t','f','f','t','t','t','t','f',5,'f',5,'t',-1,1219915166,'t','0000-00-00',0,1,1,'f','f',NULL,NULL,NULL,NULL,NULL,'f','f','t',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2e6d67b44c5ee9c52c91b3ae87bfe91f3af65668');
...
INSERT INTO `ox_session` (`sessionid`,`sessiondata`,`lastused`) VALUES 
 ('8054176a2bb9acc205f3b84768e89d05','a:6:{s:8:\"usertype\";i:1;s:8:\"loggedin\";s:1:\"t\";s:8:\"agencyid\";i:0;s:8:\"username\";s:5:\"openx\";s:12:\"update_check\";b:0;s:5:\"prefs\";a:8:{s:20:\"advertiser-index.php\";a:4:{s:12:\"hideinactive\";b:0;s:9:\"listorder\";s:0:\"\";s:14:\"orderdirection\";s:0:\"\";s:5:\"nodes\";a:1:{s:7:\"clients\";a:1:{i:1;a:2:{s:6:\"expand\";b:1;s:9:\"campaigns\";a:3:{i:1;a:1:{s:6:\"expand\";b:1;}i:2;a:1:{s:6:\"expand\";b:1;}i:3;a:1:{s:6:\"expand\";b:1;}}}}}}s:24:\"advertiser-campaigns.php\";a:1:{i:1;a:4:{s:12:\"hideinactive\";b:0;s:9:\"listorder\";s:0:\"\";s:14:\"orderdirection\";s:0:\"\";s:5:\"nodes\";s:0:\"\";}}s:17:\"campaign-zone.php\";a:2:{s:9:\"listorder\";s:4:\"name\";s:14:\"orderdirection\";s:2:\"up\";}s:19:\"affiliate-index.php\";a:3:{s:9:\"listorder\";s:0:\"\";s:14:\"orderdirection\";s:0:\"\";s:5:\"nodes\";s:1:\"1\";}s:16:\"zone-include.php\";a:6:{s:12:\"hideinactive\";b:0;s:11:\"showbanners\";b:1;s:13:\"showcampaigns\";b:0;s:9:\"listorder\";s:4:\"name\";s:14:\"orderdirection\";s:2:\"up\";s:4:\"view\";s:9:\"placement\";}s:23:\"advertiser-trackers.php\";a:2:{s:9:\"listorder\";s:0:\"\";s:14:\"orderdirection\";s:0:\"\";}s:21:\"tracker-campaigns.php\";a:3:{s:12:\"hideinactive\";b:0;s:9:\"listorder\";s:0:\"\";s:14:\"orderdirection\";s:0:\"\";}s:21:\"tracker-variables.php\";a:1:{s:9:\"trackerid\";s:1:\"1\";}}}','2008-08-28 12:43:09');
...
INSERT INTO `ox_trackers` (`trackerid`,`trackername`,`description`,`clientid`,`viewwindow`,`clickwindow`,`blockwindow`,`status`,`type`,`linkcampaigns`,`variablemethod`,`appendcode`,`updated`) VALUES 
 (1,'Sample Tracker','',1,0,0,0,4,1,'f','js','','2008-08-28 12:41:53');
...
INSERT INTO `ox_variables` (`variableid`,`trackerid`,`name`,`description`,`datatype`,`purpose`,`reject_if_empty`,`is_unique`,`unique_window`,`variablecode`,`hidden`,`updated`) VALUES 
 (1,1,'boo','Sample number','numeric',NULL,0,0,0,'var boo = \'%%BOO_VALUE%%\'','f','2008-08-28 12:43:01'),
 (2,1,'foo','Sample string','string',NULL,0,0,0,'var foo = \'%%FOO_VALUE%%\'','f','2008-08-28 12:43:01');
...
INSERT INTO `ox_zones` (`zoneid`,`affiliateid`,`zonename`,`description`,`delivery`,`zonetype`,`category`,`width`,`height`,`ad_selection`,`chain`,`prepend`,`append`,`appendtype`,`forceappend`,`inventory_forecast_type`,`comments`,`cost`,`cost_type`,`cost_variable_id`,`technology_cost`,`technology_cost_type`,`updated`,`block`,`capping`,`session_capping`) VALUES 
 (1,1,'Publisher 1 - Default','',0,3,'',468,60,'','','','',0,'f',0,'','0.0000',0,NULL,NULL,NULL,'2008-08-28 12:22:36',0,0,0),
 (2,1,'Agency Publisher 1 - Default','',0,3,'',468,60,'','','','',0,'f',0,'','0.0000',0,NULL,NULL,NULL,'2008-08-28 12:23:33',0,0,0);
