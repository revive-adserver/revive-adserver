...
+---------------------------------------------------------------------------+
$Id: Data_bkt_m_backup.php 25650 2008-09-12 17:43:39Z andrew.hill $
*/

require_once MAX_PATH.'/lib/max/Dal/DataObjects/DB_DataObjectCommon.php';

/**
 * DB_DataObject for data_bkt_m_backup
 *
 * @package    Plugin
...
class DataObjects_Data_bkt_m_backup extends DB_DataObjectCommon
{
    ...
    public $primary_creative_id;             // MEDIUMINT(9) => openads_mediumint => 129
