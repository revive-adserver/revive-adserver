...
+---------------------------------------------------------------------------+
$Id: adviewnocookies.plugin.php 3312 2005-06-09 11:41:05Z andrew $
*/
 ...
 *
 */
class Plugins_InvocationTags_adviewnocookies_adviewnocookies extends Plugins_InvocationTags
{
    /**
    ...
    function getName()
    {
        return MAX_Plugin_Translation::translate('No Cookie Image Tag', $this->module, $this->package);
    }
