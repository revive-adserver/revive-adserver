...
+---------------------------------------------------------------------------+
$Id: InvocationTagsOptions.php 6108 2006-11-24 11:34:58Z andrew@m3.net $
*/
...
class Plugins_InvocationTagsOptions
{
    ...
    function popunder()
    {
        ...
        $option .= "<td width='370'><input type='radio' name='popunder' value='0'".
             ...
             "<img src='images/icon-popup-over.gif' align='absmiddle'>&nbsp;".MAX_Plugin_Translation::translate('Pop-up', 'invocationTags')."<br />";
