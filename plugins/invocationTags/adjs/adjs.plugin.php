...
+---------------------------------------------------------------------------+
$Id: adjs.plugin.php 6205 2006-12-04 19:16:21Z chris@m3.net $
*/
...
class Plugins_InvocationTags_adjs_adjs extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return MAX_Plugin_Translation::translate('Javascript Tag', $this->module, $this->package);
    }
