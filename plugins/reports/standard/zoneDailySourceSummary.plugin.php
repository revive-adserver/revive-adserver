...
+---------------------------------------------------------------------------+
$Id:zoneDailySourceSummary.plugin.php 114 2006-07-19 12:15:00Z james.easterby@m3.net $
*/
...
class Plugins_Reports_Standard_ZoneDailySourceSummary extends Plugins_ExcelReports
{
    ...
    function initInfo()
    {
        $this->_name = 'Zone Daily Source Summary';
    ...
    function execute($zoneScope, $oDaySpan, $reslimit)
    {
        ...
        $this->addDailySourceEffectivenessSheet();
     ...
     */
    function addDailySourceEffectivenessSheet()
    {
        $headers = array(
            'Day' => 'date',
            'Source' => 'text',
        ...
        $days_data = $this->dal->getEffectivenessForZoneByDaySource($this->_zoneId, $this->_daySpan, $this->_reslimit);
        $days_display = $this->prepareDailySourceEffectivenessForDisplay($days_data);

        $this->createSubReport('Daily Source Breakdown', $headers, $days_display);
    }
