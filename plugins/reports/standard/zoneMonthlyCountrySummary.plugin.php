...
+---------------------------------------------------------------------------+
$Id:zoneMonthlyCountrySummary.plugin.php 114 2006-07-19 12:15:00Z james.easterby@m3.net $
*/
...
class Plugins_Reports_Standard_ZoneMonthlyCountrySummary extends Plugins_ExcelReports
{
    /* @var int */
    var $_start_month;
    ...
    function initInfo()
    {
        $this->_name = 'Zone Monthly Country Summary';
    ...
    function execute($zoneScope, $start_month, $end_month, $reslimit)
    {
        ...
        $this->addMonthlyCountryEffectivenessSheet();
    ...
    /**
     * Adds a worksheet to the report containing views and clicks for each month/country.
     */
    function addMonthlyCountryEffectivenessSheet()
    {
        $headers = array(
            'Month' => 'date',
            'Country' => 'text',
        ...
        $months_data = $this->dal->getEffectivenessForZoneByMonthCountry($this->_zoneId, $this->_start_month, $this->_end_month, $this->_reslimit);
        $months_display = $this->prepareMonthlyCountryEffectivenessForDisplay($months_data);

        $this->createSubReport('Monthly Country Breakdown', $headers, $months_display);
    }
