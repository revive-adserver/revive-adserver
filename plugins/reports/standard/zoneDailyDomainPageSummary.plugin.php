...
+---------------------------------------------------------------------------+
$Id:zoneDailyDomainPageSummary.plugin.php 114 2006-07-19 12:15:00Z james.easterby@m3.net $
*/
...
class Plugins_Reports_Standard_ZoneDailyDomainPageSummary extends Plugins_ExcelReports
{
    /* @var DaySpan */
    var $_daySpan;
    ...
    function initInfo()
    {
        $this->_name = 'Zone Daily Domain Page Summary';
    ...
    function execute($zoneScope, $oDaySpan, $reslimit)
    {
        ...
        $this->addDailyDomainPageEffectivenessSheet();
     ...
     */
    function addDailyDomainPageEffectivenessSheet()
    {
        $headers = array(
            'Day' => 'date',
            'Domain' => 'text',
        ...
        $days_data = $this->dal->getEffectivenessForZoneByDayDomainPage($this->_zoneId, $this->_daySpan, $this->_reslimit);
        $days_display = $this->prepareDailyDomainPageEffectivenessForDisplay($days_data);

        $this->createSubReport('Daily Domain Page Breakdown', $headers, $days_display);
    }
