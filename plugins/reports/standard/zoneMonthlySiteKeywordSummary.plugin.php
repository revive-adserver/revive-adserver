...
+---------------------------------------------------------------------------+
$Id:zoneMonthlySiteKeywordSummary.plugin.php 114 2006-07-19 12:15:00Z james.easterby@m3.net $
*/
...
class Plugins_Reports_Standard_ZoneMonthlySiteKeywordSummary extends Plugins_ExcelReports
{
    /* @var int */
    var $_start_month;
    ...
    function initInfo()
    {
        $this->_name = 'Zone Monthly Site Keyword Summary';
    ...
    function execute($zoneScope, $start_month, $end_month, $reslimit)
    {
        ...
        $this->addMonthlySiteKeywordEffectivenessSheet();
    ...
    /**
     * Adds a worksheet to the report containing views and clicks for each day/site/keyword.
     */
    function addMonthlySiteKeywordEffectivenessSheet()
    {
        $headers = array(
            'Month' => 'date',
            'Site' => 'text',
        ...
        $months_data = $this->dal->getEffectivenessForZoneByMonthSiteKeyword($this->_zoneId, $this->_start_month, $this->_end_month, $this->_reslimit);
        $months_display = $this->prepareMonthlySiteKeywordEffectivenessForDisplay($months_data);

        $this->createSubReport('Monthly Site Keyword Breakdown', $headers, $months_display);
    }
