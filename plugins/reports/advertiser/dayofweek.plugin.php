...
class Plugins_Reports_Advertiser_Dayofweek extends Plugins_Reports {
    ...
    function info()
    {
        ...
        $plugininfo = array (
            ...
            'plugin-description'    => MAX_Plugin_Translation::translate('This report shows average campaign activity by day of week.', $this->module, $this->package),
    ...
    function execute($clientid, $startdate, $enddate)
    {
        ...
        $worksheet = generateXLSHeader($workbook, $reportName, $startDate, $endDate,
                                       $clientid, $GLOBALS['strAdvertiserDayOfWeekAnalysisDescription'], 'advertiser');
