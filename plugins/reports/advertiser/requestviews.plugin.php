...
class Plugins_Reports_Advertiser_Requestviews extends Plugins_Reports {
    ...
    function info()
    {
        ...
        $plugininfo = array (
    		'plugin-name'             => MAX_Plugin_Translation::translate('Daily Views Analysis', $this->module, $this->package),
    		'plugin-description'      => MAX_Plugin_Translation::translate('This table is an analysis of the total activity down by day.', $this->module, $this->package),
    ...
    function execute($clientid, $startdate, $enddate)
    {
        ...
        $worksheet = generateXLSHeader($workbook, $reportName, $startDate, $endDate,
                                       $clientid, $GLOBALS['strAdvertiserDailyViewsAnalysisDescription'], 'advertiser');
