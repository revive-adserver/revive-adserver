...
function deliverVastAd($pluginType, &$aBanner, $zoneId=0, $source='', $ct0='', $withText=false, $logClick=true, $logView=true, $useAlt=false, $loc, $referer)
{
    ...
    $player = "";  //"NO VIDEO ASSOCIATED with banner id:" . $aBanner['ad_id'] . " name:" . $aBanner['name'] . $bannerMetaData;
...
// path_to_videoplayer_swf_used_when_viewing_video_in_openx_admintool
...
function prepareCompanionBanner(&$aOutputParams, $aBanner, $zoneId=0, $source='', $ct0='', $withText=false, $logClick=true, $logView=true, $useAlt=false, $loc, $referer){
    ...
    if ( isset( $aBanner['vast_companion_banner_id']  ) &&   ($aBanner['vast_companion_banner_id'] != 0) ){
        ...
        //
        //MAX_commonRegisterGlobalsArray(array('context'));
        global $context;
