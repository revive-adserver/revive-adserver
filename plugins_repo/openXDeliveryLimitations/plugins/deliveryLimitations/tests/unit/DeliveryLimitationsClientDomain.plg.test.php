...
class Plugins_TestOfPlugins_DeliveryLimitations_Client_Domain extends UnitTestCase
{
     ...
     */
    public function test_checkClientDomain()
    {
        $_SERVER['REMOTE_HOST'] = 'localhost.localdomain';
        $this->assertTrue(MAX_checkClient_Domain('localdomain', '==', ['ip' => '127.0.0.1']));
        $_SERVER['REMOTE_HOST'] = 'web.unanimis.co.uk';
        $this->assertTrue(MAX_checkClient_Domain('unanimis.co.uk', '==', ['ip' => '10.0.0.8']));
        $this->assertFalse(MAX_checkClient_Domain('unanimis.co.uk', '!=', ['ip' => '10.0.0.8']));
        $this->assertTrue(MAX_checkClient_Domain('.*unani.*', '=x', ['ip' => '10.0.0.8']));
    }
}
