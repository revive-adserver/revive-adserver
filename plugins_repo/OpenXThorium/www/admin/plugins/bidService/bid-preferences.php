...
$oTpl    = new OA_Plugin_Template('bid-preferences.html','bidService');
...
//TODO get campaigns here
$dalCampaigns = OA_Dal::factoryDAL('campaigns');
$aCampaigns = $dalCampaigns->getAllCampaigns();

$dalAdvertisers = OA_Dal::factoryDAL('clients');
$aAdvertisers = $dalAdvertisers->getAllAdvertisers();

foreach ($aCampaigns as $id => $campaign) {
...
$oTpl->assign('aAdvertisers', $aAdvertisers);
