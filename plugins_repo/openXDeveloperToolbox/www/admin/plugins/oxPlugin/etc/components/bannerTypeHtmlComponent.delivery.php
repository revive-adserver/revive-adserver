 ...
 * @abstract
 */
function Plugin_BannerTypeHTML_{GROUP}_{GROUP}Component_delivery(&$aBanner, $zoneId=0, $source='', $ct0='', $withText=false, $logClick=true, $logView=true, $useAlt=false, $loc, $referer)
{
