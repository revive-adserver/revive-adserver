...
/**
 * Verify Publisher Campaign Statistics method
 *
 * @author     Andriy Petlyovanyy <apetlyovanyy@lohika.com>
 */
public class TestPublisherCampaignStatisticsV2 extends PublisherTestCase {
	 ...
	 */
	private void executePublisherCampaignStatisticsWithError(Object[] params,
			String errorMsg) throws MalformedURLException {
		try {
			execute(PUBLISHER_CAMPAIGN_STATISTICS_METHOD, params);
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsAllReqAndSomeOptionalFields()
		...
		Object[] result = (Object[]) execute(
				PUBLISHER_CAMPAIGN_STATISTICS_METHOD, params);
	 ...
	 *
	 */
	public void testPublisherCampaignStatisticsWithoutSomeRequiredFields()
			throws MalformedURLException {
		Object[] params = new Object[] { sessionId };

		executePublisherCampaignStatisticsWithError(params, ErrorMessage
	 ...
	 * @throws XmlRpcException
	 */
	public void testPublisherCampaignStatisticsGreaterThanMaxFieldValueError()
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsLessThanMinFieldValueError()
			throws MalformedURLException {
		Object[] params = new Object[] { sessionId, publisherId,
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsMinValues()
			throws XmlRpcException, MalformedURLException {
		Object[] params = new Object[] { sessionId, publisherId,
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsMaxValues()
			throws XmlRpcException, MalformedURLException {
		Object[] params = new Object[] { sessionId, publisherId,
	 ...
	 * @throws XmlRpcException
	 */
	public void testPublisherCampaignStatisticsUnknownIdError()
			throws MalformedURLException, XmlRpcException {
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsDateError()
			throws XmlRpcException, MalformedURLException {
		Object[] params = new Object[] { sessionId, publisherId,
	 ...
	 * @throws MalformedURLException
	 */
	public void testPublisherCampaignStatisticsWrongTypeError()
			throws MalformedURLException {
		Object[] params = new Object[] { sessionId, publisherId,
				TextUtils.NOT_DATE, DateUtils.MAX_DATE_VALUE };
		executePublisherCampaignStatisticsWithError(
				params,
				ErrorMessage
						.getMessage(
