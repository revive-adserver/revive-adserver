 ...
 */
class MAX_Maintenance_Statistics_Tracker_Task_LogCompletion extends MAX_Maintenance_Statistics_Common_Task_LogCompletion
{

    /**
     * The constructor method.
     *
     * @return MAX_Maintenance_Statistics_Tracker_Task_LogCompletion
     */
    function MAX_Maintenance_Statistics_Tracker_Task_LogCompletion()
    {
    ...
    {
        $this->logCompletion('tracker_run_type', $oEndDate);
    }
