 ...
 */
class Maintenance_TestOfMAX_Maintenance_Statistics_AdServer_Task_LogCompletion extends UnitTestCase
{

    /**
     * The constructor method.
     */
    function Maintenance_TestOfMAX_Maintenance_Statistics_AdServer_Task_LogCompletion()
    {
        $this->UnitTestCase();
    }
    ...
    function testCreate()
    {
        ...
        $this->assertTrue(is_a($oLogCompletion, 'MAX_Maintenance_Statistics_AdServer_Task_LogCompletion'));
    }
    ...
    function testRun()
    {
        ...
        // Create a new MAX_Maintenance_Statistics_AdServer_Task_LogCompletion object
        $oLogCompletion = new MAX_Maintenance_Statistics_AdServer_Task_LogCompletion();
