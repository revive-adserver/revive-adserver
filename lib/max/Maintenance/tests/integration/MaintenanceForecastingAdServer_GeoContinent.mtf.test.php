...
// pgsql execution time before refactor: 76.226s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoContinent extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Continent delivery limitation.
     */
    function OLD_testAdServerGeo_Continent()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
