...
// pgsql execution time before refactor: 76.725s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoNetSpeed extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Netspeed delivery limitation.
     */
    function OLD_testAdServerGeo_Netspeed()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
