...
// pgsql execution time before refactor: 76.728s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoCountry extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Country delivery limitation.
     */
    function OLD_testAdServerGeo_Country()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
