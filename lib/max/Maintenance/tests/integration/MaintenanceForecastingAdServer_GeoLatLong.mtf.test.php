...
// pgsql execution time before refactor: 76.940s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoLatLong extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Latlong delivery limitation.
     */
    function OLD_testAdServerGeo_Latlong()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
