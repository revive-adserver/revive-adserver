...
// pgsql execution time before refactor: 129.42s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_ClientIp extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Client:Ip delivery limitation.
     */
    function OLD_testAdServerClient_Ip()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
