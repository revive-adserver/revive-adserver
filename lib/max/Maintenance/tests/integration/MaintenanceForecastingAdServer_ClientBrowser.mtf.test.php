...
// pgsql execution time before refactor: 75.897s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_ClientBrowser extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Client:Browser delivery limitation.
     */
    function OLD_testAdServerClient_Browser()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
