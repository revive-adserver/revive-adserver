...
// pgsql execution time before refactor: 50.099s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoReferingpage extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerSite_Referingpage()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
