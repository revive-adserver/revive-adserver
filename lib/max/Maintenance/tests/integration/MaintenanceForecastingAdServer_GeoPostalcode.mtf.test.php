...
// pgsql execution time before refactor: 49.434s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoPostalcode extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerGeo_Postalcode()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
