...
// pgsql execution time before refactor: 49.897s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoPageURL extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerSite_Pageurl()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
