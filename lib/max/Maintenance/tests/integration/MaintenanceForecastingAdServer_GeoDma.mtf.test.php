...
// pgsql execution time before refactor: 76.671s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoDma extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Dma delivery limitation.
     */
    function OLD_testAdServerGeo_Dma()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
