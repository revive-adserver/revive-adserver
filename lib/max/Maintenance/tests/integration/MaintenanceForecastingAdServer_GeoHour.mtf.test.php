...
// pgsql execution time before refactor: 76.962s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoHour extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Time:Hour delivery limitation.
     */
    function OLD_testAdServerTime_Hour()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
