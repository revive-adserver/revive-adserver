...
// pgsql execution time before refactor: 49.761s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoRegion extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Geo:Region delivery limitation.
     */
    function OLD_testAdServerGeo_Region()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
