...
// pgsql execution time before refactor: 77.075s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_ClientLanguage extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Client:Language delivery limitation.
     */
    function OLD_testAdServerClient_Language()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
