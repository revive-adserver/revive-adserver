...
// pgsql execution time before refactor: 76.342s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_ClientOS extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Client:Os delivery limitation.
     */
    function OLD_testAdServerClient_Os()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
