...
// pgsql execution time before refactor: 50.143s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoSource extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerSite_Source()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
