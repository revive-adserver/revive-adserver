...
// pgsql execution time before refactor: 49.459s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoAreaCode extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerGeo_Areacode()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
