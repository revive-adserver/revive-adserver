...
// pgsql execution time before refactor: 55.469s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoOrganisation extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerGeo_Organisation()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
