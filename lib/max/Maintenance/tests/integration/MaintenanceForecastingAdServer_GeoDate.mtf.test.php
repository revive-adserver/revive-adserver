...
// pgsql execution time before refactor: 184.52s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_GeoDate extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     * channel using the Time:Date delivery limitation.
     */
    function OLD_testAdServerTime_Date()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
