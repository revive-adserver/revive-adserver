...
// pgsql execution time before refactor: 49.259s
 ...
 */
class Maintenance_TestOfMaintenanceForecastingAdServer_ClientDomain extends Maintenance_TestOfMaintenanceForecastingAdServer
{
    /**
     ...
     *       Client:Useragent plugin test.
     */
    function OLD_testAdServerClient_Domain()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['maintenance']['operationInteval'] = 60;
        $aConf['maintenance']['channelForecasting'] = true;
