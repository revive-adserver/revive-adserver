...
$GLOBALS['strAutoMaintenanceBestPerformance'] = "Para o melhor funcionamento é recomendado que se use <a href='http://{$PRODUCT_DOCSURL}/maintenance.html' target='_blank'>manutenção agendada</a>.";
