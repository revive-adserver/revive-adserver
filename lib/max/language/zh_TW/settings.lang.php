...
$GLOBALS['strInstallIntro'] = "謝謝您選擇<a href=http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>嚮導會指導您完成{$PRODUCT_NAME} 廣告伺服器的安裝/升級流程。</p><p>為了幫助您完成安裝過程，我們準備了<a href='http://{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>快速安裝指南來幫助您安裝並啟動服務。關於{$PRODUCT_NAME}的安裝和配置，如需更詳細的資訊，請訪問<a href='http://{$PRODUCT_DOCSURL}/wizard/admin-guide'target='_blank'>管理員指南。</a>";
...
$GLOBALS['strTermsIntro'] = "{$PRODUCT_NAME} 在遵守Open Source license, the GNU General Public License的情況下可以被自由分發使用，請查看以下文檔並確認以繼續安裝過程";
...
$GLOBALS['strDbUpgradeIntro'] = "為安裝{$PRODUCT_NAME}，系統為您檢測出下列數據庫資訊。請檢查並確認這些資訊是正確的.<p>下一步將為您升級數據庫。點擊[繼續]來升級您的系統。</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "為了繼續升級，請輸入您{$PRODUCT_NAME} 管理員登錄資訊。您必須以管理員身份登錄，以繼續安裝。";
...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} 已經在系統中安裝完成. 如果您想配置這個模塊, 請點擊<a href='account-index.php'>設置界面</a>.";
