...
$GLOBALS['strInstallIntro'] = "Îţi mulţumim că ai ales <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Acest vrăjitor te va ghida în procesul de instalare / actualizare al server-ului de reclame {$PRODUCT_NAME}.</p><p>Pentru a te ajuta cu procesul de instalare am creat un<a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Ghid de Instalare Rapidă</a> pentru duce la bun sfârşit instalarea. Pentru un ghid mai detaliat privind instalarea şi configurarea {$PRODUCT_NAME} accesează <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Ghidul Administratorului</a>.";
...
$GLOBALS['strTermsIntro'] = "{$PRODUCT_NAME} este distribuit gratuit sub o licenţă Open Source, Licenţa GNU General Public. Te rugăm să revizuieşi următoarele documente pentru a continua instalarea.";
...
$GLOBALS['strDbUpgradeIntro'] = "Mai jos sunt datele bazei de date detectate pentru instalarea ta {$PRODUCT_NAME}. Te rugăm să verifici pentru a fi sigur că aceste date sunt corecte.<p> Următorul pas îţi va actualiza baza de date. Apasă 'Continuă' pentru a-ţi actualiza sistemul.</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "Pentru a continua procesul de actualizare, te rugăm să introduci detalii de autentificare ale administratorului {$PRODUCT_NAME}. Trebuie să te autentifici ca administrator pentru a continua procesul de actualizare.";
...
$GLOBALS['strWebPath'] = "Locaţii de Acces ale Server-ului pentru {$PRODUCT_NAME}";
...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} este deja instalat pe acest sistem. Dacă vrei să-l configurezi accesează <a href='account-index.php'>interfaţa de setări</a>";
