...
$GLOBALS['strInstallWelcome'] = "Bine ai venit - {$PRODUCT_NAME}";
...
$GLOBALS['strAdminEmailHeaders'] = "Adaugă următoarele headere fiecărui mesaj e-mail trimis de {$PRODUCT_NAME} ";
