...
$GLOBALS['strInstallIntro'] = "Tak fordi du valgte <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Denne wizard vil guide dig igennem installations processen/opdateringen af {$PRODUCT_NAME} reklame server.</p><p> For at hjælpe dig med installationsprocessen har vi lavet en <a href='http://{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Qucik Start Installations guide</a> til at få dig gemmen processen så du kommer hurtigt i gang. For en mere detaljeret guide til installation og konfigurering af {$PRODUCT_NAME} se <a href='http://{$PRODUCT_DOCSURL}/wizard/admin-guide'target='_blank'>Administrator Guide</a>.";
...
$GLOBALS['strDbUpgradeIntro'] = "Herunder er detaljerne for den database som er regristeret for installation af {$PRODUCT_NAME}. Venligst tjek at disse informationer er korrekte.<p>Det næste trin vil opgradere din database. Klik 'Fortsæt' for at opgradere dit system.</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "For at fortsætte med opdaterings processen, venligst angiv dit {$PRODUCT_NAME} administrator log ind detaljer. Det er nødvendigt at du logger ind som administrator for at fortsætte med opgraderings processen.";
...
$GLOBALS['strWebPath'] = "{$PRODUCT_NAME} Server adgangs sti";
