...
$GLOBALS['strInstallIntro'] = "Obrigado por escolher o <a href='http://MAX_PRODUCT_URL' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Este assistente irá guiar você pelo processo de instalação / atualização do servidor de anúncios {$PRODUCT_NAME}.</p><p>Para ajudar com o processo de instalação criamos um <a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Guia de Instalação Rápida</a> que lhe ajudará a ter o serviço no ar rapidamente. Para maiores detalhes sobre instalação ou configuração do MAX_PRODUCT_NAME visite o <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Guia do Administrador</a>.";
