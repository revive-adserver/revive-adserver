...
$GLOBALS['strHideInactiveCampaigns']		= "Skrýt neaktívní kampaně";
...
$GLOBALS['strAllowClientModifyInfo']		= "Povolit uživateli měnit vlastní nastavení";
...
$GLOBALS['strAllowClientViewTargetingStats']	= "Povolit uivateli prohlíet statistiky cílení";
...
$GLOBALS['strOptimise']				= "Optimalizovat doručování této kampaně.";
...
$GLOBALS['strConfirmDeleteAllTrackers']		= "Opravdu chcete smazat vechny sledovače tohoto inzerenta?";
$GLOBALS['strConfirmDeleteTracker']		= "Opravdu chcete smazat tento sledovač?";
$GLOBALS['strDeleteAllTrackers']		= "Smazat vechny sledovače";
...
$GLOBALS['strNewBannerFileAlt']			= "Vyberte alternativní obrázek, který <br>chcete pouít pro prohlíeče,<br>které nepodporují rich-media<br><br>";
...
$GLOBALS['strErrorDBNoDataPlain']		= "Vzhledem k promlémům s databází, ".$phpAds_productname." nemůže načíst ani ukládat data. ";
$GLOBALS['strErrorDBNoDataSerious']		= "Vzhledem k závažným promlémům s databází, ".$phpAds_productname." nemůže načíst data";
...
$GLOBALS['strErrorDBSubmitBug']			= "Pokud je tento problém reprodukovatelný, může být způsoben chybou v ".$phpAds_productname.". Prosím poskytněte následující informace tvůrcům ".$phpAds_productname.". Také se pokuste popsat kroky které vedly k této chybě jak nejpřesněji je to jen možné.";
$GLOBALS['strMaintenanceNotActive']		= "Skript pro správu systému nebyl spuštěn v průběhu posledních 24 hodin. \\nAby mohl ".$phpAds_productname." korektně fungovat je nutné aby běžel každou \\nhodinu. \\n\\nProsím přečtěte si příručku Administrators guide pro informace \\no konfiguraci skriptu pro správu systému.";
...
$GLOBALS['strAddAgency_Key']			= "Přidat <u>n</u>ového partnera";
$GLOBALS['strTotalAgencies']			= "Celkem partnerů";
$GLOBALS['strAgencyProperties']			= "Vlastnosti partnera";
$GLOBALS['strNoAgencies']			= "V tuto chvíli nejsou definování ádní partneři";
...
$GLOBALS['strInactiveAgenciesHidden']		= "neaktivních partnerů skryto";
...
$GLOBALS['strNoVarsToTrack']			= "ádné proměnné ke sledování.";
