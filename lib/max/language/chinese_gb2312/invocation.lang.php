...
// Other
$GLOBALS['strCopyToClipboard']			= "���Ƶ����а�";
...
$GLOBALS['strInvocationWhat']			= "ѡ����";
$GLOBALS['strInvocationClientID']		= "�ͻ�����Ŀ";
$GLOBALS['strInvocationTarget']			= "Ŀ��Frame";
$GLOBALS['strInvocationSource']			= "4Դ";
$GLOBALS['strInvocationWithText']		= "�ڹ��������ʾ����";
$GLOBALS['strInvocationDontShowAgain']		= "��ͬһҳ�治����ʾ�˹��";
$GLOBALS['strInvocationDontShowAgainCampaign']	= "��ͬһҳ�治����ʾ����Ŀ�Ĺ��";
$GLOBALS['strInvocationTemplate'] 		= "�ѹ�汣����һ����У�������һ��ģ������ʹ��";


// Iframe
$GLOBALS['strIFrameRefreshAfter']		= "ˢ��ʱ��";
$GLOBALS['strIframeResizeToBanner']		= "ʹiframe����ĳߴ籣��һ��";
$GLOBALS['strIframeMakeTransparent']		= "ʹiframe͸��";
$GLOBALS['strIframeIncludeNetscape4']		= "��(Netscape 4���ݵ�ilayer";
...
$GLOBALS['strShowToolbars']			= "����8";
$GLOBALS['strShowLocation']			= "��ַ8";
$GLOBALS['strShowMenubar']			= "�˵�8";
$GLOBALS['strShowStatus']			= "״̬8";
