...
$GLOBALS['strUpdateDatabaseError']			= "Per motivi sconosciuti l'aggiornamento del database non è andato a buon fine. È consigliato cliccare su <b>Riprova</b> per tentare di correggere questi potenziali problemi. Se sei sicuro che questi errori non influiscano sul corretto funzionamento di {$PRODUCT_NAME} clicca su <b>Ignora errori</b> per continuare. Ignorare questi errori può causare seri problemi e non è consigliato!";
$GLOBALS['strAlreadyInstalled']				= "{$PRODUCT_NAME} è già installato su questo sistema. Per modificare le impostazioni clicca <a href='settings-index.php'>qui</a>";
...
$GLOBALS['strTableInUse']					= "Il database specificato è già utilizzato da {$PRODUCT_NAME}, utilizza un diverso prefisso per le tabelle, o leggi il manuale le istruzioni sull'aggiornamento.";
...
$GLOBALS['strFixProblemsBefore']			= "Le seguenti cose devono essere corrette prima di installare {$PRODUCT_NAME}. Per qulunque dubbio su questi messaggi di errore, consultare la <i>Administrator guide</i>, presente nell'archivio scaricato.";
$GLOBALS['strFixProblemsAfter']				= "Se non sei in grado di risolvere i problemi elencati, ocntatta l'amministratore del sistema su cui stai installando {$PRODUCT_NAME}. L'amministratore del server potrebbe essere in grado di aiutarti.";
...
$GLOBALS['strWarningPHPversion']			= "{$PRODUCT_NAME} richiede PHP 4.0 o più recente per funzionare correttamente. La versione attualmente utilizzata è {php_version}.";
...
$GLOBALS['strConfigLockedDetected']			= "Il file <b>config.inc.php</b> non può essere sovrascritto dal server. Non � possiblie procedere finché non vengono modificati i permessi sul file. Puoi leggere sul manuale di {$PRODUCT_NAME} come fare.";
...
$GLOBALS['strInstallMessage']				= "Prima di utilizzare {$PRODUCT_NAME} è necessario configurarlo e <br /> il database deve essere creato. Clicca su <b>Procedi</b> per continuare.";
$GLOBALS['strInstallSuccess']				= "Cliccando <em>continua</em> entrerai dentro il tuo ad server.	<p><strong>E dopo?</strong></p>	<div class='psub'>	<p><strong>Iscriviti per ricevere gli aggiornamenti sul prodotto</strong><br />	 <a href='{$PRODUCT_DOCSURL}/wizard/join' target='_blank'>Iscriviti alla mailing list {$PRODUCT_NAME}</a> per ricevere gli aggiornamenti sul prodotto, segnalazioni di sicurezza e annunci sui nuovi prodotti.	 </p>	 <p><strong>Crea la tua prima campagna pubblicitaria</strong><br />	 Usa la <a href='{$PRODUCT_DOCSURL}/wizard/qsg-firstcampaign' target='_blank'>guida rapida per pubblicare la prima campagna pubblicitaria</a>.	  </p></div>	<p><strong>Passi facoltativi dell'installazione</strong></p>	<div class='psub'>	 <p><strong>Blocca i tuoi file di configurazione</strong><br />	 Questo passo migliora notevolmente la sicurezza del tuo adserver, evitando che le impostazioni di configurazione vengano alterate. <a href='{$PRODUCT_DOCSURL}/wizard/lock-config' target='_blank'>Per saperne di più</a>.	  </p>	 <p><b>Imposta la manutenzione programmata</b><br>	  La manutenzione programmata è consigliata per assicurare nel tempo la generazione dei report e le migliori performance del prodotto.  <a href='{$PRODUCT_DOCSURL}/wizard/setup-cron' target='_blank'>Per saperne di più</a>	  </p>	 <p><b>Rivedi le tue configurazioni di sistema</b><br>	  Prima di iniziare ad usare {$PRODUCT_NAME} ti consigliamo di rivedere le tue impostazioni del sistema nel pannello <em>Impostazioni</em>.	  </p>	</div>";
$GLOBALS['strUpdateSuccess']				= "<b>L'aggiornamento di {$PRODUCT_NAME} &egrave stato completato.</b><br /><br />Affinché {$PRODUCT_NAME} funzioni correttamente devi assicurarti
                                        	   ...
                                        	   sicurezza.";
$GLOBALS['strInstallNotSuccessful']			= "<b>L\'installazione di {$PRODUCT_NAME} non ha avuto successo</b><br /><br />Alcune parti del processo di installazione non possono essere completate.
...
$GLOBALS['strInstallIntro'] = "Grazie per aver scelto <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Questa procedura guidata ti aiuterà durante il processo di installazione / aggiornamento dell'adserver {$PRODUCT_NAME}.</p><p>Per aiutarti con la procedura di installazione abbiamo creato una <a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Guida rapida all'installazione</a> per permetterti di avere una piattaforma funzionante. Per ottenere una guida più dettagliata sull'installazione e la configurazione di {$PRODUCT_NAME} visita la <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Guida per l'amministratore</a>.";
...
$GLOBALS['strTermsIntro'] = "{$PRODUCT_NAME} è software Open Source, inoltre viene distribuito liberamente tramite licenza Free Software: The GNU General Public License. Per favore leggi attentamente il testo della licenza: per proseguire l'installazione è necessario accettare e condividere le condizioni di licenza.";
...
$GLOBALS['strDbUpgradeIntro'] = "Di seguito sono stati individuati i dati relativi alla tua base dati di {$PRODUCT_NAME}. Per favore controlla l'esattezza dei dati, il prossimo passo sarà quello per aggiornare la base dati. Clicca <em>continua</em> per aggiornare la tua installazione.</p>";
...
$GLOBALS['strDbSuccessIntro'] = "Il database di {$PRODUCT_NAME} è stato creato. Clicca su 'Continua' per procedere alla configurazione di Amministrazione e Consegna di {$PRODUCT_NAME}.";
...
$GLOBALS['strLoginSettingsIntro'] = "Per procedere con l'aggiornamento, inserisci i dettagli dell'Amministratore del tuo {$PRODUCT_NAME}. E' necessario autenticarsi come Amministratore per procedere con l'upgrade.";
...
$GLOBALS['strDemoDataIntro'] = "È possibile caricare le impostazioni standard di {$PRODUCT_NAME} per aiutarti ad iniziare subito a servire inserzioni on line. I tipi di banner più comuni e alcune campagne di esempio possono essere caricate e preconfigurate. È fortemente consigliato caricare le impostazioni standard per le nuove installazioni.";
...
$GLOBALS['strWebPath'] = "{$PRODUCT_NAME} Percorsi di accesso al Server'";
...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} è già installato nel sistema. Se vuoi configurarlo vai nell`<a href='account-index.php'>interfaccia impostazioni</a>.";
