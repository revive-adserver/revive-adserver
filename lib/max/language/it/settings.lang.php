...
$GLOBALS['strInstallSuccess']				= "<b>L'istallazione di ".$phpAds_productname." &egrave stata completata.</b><br /><br />Affinché ".$phpAds_productname." funzioni correttamente devi assicurarti
...
$GLOBALS['strDayFullNames']					= array("Domenica","Lunedì","Martediì","Mercoledì","Giovedì","Venerdì","Sabato");
...
$GLOBALS['strTypeWebModeLocal']				= "Modalità locale (utilizza una directory locale)";
$GLOBALS['strTypeWebModeFtp']				= "Modalità FTP (utilizza un server FTP esterno)";
$GLOBALS['strTypeWebDir']					= "Directory per la modalità locale";
...
$GLOBALS['strReverseLookup']				= "Cerca di determinare il nome di host del visitatore se non è fornito dal server web";
...
$GLOBALS['strHideInactive']					= "Nascondi entità inattive in tutte le pagine riassuntive";
