...
$GLOBALS['strCampaignWarningECPMNoECPM']   = "The type of this campaign has been set to eCPM, \nbut the 'eCPM' is set to zero or it has not been specified. \nThis will cause the campaign to be deactivated \nand its banners won't be delivered until the \neCPM has been set to a valid number. \n\nAre you sure you want to continue?";
...
$GLOBALS['strECPMInfo']                     = "This is an eCPM campaign which can be constrained with either an end date or a specific limit";
...
$GLOBALS['strECPMIsNull']                       = "its eCPM is set to zero";
