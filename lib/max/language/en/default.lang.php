...
$GLOBALS['strEmailNoDates']                     = "Campaigns linked to Email Zones must have a start and end date set. OpenX ensures that on a given date, only one active banner is linked to an Email Zone. Please unsure that the campaigns already linked to the zone do not have overlapping dates with the campaign you are trying to link.";
