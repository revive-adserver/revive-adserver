...
$GLOBALS['strMonth'][0] = "January";
$GLOBALS['strMonth'][1] = "February";
$GLOBALS['strMonth'][2] = "March";
$GLOBALS['strMonth'][3] = "April";
$GLOBALS['strMonth'][4] = "May";
$GLOBALS['strMonth'][5] = "June";
$GLOBALS['strMonth'][6] = "July";
$GLOBALS['strMonth'][7] = "August";
$GLOBALS['strMonth'][8] = "September";
$GLOBALS['strMonth'][9] = "October";
...
$GLOBALS['strCacheBusterComment'] = "  * Replace all instances of {random} with
  ...
  *";
$GLOBALS['strSSLBackupComment'] = "  * The backup image section of this tag has been generated for use on a
  * non-SSL page. If this tag is to be placed on an SSL page, change the
  *   'http://%s/...'  * to
  *   'https://%s/...'  *";
$GLOBALS['strSSLDeliveryComment'] = "  * This tag has been generated for use on a non-SSL page. If this tag
