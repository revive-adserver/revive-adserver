...
$GLOBALS['strAlreadyInstalled']			= "{$PRODUCT_NAME} ya se encuentra instalado en el sistema. Si desea configurarlo vaya a <a href='settings-index.php'>Configuración de Interface</a>";
...
$GLOBALS['strTableInUse']				= "La base de datos especificada ya se encuentra utilizada por {$PRODUCT_NAME}, por favor use un prefijo de tabla diferente, o lea el manual de instrucciones para actualizar.";
...
$GLOBALS['strWarningPHPversion']		= "{$PRODUCT_NAME} requiere PHP 4.0 o mayor para funcionar correctamente. Ud. está usando {php_version}.";
...
$GLOBALS['strConfigLockedDetected']		= "{$PRODUCT_NAME} ha detectado que su <b>config.inc.php</b> no tiene permiso de escritura por el server.<br /> Ud. no podrá proseguir si no cambia los permisos del archivo. <br />Lea la documentación suministrada si no sabe como hacerlo.";
...
$GLOBALS['strInstallMessage']			= "Antes de poder usar {$PRODUCT_NAME} necesitará configurarlo y <br /> deberá crear la base de datos. Clickee en <b>Proceder</b> para continuar.";
...
$GLOBALS['strUpdateSuccess']			= "<b>La actualización de {$PRODUCT_NAME} ha sido completada.</b><br /><br />Para que {$PRODUCT_NAME} funcione correctamente deberá
...
$GLOBALS['strInstallIntro'] = "Gracias por usar <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a>. <p>Este asistente le guiará en el proceso de instalación / actualización del servidor de publicidad {$PRODUCT_NAME}.</p><p>Para ayudarle con el proceso de instalación hemos creado una <a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Guía de instalación rápida</a> para iniciarle en el proceso de puesta en marcha. Para una guía más detallada de la instalación y configuración de {$PRODUCT_NAME} visite la <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Guía del Administrador</a>.";
...
$GLOBALS['strDbUpgradeIntro'] = "A continuación se muestran los detalles detectados de su base de datos para la instalación de {$PRODUCT_NAME}. Por favor, compruebe que los valores sean correctos. <p>El siguiente paso actualizará su base de datos. Haga clic en 'Continuar' para actualizar su sistema</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "Para poder continuar con el proceso de actualización, por favor introduzca los detalles de su cuenta de administrador de {$PRODUCT_NAME}. Debe iniciar la sesión como administrador para continuar con el proceso de actualización.";
