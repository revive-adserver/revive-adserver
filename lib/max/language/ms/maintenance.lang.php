...
$GLOBALS['strBannerCacheExplaination'] = "\nPengkalan data \"banner cache\" digunakan untuk mempercepatkan penyampaian banner semasa penghantaran<br />";
...
$GLOBALS['strNoNewVersionAvailable'] = "\n	 Versi anda untuk ".MAX_PRODUCT_NAME." adalah terkini. Tiada versi baru yang terdapat kini.\n";
$GLOBALS['strNewVersionAvailable'] = "\n	<b>Versi baru untuk ".MAX_PRODUCT_NAME." telah dikeluarkan.</b><br /> Adalah digalakkan untuk memperbaharui sistem anda menggunakan versi baru ini,\n	berkemungkinan ini akan memperbaiki masalah yang terdapat kini dan juga menambahkan ciri-ciri baru. Maklumat lanjut\n	tentang proses pembaharuan, sila baca dokumen yang terdapa bersama fail-fail dibawah.\n";
