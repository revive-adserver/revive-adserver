...
$GLOBALS['strInvocationTemplate'] 		= "Zapisz ten banner w zmiennej, aby m�g� by� wkorzystany w szablonie";


// Iframe
$GLOBALS['strIFrameRefreshAfter']		= "Od�wie� po";
$GLOBALS['strIframeResizeToBanner']		= "Przeskaluj iframe do rozmiar�w bannera";
$GLOBALS['strIframeMakeTransparent']		= "Zr�b przezroczyst� iframe";
...
$GLOBALS['strPopUpCreateInstance']		= "Kiedy pop-up ma by� wy�wietlony";
...
$GLOBALS['strPopUpTop']				= "Pocz�tkowa pozycja (g�ra)";
$GLOBALS['strPopUpLeft']			= "Pocz�tkowa pozycja (lewa)";


// XML-RPC
$GLOBALS['strXmlRpcLanguage']			= "J�zyk Hosta";


// AdLayer
$GLOBALS['strAdLayerStyle']			= "Styl";

$GLOBALS['strAlignment']			= "Wyr�wnanie";
$GLOBALS['strHAlignment']			= "Wyr�wnanie poziome";
$GLOBALS['strLeft']				= "Lewa";
$GLOBALS['strCenter']				= "�rodek";
$GLOBALS['strRight']				= "Prawa";

$GLOBALS['strVAlignment']			= "Wyr�wnanie pionowe";
$GLOBALS['strTop']				= "G�ra";
$GLOBALS['strMiddle']				= "�rodek";
$GLOBALS['strBottom']				= "D�";

$GLOBALS['strAutoCollapseAfter']		= "Automatycznie schowa po";
$GLOBALS['strCloseText']			= "Tekst zamkni�cia";
$GLOBALS['strClose']				= "[Zamknij]";
$GLOBALS['strBannerPadding']			= "Odst�p bannera";

$GLOBALS['strHShift']				= "Przesuni�cie poziome";
$GLOBALS['strVShift']				= "Przesuni�cie pionowe";
...
$GLOBALS['strLooping']				= "P�tle";
$GLOBALS['strAlwaysActive']			= "Zawsze aktywny";
$GLOBALS['strSpeed']				= "Pr�dko��";
...
$GLOBALS['strHideDelay']			= "Op�nienie przed ukryciem bannera";
