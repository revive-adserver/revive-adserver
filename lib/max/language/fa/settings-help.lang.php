...
$GLOBALS['phpAds_hlp_reverse_lookup'] = "نام میزبان است که معمولا توسط وب سرور تعیین می شود، اما در برخی موارد این ممکن است
خاموش است. اگر شما می خواهید به استفاده از نام میزبان بازدید کنندگان داخل محدودیت تحویل و / یا
نگه داشتن آمار در مورد این و سرور می کند این اطلاعات شما نیاز به ارائه نمی
به نوبه خود از این گزینه در. تعیین نام میزبان از بازدید کننده می کند برخی از زمان. آن را
کاهش سرعت تحویل آگهی ها پایین.";
...
$GLOBALS['phpAds_hlp_geotracking_type'] = "Geotargeting اجازه می دهد تا {$PRODUCT_NAME} آدرس IP بازدید کننده به جغرافیایی
اطلاعات تبدیل کند. بر اساس این اطلاعات شما می توانید محدودیت های تحویل و یا می توانید محدودیت دریافت تنظیم کنید یا شما می توانید ذخیره کنید
این اطلاعات برای دیدن اینکه کدام کشور است تولید می کند بیشترین برداشت و یا کلیک thrus.
اگر شما می خواهید را فعال geotargeting شما نیاز به انتخاب کنید که نوع پایگاه داده شما را داشته باشد.
{$PRODUCT_NAME} حال حاضر پشتیبانی می کند از <a href='http://hop.clickbank.net/?phpadsnew/ip2country' target='_blank'>IP2کشور </a>
و <a href='http://www.maxmind.com/?rId=phpadsnew' target='_blank'>GeoIP</a> پایگاه داده.";
...
$GLOBALS['phpAds_hlp_acl'] = "اگر شما از محدودیت تحویل استفاده نمی کنید شما می توانید این گزینه را با این پارامتر غیر فعال کردن،
این باعث افزایش سرعت {$PRODUCT_NAME} کمی می شود.";
