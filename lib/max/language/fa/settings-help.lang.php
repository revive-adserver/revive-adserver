...
$GLOBALS['phpAds_hlp_dbhost'] = "            نام هاست پایگاه داده{$phpAds_dbmsname}  را که می خواهید به آن متصل شوید را مشخص نمایید.
		";
...
$GLOBALS['phpAds_hlp_gui_show_campaign_preview'] = "		If this option is enabled a preview of all banners will be shown on the <i>Banner overview</i>
