...
$GLOBALS['phpAds_hlp_dbhost'] = "        Menetapkan nama Host untuk {$phpAds_dbmsname} database server yang ingin digunakan untuk koneksi.
		";

$GLOBALS['phpAds_hlp_dbport'] = "        Menetapkan nomor dari port database server yang ingin digunakan untuk koneksi ke {$phpAds_dbmsname}";

$GLOBALS['phpAds_hlp_dbuser'] = "        Menetapkan nama user yang digunakan oleh {$PRODUCT_NAME} untuk mengakses {$phpAds_dbmsname} database server.
		";

$GLOBALS['phpAds_hlp_dbpassword'] = "        Menetapkan kata sandi yang digunakan oleh {$PRODUCT_NAME} untuk mengakses database server {$phpAds_dbmsname}.
		";

$GLOBALS['phpAds_hlp_dbname'] = "        Menetapkan nama database yang digunakan oleh {$PRODUCT_NAME} untuk menyimpan data.
		Penting: Database harus sudah dibuat pada database server. {$PRODUCT_NAME} <b>tidak</b>
		membuat database dengan sendirinya bila database tersebut belu tersedia.
		";

$GLOBALS['phpAds_hlp_persistent_connections'] = "	Penggunaan koneksi persistent sangat mempercepatkan {$PRODUCT_NAME} dan
		...
		yang dipakai. Bila {$PRODUCT_NAME} mengunakan tenaga server yang berkelebihan,
		disarankan untuk periksa penyetelan ini paling pertama.
		";

$GLOBALS['phpAds_hlp_insert_delayed'] = "	{$phpAds_dbmsname} mengunci tabel sewaktu mengisi data. Bila situs Anda banyak dikunjungi bisa terjadi
		bahwa {$PRODUCT_NAME} harus menunggu untuk menambah baris baru sehubungan database
...
$GLOBALS['phpAds_hlp_compatibility_mode'] = "	Bila Anda mengalami masalah dalam integrasi {$PRODUCT_NAME} dengan sebuah produk lain
		cobalah aktivasikan Database Compatibility Mode. Bila Anda mengunakan invokasi Local Mode
		sedangkan posisi dari Compatibility Mode berada dalam posisi On, {$PRODUCT_NAME}
		akan membiarkan status pada koneksi ke database dalam keadaan seperti sebelum
		{$PRODUCT_NAME} dijalankan. Stelan ini agak lebih lambat (hanya sedikit) dan soal
		itu dalam posisi Off secara Default.
		";

$GLOBALS['phpAds_hlp_table_prefix'] = "	Bilamana database yang digunakan oleh {$PRODUCT_NAME} dibagi bersama-sama produk software yang
		lain, lebih arif kalau Anda menggunakan sebuah <i>Prefix</i> untuk nama tabel. Bila Anda menggunakan lebih dari
		satu instalasi dari {$PRODUCT_NAME} dalam database yang sama perlu dipastikan, bahwa Prefix
		yang digunakan untuk setiap instalasi adalah unik.
		";

$GLOBALS['phpAds_hlp_table_type'] = "        {$phpAds_dbmsname} mendukung berberapa jenis tabel. Setiap jenis tabel memiliki khas tersendiri dan diantaranya
		ada berberapa jenis yang mampu untuk amat mempercepat {$PRODUCT_NAME} Jenis tabel MyISAM adalah jenis
...
$GLOBALS['phpAds_hlp_url_prefix'] = "        Untuk befungsi dengan baik {$PRODUCT_NAME} harus mengenal lokasi dirinya pada web server.
		Anda perlu menetapkan URL ke direktori penyimpanan {$PRODUCT_NAME}, seb. contoh:
		http://www.url-anda.com/{$PRODUCT_NAME}.
		";

$GLOBALS['phpAds_hlp_my_header'] =
$GLOBALS['phpAds_hlp_my_footer'] = "	Disini Anda perlu menetapkan <i>Path</i> ke file Header (contoh: /home/login/www/header.htm)
...
$GLOBALS['phpAds_hlp_content_gzip_compression'] = "	Dengan membolehkan kompresi GZIP Anda akan dapat mengurangi data yang dikirim kepada browser
...
$GLOBALS['phpAds_hlp_language'] = "	Menentukan bahasa yang digunakan oleh {$PRODUCT_NAME} sebagai Default. Bahasa
...
$GLOBALS['phpAds_hlp_name'] = "	Menentukan nama yang digunakan untuk aplikasi ini. Kata-kata yang diisi disini akan
		ditampilkan pada seluruh halaman di Interface Admin dan Interface Pemasang Iklan.
		Bila kotak ini tidak diisi (default) maka sebuah lambang dari {$PRODUCT_NAME}
		akan tertampil pada halaman-halaman tersebut.
		";

$GLOBALS['phpAds_hlp_company_name'] = "	Nama ini akan digunakan dalam E-Mail yang dikirim oleh {$PRODUCT_NAME}.
		";

$GLOBALS['phpAds_hlp_override_gd_imageformat'] = "	Pada umumnya {$PRODUCT_NAME} akan mendeteksi secara otomatis apakah GD Library
		...
		Bila {$PRODUCT_NAME} gagal mendeteksi format gambar yang akurat Anda bisa menentukan
		format yang benar disini. Nilai yang diperbolehkan adalah: none, png, jpeg, gif.
		";

$GLOBALS['phpAds_hlp_p3p_policies'] = "	Bila Anda ingin mengaktifkan P3P Privacy Policies dari {$PRODUCT_NAME}, Anda
		perlu mengubah stelan ini ke posisi On.
		";

$GLOBALS['phpAds_hlp_p3p_compact_policy'] = "	Policy Kompak yang dikirim bersamaan dengan Cookie. Stelan Default adalah:
		'CUR ADM OUR NOR STA NID' yang mengizinkan Internet Explorer 6 untuk terima
		Cookie yang digunakan oleh {$PRODUCT_NAME}. Anda diperbolehkan untuk
		menentukan Privacy Statement lain sesuai dengan apa yang digunakan oleh webserver
		Anda disini.
		";

$GLOBALS['phpAds_hlp_p3p_policy_location'] = "	Bila Anda ingin menggunakan Private Policy yang penuh, Anda bisa menentukan lokasi dari
		Policy tersebut disini.
		";

$GLOBALS['phpAds_hlp_log_beacon'] = "	Yang dimaksud dengan Rambu Kecil adalah gambar kecil yang tidak kelihatan oleh pengunjung dan yang ditempatkan pada
		halaman yang sekalian menampilkan banner. Bila fungsi ini diaktifkan {$PRODUCT_NAME}
...
$GLOBALS['phpAds_hlp_compact_stats'] = "	Secara tradisional {$PRODUCT_NAME} melakukan pencatatan yang sangat luas dan terperinci
		...
		tersebut {$PRODUCT_NAME} mendukung jenis statistik yang baru, yaitu Statistik Kompak
...
$GLOBALS['phpAds_hlp_log_adviews'] = "	Biasanya seluruh AdViews dicatat oleh {$PRODUCT_NAME}. Bila Anda tidak ingin mengetahui
		statistik tentang AdViews, fungsi ini perlu dimatikan.
		";

$GLOBALS['phpAds_hlp_block_adviews'] = "	Setiap kalinya seseorang pengunjung menampilkan ulang sebuah halaman, {$PRODUCT_NAME} akan
		...
		Bila Anda menentukan jangka waktu 300 detik, {$PRODUCT_NAME} hanya akan mencatat
...
$GLOBALS['phpAds_hlp_log_adclicks'] = "	Biasanya seluruh AdClicks dicatat oleh {$PRODUCT_NAME}. Bila Anda tidak ingin mengetahui
		statistik tentang AdClicks, fungsi ini perlu dimatikan.
		";

$GLOBALS['phpAds_hlp_block_adclicks'] = "	Bila seorang pengunjung meng-klik berulang-ulang sebuah banner, {$PRODUCT_NAME} akan
		...
		Sebagai contoh: Bila Anda menentukan jangka waktu 300 detik, {$PRODUCT_NAME} hanya
...
$GLOBALS['phpAds_hlp_log_source'] = "	Bila Anda gunakan fungsi parameter sumber <i>source parameter</i> dalam kode invokasi, informasi tersebut
...
$GLOBALS['phpAds_hlp_geotracking_stats'] = "	Bila Anda menggunakan database untuk <i>Geotargeting</i>, Anda diperbolehkan untuk menyimpan informasi
...
$GLOBALS['phpAds_hlp_log_hostname'] = "	Bila Anda ingin menyimpan nama host atau nomor IP dari setiap pengunjung dalam statistik, silakan aktifkan
...
$GLOBALS['phpAds_hlp_log_iponly'] = "	Menyimpan nomor IP dari pengunjung akan membutuhkan ruang yang cukup besar dalam database. Bila Anda aktifkan
		pilihan ini, {$PRODUCT_NAME} akan menyimpan informasi tentang Host, akantetapi hanya
		alamat IP yang tersimpan pada database guna menghemat ruang. Pilihan ini tidak tersedia bilamana nama
		dari host tidak disediahkan oleh server yang bersangkutan atau oleh {$PRODUCT_NAME} sehubungan
		alamat IP menang selalu disimpan.
		";

$GLOBALS['phpAds_hlp_reverse_lookup'] = "	Nama dari host pada umumnya ditentukan oleh web server tetapi kadang-kadang fasilitas ini tidak diaktifkan.
...
$GLOBALS['phpAds_hlp_proxy_lookup'] = "	Beberapa pengunjung menggunakan proxy server untuk mengakses Internet. Dalam hal ini
		{$PRODUCT_NAME} akan mencatat nomor IP atau nama Host dari proxy server
		tetapi bukan dari pengunjung. Bila fungsi ini diaktifkan, {$PRODUCT_NAME}
...
$GLOBALS['phpAds_hlp_auto_clean_tables_interval'] = "	Bila Anda ingin gunakan fasilitas ini, statistik yang diperolehkan akan dihapus secara otomatis
...
$GLOBALS['phpAds_hlp_auto_clean_userlog_interval'] = "	Pilihan ini akan menghapus semua catatan dari <i>Userlog</i> yang masa waktunya melebihi jumlah
		minggu yang telah ditentukan pada kotak	dibawah ini.
		";

$GLOBALS['phpAds_hlp_geotracking_type'] = "	<i>Geotargeting</i> mengizinkan {$PRODUCT_NAME} untuk mengubah alamat IP dari pengunjung ke
		...
		pilih jenis database yang digunakan. {$PRODUCT_NAME} pada saat ini mendukung database
		IP2Country
		atau <a href='http://www.maxmind.com/?rId=phpadsnew2' target='_blank'>GeoIP</a>.
		";

$GLOBALS['phpAds_hlp_geotracking_location'] = "	Kecuali kalau Anda menggunakan modul GeoIP Apache, Anda perlu beritahukan database <i>Geotargeting</i>
		yang ingin digunakan kepada {$PRODUCT_NAME}. Disarankan untuk menyimpan database yang
		digunakan diluar document root dari web server untuk menghindarkan database tersebut bisa di-
		download oleh pengguna.
		";

$GLOBALS['phpAds_hlp_geotracking_cookie'] = "	Ubah alamat IP ke informasi geografis akan membutuhkan waktu yang cukup lama. Untuk menghindarkan perubahan
		ini dilakukan setiapkalinya sebuah banner disampaikan oleh {$PRODUCT_NAME}, hasil perubahan
		bisa disimpan dalam sebuah <i>Cookie</i>. Bila Cookie tersebut ini tersedia, {$PRODUCT_NAME}
		akan gunakan informasi ini dan tidak lagi perlu mengubah alamat IP.
		";

$GLOBALS['phpAds_hlp_ignore_hosts'] = "	Bila Anda ingin menghindar perhitungan Clicks dan Views oleh komputer tertentu, komputer-
...
$GLOBALS['phpAds_hlp_begin_of_week'] = "	Pada umumnya sebuah minggu dimulai dengan hari senin. Bila Anda ingin memulai minggu
		pada hari minggu, silakan tentukannya disini.
		";

$GLOBALS['phpAds_hlp_percentage_decimals'] = "	Menentukan jumlah angka desimal pada halaman statistik.
		";

$GLOBALS['phpAds_hlp_warn_admin'] = "	{$PRODUCT_NAME} dapat mengirim E-mail, bilamana sisa Clicks atau sisa Views di
	sebuah kampanye tinggal sedikit. Fasilitas ini aktif sebagai default.
		";

$GLOBALS['phpAds_hlp_warn_client'] = "	{$PRODUCT_NAME} dapat mengirim E-mail kepada Pemasang Iklan, bilamana sisa Clicks
	atau sisa Views tinggal sedikit. Fasilitas ini aktif sebagai default.
		";

$GLOBALS['phpAds_hlp_qmail_patch'] = "	Beberapa versi dari program qmail mengandung sebuah bug yang mengakibatkan {$PRODUCT_NAME}
		tampilkan Headers dalam badan dari E-Mail. Bila Anda aktifkan fungsi ini, {$PRODUCT_NAME}
		akan mengirimkan E-Mail dalam format yang kompatibel.
		";

$GLOBALS['phpAds_hlp_warn_limit'] = "	Batas yang memerintah {$PRODUCT_NAME} untuk mengirim E-mail Peringatan. Angka
	default adalah 100.
		";
...
$GLOBALS['phpAds_hlp_allow_invocation_popup'] = "	Dengan penyetelan ini Anda tentukan jenis invokasi yang diperbolehkan. Jenis invokasi
...
$GLOBALS['phpAds_hlp_con_key'] = "	{$PRODUCT_NAME} memiliki sistem pencarian yang sangat kuat dengan menggunakan
...
$GLOBALS['phpAds_hlp_mult_key'] = "	Bila Anda gunakan seleksi langsung untuk menampilkan banner Anda diperbolehkan untuk
...
$GLOBALS['phpAds_hlp_acl'] = "	Bila Anda tidak menggunakan pembatasan penyampaian silakan matikan opsi ini dengan parameter
		ini. Stelan yang berada dalam posisi Off akan meningkatkan kecepatan dari
		{$PRODUCT_NAME}.
        	";

$GLOBALS['phpAds_hlp_default_banner_url'] =
$GLOBALS['phpAds_hlp_default_banner_target'] = "	Bila {$PRODUCT_NAME} gagal menghubungi database server atau tidak bisa temukan banner
...
$GLOBALS['phpAds_hlp_delivery_caching'] = "	Guna untuk mempercepat penyampaian, {$PRODUCT_NAME} menggunakan sebuah Cache yang berisi
...
$GLOBALS['phpAds_hlp_type_txt_allow'] = "        {$PRODUCT_NAME} siap untuk mengolah jenis banner yang berbeda dengan cara
		...
		{$PRODUCT_NAME} akan menyimpan banner tersebut dalam database SQL atau
...
$GLOBALS['phpAds_hlp_type_web_mode'] = "	Bila Anda ingin menggunakan banner yang disimpan pada web server, penyetelan disini perlu
...
$GLOBALS['phpAds_hlp_type_web_dir'] = "	Menetapkan direktori yang akan digunakan oleh {$PRODUCT_NAME} untuk meng-upload
...
$GLOBALS['phpAds_hlp_type_web_ftp_host'] = "	Bila Anda menetapkan metode penyimpanan pada <i>Server FTP Eksternal</i>, Anda perlu
		tepatkan alamat IP atau nama domain dari Server FTP Eksternal tersebut, yang akan
		digunakan oleh {$PRODUCT_NAME} untuk meng-upload banner.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_path'] = "	Bila Anda menetapkan metode penyimpanan pada <i>Server FTP Eksternal</i>, Anda perlu
		tepatkan sebuah direktori dari Server FTP Eksternal tersebut, yang akan digunakan
		oleh {$PRODUCT_NAME} untuk meng-upload banner.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_user'] = "	Bila Anda menetapkan metode penyimpanan pada <i>Server FTP Eksternal</i>, Anda perlu
		berikan nama pengguna yang akan digunakan oleh {$PRODUCT_NAME} untuk buka
		koneksi ke Server FTP Eksternal yang bersangkutan.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_password'] = "	Bila Anda menetapkan metode penyimpanan pada <i>Server FTP Eksternal</i>, Anda perlu
		berikan kata sandi yang akan digunakan oleh {$PRODUCT_NAME} untuk buka
		koneksi ke Server FTP Eksternal yang bersangkutan.
		";

$GLOBALS['phpAds_hlp_type_web_url'] = "	Bila Anda menyimpan banner dalam web server {$PRODUCT_NAME} perlu diberitahui,
...
$GLOBALS['phpAds_hlp_type_html_auto'] = "	Bila fungsi ini ditepatkan pada posisi ON, {$PRODUCT_NAME} akan mengubah banner
...
$GLOBALS['phpAds_hlp_type_html_php'] = "	{$PRODUCT_NAME} memungkinkan untuk mengeksekusi kode PHP yang terletak dalam
		banner HTML. Fungsi ini ditepatkan dalam posisi OFF secara default.
		";

$GLOBALS['phpAds_hlp_admin'] = "	Silakan isi nama pengguna dari Administrator. Dengan nama pengguna tersebut Anda
		diperbolehkan untuk me-login ke Interface Administrator.
		";

$GLOBALS['phpAds_hlp_admin_pw'] =
$GLOBALS['phpAds_hlp_admin_pw2'] = "	Silakan ketik kata sandi yang ingin digunakan untuk me-login ke Interface Administrator.
		Kata sandi perlu diketik berulang dua kali untuk menghindar kekeliruan pengetetikan.
		";

$GLOBALS['phpAds_hlp_pwold'] =
$GLOBALS['phpAds_hlp_pw'] =
$GLOBALS['phpAds_hlp_pw2'] = "	Untuk mengubah kata sandi dari Administrator, Anda perlu sebutkan kata sandi yang lama
		diatas. Kata sandi yang baru perlu diketik berulang dua kali untuk hindari kekeliruan
		sewaktu penggantian kata sandi.
		";

$GLOBALS['phpAds_hlp_admin_fullname'] = "	Nama lengkap dari Administrator. Nama yang tercantum disini digunakan untuk mengirim statistik
		melalui E-Mail.
		";

$GLOBALS['phpAds_hlp_admin_email'] = "	Alamat E-Mail dari Administrator. Alamat ini digunakan sebagai alamat dari pengirim
		setiap kalinya E-Mail tentang statistik dikirim.
		";

$GLOBALS['phpAds_hlp_admin_email_headers'] = "	Anda diperbolehkan untuk mengubah header dari E-Mail yang dikirim oleh {$PRODUCT_NAME}.
		";

$GLOBALS['phpAds_hlp_admin_novice'] = "	Bila Anda ingin menerima peringatan sebelum menghapus Pemasang Iklan, kampanye, banner,
		penerbit dan zona tepatkan penyetelan ini ke <i>True</i>.
		";

$GLOBALS['phpAds_hlp_client_welcome'] = "	Bila fasilitas ini ditepatkan pada posisi On, sebuah kabar Selamat Datang akan ditampilkan
...
$GLOBALS['phpAds_hlp_client_welcome_msg'] = "	Daripada meng-edit file welcome.html, Anda diperbolehkan untuk mengisi kabar disini. Bila Anda
		tulis teks disini, file welcome.html akan diabaikan. Diperbolehkan untuk menggunakan
		<i>HTML Tags</i> disini.
		";

$GLOBALS['phpAds_hlp_updates_frequency'] = "	Bila Anda ingin tahu apakah sudah tersedia versi baru dari {$PRODUCT_NAME}, fungsi ini
		harus ditepatkan pada  posisi On. Diperbolehkan untuk menentukan jarak waktu yang berulang,
		{$PRODUCT_NAME} akan membuka koneksi ke update server tersendiri. Jika ditemukan
		versi yang baru, sebuah kabar akan muncul untuk memberikan informasi tambahan tentang
		update tersebut.
		";

$GLOBALS['phpAds_hlp_userlog_email'] = "	Bila Anda ingin simpan salinan dari seluruh E-Mail yang dikirim oleh {$PRODUCT_NAME},
		fungsi ini harus ditepatkan pada posisi On. Seluruh E-Mail akan tersimpan dalam
		<i>Userlog</i>.
		";

$GLOBALS['phpAds_hlp_userlog_priority'] = "	Untuk memastikan bahwa kalkulasi prioriti sudah berjalan dengan baik, Anda bisa menyimpan laporan
...
$GLOBALS['phpAds_hlp_userlog_autoclean'] = "	Untuk memastikan bahwa database telah dipangkas secara benar, Anda bisa simpan sebuah laporan
		tentang apa saja yang terjadi sewaktu pemangkasan tersebut dijalankan. Informasi ini
		akan tersimpan pada Userlog.
		";

$GLOBALS['phpAds_hlp_default_banner_weight'] = "	Bila Anda ingin menggunakan bobot banner yang lebih tinggi sebagai default, silakan tentukan bobot
		yang diinginkan disini. Stelan 1 adalah penyetelan default.
		";

$GLOBALS['phpAds_hlp_default_campaign_weight'] = "	Bila Anda ingin menggunakan bobot kampanye yang lebih tinggi sebagai default, silakan tentukan bobot
		yang diinginkan disini. Stelan 1 adalah penyetelan default.
		";

$GLOBALS['phpAds_hlp_gui_show_campaign_info'] = "	Bila penyetelan ini diaktifkan, sebuah informasi khusus tentang setiap kampanye akan ditampilkan
...
$GLOBALS['phpAds_hlp_gui_show_banner_info'] = "	Bila penyetelan ini diaktifkan, sebuah informasi khusus tentang setiap banner akan ditampilkan
...
$GLOBALS['phpAds_hlp_gui_show_campaign_preview'] = "	Bila penyetelan ini diaktifkan, sebuah <i>Preview</i> dari semua banner akan ditampilkan pada halaman
...
$GLOBALS['phpAds_hlp_gui_show_banner_html'] = "	Bila penyetelan ini diaktifkan, banner yang sebenarnya akan ditampilkan dan bukan kode HTML. Penyetelan
...
$GLOBALS['phpAds_hlp_gui_show_banner_preview'] = "	Bila penyetelan ini diaktifkan, sebuah <i>Preview</i> akan ditampilkan pada halaman <i>Properties dari
...
$GLOBALS['phpAds_hlp_gui_hide_inactive'] = "	Bila penyetelan ini diaktifkan, seluruh banner, kampanye dan Pemasang Iklan akan disembunyikan
...
$GLOBALS['phpAds_hlp_gui_show_matching'] = "	Bila pilihan ini diaktifkan banner sebanding akan tertampil pada halaman <i>Linked banners</i> jika
...
$GLOBALS['phpAds_hlp_gui_show_parents'] = "	Bila pilihan ini diaktifkan kampanye induk dari banner akan tertampil pada halaman <i>Linked banners</i>
...
$GLOBALS['phpAds_hlp_gui_link_compact_limit'] = "	Secara Default seluruh banner dan kampanye yang tersedia ditampilkan pada halaman <i>Linked banners</i>.
