...
$GLOBALS['strDeliveryCacheExplaination']		= "	전달유지 �?시(delivery cache)는 배너를 빠르게 전달하기 위해 사용하는 방법�?�다.
...
$GLOBALS['strForUpdatesLookOnWebsite']	= "	You are currently running {$PRODUCT_NAME} ".$phpAds_version_readable.".
