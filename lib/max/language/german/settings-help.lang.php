...
+---------------------------------------------------------------------------+
$Id: settings-help.lang.php 5631 2006-10-09 18:21:43Z andrew@m3.net $
*/
...
$GLOBALS['phpAds_hlp_dbuser'] = "
        Geben Sie den Benutzername f&uuml;r die <i>Datenbank</i> an. Mit diesem Benutzername greift ".$phpAds_productname." auf den Datenbankserver von ".$phpAds_dbmsname." zu.
		";

$GLOBALS['phpAds_hlp_dbpassword'] = "
Geben Sie das Passwort f&uuml;r die <b>Datenbank</b> an. Mit diesem Passwort kann ".$phpAds_productname." auf den Datenbankserver von ".$phpAds_dbmsname." zugreifen.
		";
...
$GLOBALS['phpAds_hlp_persistent_connections'] = "
        Die dauerhafte Verbindung zur Datenbank kann die Geschwindigkeit von ".$phpAds_productname." durchaus erh&ouml;hen, insbesondere wird die Ladezeiten vom Server verringert. Andererseits k&ouml;nnen bei Seiten mit sehr vielen Besuchern - genau gegenteilig zu oben - durch die dauerhafte Verbindung die Ladezeiten erheblich ansteigen. <br />
Welche Art der Verbindung gew&auml;hlt wird, <i>normale</i> oder <i>dauerhafte</i>, ist abh&iuml;&auml;ngig von der Besucherzahl und der eingesetzten Hardware. Wenn ".$phpAds_productname." zu viele Ressourcen belegt, k&ouml;nnte dies durch die Einstellung <i>dauerhafte Verbindung </i> hervorgerufen worden sein.
		";

$GLOBALS['phpAds_hlp_compatibility_mode'] = "
        Wird die Datenbank ".$phpAds_dbmsname." nicht nur von ".$phpAds_productname.", sondern auch von weiteren Anwendungen genutzt, k&ouml;nnen unter Umst&auml;nden Kompatibilit&auml;tsprobleme auftreten. Durch setzen des Kompatibilit&auml;tsmodus (Datenbank) werden diese Probleme behoben.<br />
Wenn die Bannerauslieferung im <i>lokalen Modus</i> erfolgt und Kompatibilit&auml;tsmodus (Datenbank) gesetzt ist, hinterl&auml;&szlig;t ".$phpAds_productname." die Einstellungen der Datenbank so, wie diese vorher vorgefunden wurden. <br />
...
".$phpAds_productname." kann mehrfach installiert werden , wobei alle installierten Programme auf dieselbe Datenbank zugreifen k&ouml;nnen. Es mu&szlig; dann f&uuml;r jede Anwendung den Tabellennamen ein eigener eindeutiger  <i>Pr&auml;fix</i> vorangestellt werden.
		";

$GLOBALS['phpAds_hlp_table_type'] = "
        ".$phpAds_dbmsname." unterst&uuml;tzt mehrere Tabellentypen. Jeder Tabellentype hat seine eigenen Eigenschaften, die es durchaus erm&ouml;glichen, ".$phpAds_productname." stark zu beschleunigen. <br />
MyISAM ist der immer vorhandene Tabellentype und daher Voreinstellung bei ".$phpAds_dbmsname.".
		";

$GLOBALS['phpAds_hlp_url_prefix'] = "
        ".$phpAds_productname." ben&ouml;tigt f&uuml;r das korrekte Funktionieren die genaue Angabe &uuml;ber den eigenen Standort auf dem Server. Ben&ouml;tigt wird die URL und das Verzeichnis, in dem ".$phpAds_productname." installiert ist. Z.B.: <i>http://www.your-url.com/".$phpAds_productname."</i>.
		";
...
$GLOBALS['phpAds_hlp_name'] = "
        Es besteht die M&ouml;glichkeit, f&uuml;r die Anwendung anstelle <i>".$phpAds_productname." </i> eine
...
$GLOBALS['phpAds_hlp_override_gd_imageformat'] = "
         ".$phpAds_productname." pr&uuml;ft standardm&auml;&szlig;ig, ob die Bibliothek GD-library installiert ist und
...
$GLOBALS['phpAds_hlp_compact_stats'] = "
	".$phpAds_productname." bietet die M&ouml;glichkeit, entweder detaillierte Statistiken oder kompakte zu w&auml;hlen. f&uuml;r die kompakten Statistiken werden AdViews und AdClicks gesammelt und st&uuml;ndlich verarbeitet. Die detaillierten Statistiken ben&ouml;tigen mehr Datenbank-Ressourcen.
		";
...
$GLOBALS['phpAds_hlp_proxy_lookup'] = "
		Verwendet der Besucher einen Proxy-Zugang, protokolliert ".$phpAds_productname." normalerweise die IP-Adresse und/oder den Hostname des Proxy-Servers. Diese Erfassung kann so gesetzt werden, da&szlig; ".$phpAds_productname." versucht, den tats&auml;chlichen Hostnamen oder die IP-Adresse zu ermitteln, die hinter dem Proxy-Server steht. Kann diese  <i>richtige</i> Adresse des Besuchers nicht ermittelt werden, werden die Daten des Proxy-Servers verwendet. In der Voreinstellung ist diese Option deaktiviert, da sie die Bannerauslieferung verlangsamt.
		";
...
f&uuml;r Geotargeting wird eine spezielle Datenbank ben&ouml;tigt. ".$phpAds_productname." unterst&uuml;tzt die Datenbanken von  <a href='http://hop.clickbank.net/?phpadsnew/ip2country' target='_blank'>IP2Country</a> und <a href='http://www.maxmind.com/?rId=phpadsnew' target='_blank'>GeoIP</a>.
		";

$GLOBALS['phpAds_hlp_geotracking_location'] = "
		Wenn nicht das Modul GeoIP Apache verwendet wird, mu&szlig; f&uuml;r ".$phpAds_productname." das Verzeichnis eingegeben werden, in dem sich die Geotargeting-Datenbank befindet. Empfehlenswert ist es, diese au&szlig;erhalb des Dokumentenverzeichnisses des Web-Servers abzulegen; da diese andernfalls f&uuml;r Dritte einsehbar sein k&ouml;nnte.
		";
...
$GLOBALS['phpAds_hlp_warn_admin'] = "
	Es besteht die M&ouml;glichkeit, da&szlig; ".$phpAds_productname." eine E-Mail an den Administrator sendet, wenn f&uuml;r eine Kampagne ein bestimmtes Restguthaben f&uuml;r AdViews oder AdClicks unterschritten wurde. In der Voreinstellung ist diese Option gesetzt.
		";

$GLOBALS['phpAds_hlp_warn_client'] = "
	Es besteht die M&ouml;glichkeit, da&szlig; ".$phpAds_productname." eine E-Mail an den Inserenten sendet, wenn f&uuml;r eine Kampagne ein bestimmtes Restguthaben f&uuml;r AdViews oder AdClicks unterschritten wurde.
In der Voreinstellung ist diese Option gesetzt.
		";

$GLOBALS['phpAds_hlp_qmail_patch'] = "
	Einigen Versionen von <i>qMail</i> sind fehlerbehaftet. Die Kopfzeile der E-Mail wird in den Haupttext verschoben. Hier kann festgelegt werden, da&szlig; ".$phpAds_productname." jede E-Mail in einem Format versendet, das von <i>qMail</i> korrekt wiedergegeben wird.
		";

$GLOBALS['phpAds_hlp_warn_limit'] = "
	Eingegeben wird das Restguthaben, nach dessen Unterschreitung ".$phpAds_productname." Warnungen per E-Mail versendet. Voreinstellung ist 100.
		";
...
$GLOBALS['phpAds_hlp_allow_invocation_popup'] = "
		Mit dieser Einstellung werden die Verfahren der Bannerauslieferung festgelegt. f&uuml;r jedes Verfahren wird ein eigener Bannercode erstellt. Ist eines der Verfahren an dieser Stelle deaktiviert, erfolgt diese Sperre nur f&uuml;r den Bannercode-Generator. Der Ausschlu&szlig; des Verfahrens betrifft Bannercodes an sich nicht. Existierende Banner eines ausgeschlossenen Verfahrens bleiben weiterhin lauff&auml;hig.
		";

$GLOBALS['phpAds_hlp_con_key'] = "
		f&uuml;r den lokalen Modus als Verfahren zur Bannerauslieferung bietet ".$phpAds_productname." m&auml;chtige Werkzeuge zur Selektion. Unter anderem k&ouml;nnen hier logische Operatoren verwendet werden. Weitere Informationen finden sich im Handbuch. In der Voreinstellung ist diese Option gesetzt.
		";
...
$GLOBALS['phpAds_hlp_type_web_dir'] = "
	In das hier festgelegte Verzeichnis speichert ".$phpAds_productname." die hochgeladenen Banner. Das Verzeichnis darf f&uuml;r PHP nicht schreibgesch&uuml;tzt sein. Es mu&szlig;, ggf. mit Hilfe eines FTP-Programmes, die Zugriffs- und Schreibberechtigung gesetzt werden. Das Verzeichnis mu&szlig; im Root-Verzeichnis von ".$phpAds_productname." sein. Bei der Eingabe des Verzeichnisses darf als Ende kein  Slash (/) eingegeben werden. Diese Angaben werden nur bei  <i>Lokales Verzeichnis</i> als Wahl f&uuml;r die Speicherung ben&ouml;tigt.
		";
...
$GLOBALS['phpAds_hlp_type_html_auto'] = "
	Durch diese Option modifiziert ".$phpAds_productname." den HTML-Code so, da&szlig; AdClicks aufgezeichnet werden k&ouml;nnen. Auch wenn diese Option an dieser Stelle aktiviert wird, ist es dennoch m&ouml;glich, sie f&uuml;r jeden Banner individuell zu deaktivieren.
		";
...
$GLOBALS['phpAds_hlp_admin_E-Mail'] = "
	Eingabe der E-Mail-Adresse des Administrators. Die Angaben werden f&uuml;r E-Mails ben&ouml;tigt.
		";

$GLOBALS['phpAds_hlp_admin_E-Mail_headers'] = "
	Die Kopfzeile f&uuml;r die E-Mails, die ".$phpAds_productname." versenden soll, kann hier ge&auml;ndert werden.
		";
...
$GLOBALS['phpAds_hlp_updates_frequency'] = "
		".$phpAds_productname." wird st&auml;ndig optimiert. Es kann in selbst definierten Intervallen direkt beim Update-Server nach neuen Versionen gesucht werden. Ist eine neue Version vorhanden, werden in einem Dialogfenster zun&auml;chst weitere Informationen &uuml;ber das Update gegeben.
		";

$GLOBALS['phpAds_hlp_userlog_email'] = "
		Soll von allen durch ".$phpAds_productname."  versandte E-Mails eine Kopie angefertigt werden, kann das durch diese Option erm&ouml;glicht werden. Die E-Mails werden in das Benutzerprotokoll eingetragen.
		";
...
$GLOBALS['phpAds_hlp_gui_link_compact_limit'] = "
	Als Voreinstellung werden auf der Seite <i>Verkn&uuml;pfte Banner</i> alle verf&uuml;gbaren Banner oder Kampagnen angezeigt. Da diese Anzeige sehr lang werden kann, gestattet diese Option die Darstellung einer maximalen Anzahl von Positionen. Sind mehr Positionen als festgelegt vorhanden, aber verschiedene Wege der Darstellung, wird die Darstellungsart gew&auml;hlt, die weniger Platz ben&ouml;tigt.		";
