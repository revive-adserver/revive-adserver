...
$GLOBALS['strIframeResizeToBanner']		= "Iframe an die Bannergr&ouml;&szlig;e anpassen";
$GLOBALS['strIframeMakeTransparent']		= "Iframe transparent darstellen";
$GLOBALS['strIframeIncludeNetscape4']		= "Netscape 4 kompatiblen ilayer (zus&auml;tzlich)";
...
$GLOBALS['strShowMenubar']			= "Men&uuml;leiste";
$GLOBALS['strShowStatus']			= "Statusleiste";
$GLOBALS['strWindowResizable']		= "G&ouml;&szlig;e anpassen";
...
$GLOBALS['strBannerPadding']			= "Banner ausf&uuml;llen";
...
$GLOBALS['strHideDelay']			= "Verz&ouml;gerung bis zum Verbergen des Banners";
...
$GLOBALS['str3rdPartyTrack']		= "3rd Party Server Klick-Tracking unterst&uuml;tzen";

// Support for cachebusting code
$GLOBALS['strCacheBuster']		    = "Cache-Busting Code einf&uuml;gen";

// Non-Img creatives Warning for zone image-only invocation
$GLOBALS['strNonImgWarningZone']	= "Warnung: Dieser Ad-Tag enth&auml;lt Werbemittel, die keine Banner sind. Diese Werbemittel werden durch diese Zone nicht ausgeliefert.";
...
$GLOBALS['strWebBannerWarning']     = "Warnung: Dieses Werbemittel mu&szlig; heruntergeladen werden und Sie m&uuml;ssen uns die korrekte Klick-URL f&uuml;r dieses Werbemittel senden.
<br /> 1) Banner-Download:";
$GLOBALS['strDwnldWebBanner']       = "Mit der rechten Maustaste klicken und Ziel speichern als ausw&auml;hlen";
...
$GLOBALS['strImgWithAppendWarning'] = "Dieser Tracker hat angeh&auml;ngten Code.<br />Angeh&auml;ngter Code kann nur &uuml;ber JavaScript-Tags ausgef&uuml;hrt werden";
