...
$GLOBALS['strAlreadyInstalled']			= "{$PRODUCT_NAME} jest już zainstalowany na tym systemie. Jeżeli chcesz go skonfigurować, idź do <a href='settings-index.php'>części ustawień</a>";
...
$GLOBALS['strTableInUse']			= "Baza danych, którą podałeś jest już używana przez {$PRODUCT_NAME}, podaj inny prefiks tabeli lub przeczytaj w dokumentacji instrukcje dotyczące aktualizacji.";
...
$GLOBALS['strWarningPHPversion']		= "{$PRODUCT_NAME} wymaga PHP 4.0 lub nowszego do poprawnego funkcjonowania. Na serwerze jest obecnie {php_version}.";
...
$GLOBALS['strConfigLockedDetected']		= "{$PRODUCT_NAME} wykryło, że twój plik <b>config.inc.php</b> nie może być modyfikowany przez server.<br /> Kontynuacja nie będzie możliwa zanim nie zmienisz uprawnień dla tego pliku. <br />Przeczytaj dołączoną dokumentację, jeżeli nie wiesz jak to zrobić.";
...
$GLOBALS['strInstallWelcome']			= "Witamy w {$PRODUCT_NAME}";
$GLOBALS['strInstallMessage']			= "Zanim możesz zacząć używać {$PRODUCT_NAME} musi on zostać skonfigurowany i <br /> utworzona zostać baza danych. Kliknij <b>Dalej</b> aby kontynuować.";
...
$GLOBALS['strUpdateSuccess']			= "<b>Aktualizacja {$PRODUCT_NAME} zakończyła się pomyślnie.</b><br /><br />Aby zapewnić prawidłowe funkcjonowanie {$PRODUCT_NAME} musisz także
...
$GLOBALS['strInstallIntro'] = "Dziękujemy za wybranie <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Kreator pomoże Ci zainstalować / zaktualizować {$PRODUCT_NAME}  </p><p> Aby ułatwić proces instalacji opracowaliśmy przewodnik a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Installation Quick Start Guide</a>, który umożliwi Ci sprawną aktywację. Bardziej szczegółowe informacje na temat instalacji i konfiguracji {$PRODUCT_NAME}  uzyskasz w przewodniku <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Administrator Guide</a>.";
...
$GLOBALS['strTermsIntro'] = "{$PRODUCT_NAME} jest udostępniony w ramach licencji Open Source, GNU General Public License. Proszę przeczytać i zaakceptować następujące dokumenty, aby kontynuować instalację.";
...
$GLOBALS['strDbUpgradeIntro'] = "Poniżej znajdują się informacje o bazie danych potrzebne do instalacji {$PRODUCT_NAME}. Sprawdź ich poprawność. <p>Kolejnym krokiem będzie aktualizowanie bazy danych. Kliknij 'Dalej', aby aktualizować system.</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "Zaloguj się jako administrator {$PRODUCT_NAME}, aby kontynuować proces aktualizacji. Do ukończenia aktualizacji wymagany jest login administratora.";
...
$GLOBALS['strWebPath'] = "Ścieżka dostępu serwera {$PRODUCT_NAME}";
...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} został juz zainstalowany. Jeśli chcesz go skonfigurować przejdź do <a href='account-index.php'>menadżera ustawień</a>.";
