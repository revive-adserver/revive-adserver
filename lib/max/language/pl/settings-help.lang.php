...
$GLOBALS['phpAds_hlp_dbhost'] = "        Specify the hostname of the {$phpAds_dbmsname} database server.
		";
...
$GLOBALS['phpAds_hlp_company_name'] = "Ta nazwa używana jest w e-mailu wysyłanym przez {$PRODUCT_NAME}.";
...
$GLOBALS['phpAds_hlp_block_adviews'] = "		If a visitor reloads a page an AdView will be logged by {$PRODUCT_NAME} every time.
		...
		to 300 seconds, {$PRODUCT_NAME} will only log AdViews if the same banner isn�?ż�?t already
...
$GLOBALS['phpAds_hlp_block_adclicks'] = "		If a visitor clicks multiple times on a banner an AdClick will be logged by {$PRODUCT_NAME}
		...
		to 300 seconds, {$PRODUCT_NAME} will only log AdClicks if the visitor didn�?ż�?t click on the same
...
$GLOBALS['phpAds_hlp_warn_client'] = "{$PRODUCT_NAME} może wysłać e-mail do reklamodawcy, jeśli jedna z jego kampanii ma tylko";
...
{$PRODUCT_NAME} widnieje nagłówek. Jeśli uaktywnisz
to ustawienie, {$PRODUCT_NAME} wyśle e-mail w formacie kompatybilnym z qmail.";

$GLOBALS['phpAds_hlp_warn_limit'] = "Limit, od którego {$PRODUCT_NAME} zaczyna wysyłać e-maile z ostrzeżeniem. Domyślnie 100";
...
$GLOBALS['phpAds_hlp_admin'] = "        The administrator username, you can specify the username that you can
...
$GLOBALS['phpAds_hlp_client_welcome_msg'] = "       If you turn this feature on a welcome message will be displayed on the
        first page an advertiser will see after logging in. You can personalize this
        message by editing the 'welcome.html' file location in the 'admin/templates'        directory. Things you might want to include are for example: Your company
