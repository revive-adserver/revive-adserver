...
$GLOBALS['strInstallSuccess'] = "Z klikom na 'Nadaljuj' se boste prijavili v vaš oglaševalski strežnik.	<p><strong>Kaj sledi?</strong></p>	<div class='psub'>	  <p><b>Prijavite se na posodobitve o izdelku</b><br>	    <a href='{$PRODUCT_DOCSURL}/wizard/join' target='_blank'>Prijavite se na {$PRODUCT_NAME} elektronsko sporočanje</a> o posodobitvah izdelka, varnostnih popravkih in oznanilih o novih izdelkih.	  </p>	  <p><b>Ustvarjanje vaše prve oglaševalske kampanje</b><br>	    Uporabite <a href='{$PRODUCT_DOCSURL}/wizard/qsg-firstcampaign' target='_blank'>hitri vodič pri ustvarjanju prve oglaševalske kampanje</a>.	  </p>	</div>	<p><strong>Dodatni namestitveni koraki</strong></p>	<div class='psub'>	  <p><b>Zaklenite vaše konfiguracijske datoteke</b><br>	    To je dodaten varnostni ukrep pri zaščiti vaših datotek pred spremenitvijo.  <a href='{$PRODUCT_DOCSURL}/wizard/lock-config' target='_blank'>Več o tem</a>.	  </p>	  <p><b>Nastavi redno vzdrževalno nalogo</b><br>	    Vzdrževalna skripta je priporočljiva za zagotovitev pravočasnih in optimalnih učinkov oglaševalske dostave.  <a href='{$PRODUCT_DOCSURL}/wizard/setup-cron' target='_blank'>Več o tem</a>	  </p>	  <p><b>Preglejte vaše konfiguracijske nastavitve</b><br>	    Pred uporabo {$PRODUCT_NAME} vam priporočamo pregled vaših nastavitev s klikom na zaznamek 'Nastavitve'.	  </p>	</div>";
$GLOBALS['strInstallNotSuccessful'] = "<b>Namestitev {$PRODUCT_NAME} ni bila uspešna</b><br /><br />Nekateri deli namestitve niso mogli biti dokončani.
...
$GLOBALS['strDbSuccessIntro'] = "{$PRODUCT_NAME} podatkovna baza je bila ustvarjena. Prosimo, kliknite \"Nadaljuj\" za napotitev h konfiguraciji {$PRODUCT_NAME} nadzorniških in dostavnih nastavitev.";
...
$GLOBALS['strDemoDataIntro'] = "Privzete datoteke lahko naložite v {$PRODUCT_NAME} kot pomoč pri prvi uporabi spletne oglaševalske aplikacije. Najpogostejši tipi pasic, kakor tudi začetnih kampanj so lahko naloženi in prednastavljeni. Priporočljivo za nove namestitve.";
