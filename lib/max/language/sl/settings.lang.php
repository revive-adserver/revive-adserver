...
$GLOBALS['strInstallIntro'] = "Hvala za uporabo <a href='http://{$PRODUCT_URL}' target='_blank'><strong>{$PRODUCT_NAME}</strong></a><p>Ta čarovnik vas bo vodil skozi celoten postopek namestitve / posodobitve {$PRODUCT_NAME} oglaševalskega strežnika.</p><p>Za pomoč pri namestitvenem postopku smo za vas ustvarili <a href='{$PRODUCT_DOCSURL}/wizard/qsg-install' target='_blank'>Hiter vodič pri namestitvi</a> , ki vam omogoča spoznavanje celotnega postopka. Za podrobnejši vodič pri namestitvi in nastavitvi {$PRODUCT_NAME} obiščite <a href='{$PRODUCT_DOCSURL}/wizard/admin-guide' target='_blank'>Administratorski vodič</a>.";
...
$GLOBALS['strTermsIntro'] = "{$PRODUCT_NAME} se razpečuje prosto pod odprtokodno licenco GNU (General Public License). Prosimo, preglejte naslednjo dokumentacijo za nadaljevanje namestitve.";
...
$GLOBALS['strDbUpgradeIntro'] = "Spodaj so najdene podrobnosti podatkovne baze za vašo namestitev {$PRODUCT_NAME}. Prosimo, preverite če so podrobnosti pravilne.<p>Z naslednjim korakom boste posodobili svojo podatkovno bazo. Kliknite 'Nadaljuj' za posodobitev vašega sistema.</p>";
...
$GLOBALS['strLoginSettingsIntro'] = "Za nadaljevanje posodobitvenega postopka, prosimo vnesite vaše {$PRODUCT_NAME} podatke o administratorskem računu. Prijaviti se morate kot administrator za nadaljevanje posodobitvenega postopka.";
...
$GLOBALS['strWebPath'] = "{$PRODUCT_NAME} Dostopne poti strežnika";
...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} je že nameščen na ta sistem. Če bi ga radi konfigurirali, pojdite na <a href='account-index.php'>Nastavitve vmesnika</a>.";
...
$GLOBALS['strWarningPHPversion'] = "{$PRODUCT_NAME} potrebuje PHP  različice 5.1.4 ali višje za pravilno delovanje. Trenutno uporabljate različico {php_version}.";
