...
$GLOBALS['strAlreadyInstalled'] = "{$PRODUCT_NAME} تم تنصيبه بنجاح على نظامك. إذا كنت تريد تعديله يمكنك الذهاب إلى <a href='account-index.php'>خيارات شكل لوحة التحكم</a>.";
