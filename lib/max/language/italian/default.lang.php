...
$GLOBALS['strNoAdminInterface']				= "L'interfaccia di amministrazione è stata disattivata per manutenzione. La consegna dei banner continua a funzionare come previsto.";
$GLOBALS['strFilterBySource']				= "filtra per sorgente";
$GLOBALS['strFieldContainsErrors']			= "I seguenti campi contengono errori:";
$GLOBALS['strFieldFixBeforeContinue1']		= "Prima di continuare &egrave; necessario";
...
$GLOBALS['strCampaignWarningNoWeight']		= "Questa campagna � stata impostata come campagna a bassa priorit�, \nma il suo peso � impostato a zero o non � stato specificato. \nQuesto comporter� la disattivazione della campagna: i suoi banner \nnon verranno visualizzati finch� il peso non sar� impostato \nad un numero valido. \n\nSei sicuro di voler procedere?";
$GLOBALS['strCampaignWarningNoTarget']		= "Questa campagna � stata impostata come campagna ad alta priorit�, \nma il numero di Visualizzazioni giornaliere non � stato specificato. \nQuesto comporter� la disattivazione della campagna: i suoi banner \nnon verranno visualizzati finch� non sar� impostato \nun numero valido di Visualizzazioni giornaliere. \n\nSei sicuro di voler procedere?";
...
$GLOBALS['strMaintenanceNotActive']			= "Lo script di manutenzione non � stato lanciato nelle ultime 24 ore. \\nAffinch� ".$phpAds_productname." funzioni correttamente esso deve essere lanciato \\nogni ora. \\n\\nLa ggere la Administrator guide per maggiori informazioni \\nsu come configurare lo script di manutenzione.";
...
$GLOBALS['strMailClientDeactivated']		= "I seguenti banner sono stati disattivati poich�";
...
$GLOBALS['strNoMoreClicks']					= "non ci sono pi� Click a disposizione";
$GLOBALS['strNoMoreViews']					= "non ci sono pi� Visualizzazioni a disposizione";
$GLOBALS['strWeightIsNull']					= "il suo peso � impostato a zero";
