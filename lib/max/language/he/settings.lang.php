...
$GLOBALS['strUpdateDatabaseError']	= "מסיבות ל�? ברורות עדכון בסיס הנתוני�? ל�? הצליח. הררך המומלצת להמשיך הי�? ללחוץ <b>נסה עדכון מחדש</b> כדי לנסות ולתקן בעיות �?פשריות. �?�? �?תה בטוח שבעיות �?לו ל�? יכולות לפגוע בתפקוד {$PRODUCT_NAME} �?תה יכול ללחוץ <b>התעל�? משגי�?ות</b> כדי להמשיך. התעלמות משגי�?ות �?לו �?פשר שתיור בעיה חמורה וזה ל�? מומלץ!";
$GLOBALS['strAlreadyInstalled']			= "{$PRODUCT_NAME} כבר מותקנת במערכת זו. �?�? �?תה רוצה לעצב �?ותה לך ל<a href='settings-index.php'>קיבעות ממשק</a>";
...
$GLOBALS['strTableInUse']			= "בסיס הנתוני�? שרשמת נמצ�? כבר בשימוש של {$PRODUCT_NAME}, �?נ�? בחר בקידומת טבל�?ות �?חרת, �?ו קר�? �?ת המדריך לגבי הור�?ות שדרוג.";
...
$GLOBALS['strFixProblemsBefore']		= "הפריט(י�?) הב�?(י�?) דורשי�? תיקון לפני שניתן יהיה להתקין �?ת {$PRODUCT_NAME}. �?�? יש לך ש�?לה לגבי שי�?ה זו, �?נ�? קר�? �?ת ה<i>מדריך ל�?דמיניסטרטור</i>, הנמצ�? בחבילה שהורדת.";
$GLOBALS['strFixProblemsAfter']			= "�?�? �?ין ב�?פשרותך לתקן �?ת הבעיה שהוצגה מעלה, נ�? צור שר ע�? ה�?חר�?י של השרת שעליו �?תה מנסה להתקין �?ת {$PRODUCT_NAME}. �?פשר שהו�? יוכל לעזור לך �?ו לכוון לפתרון.";
$GLOBALS['strIgnoreWarnings']			= "התעל�? מ�?ז�?רות";
$GLOBALS['strWarningPHPversion']		= "{$PRODUCT_NAME} נדרש PHP 4.0 �?ו גירסה גבוהה יותר לש�? תפקוד נכון. �?תה משתמש כעת בגירסה {php_version}.";
...
$GLOBALS['strConfigLockedDetected']		= "{$PRODUCT_NAME} זיהה שהקובץ <b>config.inc.php</b> מוגן מכתיבה.<br> ל�? תוכל להמשיך עד שתשנה �?ת �?ישור הגישה לקובץ זה. <br>קר�? �?ת התיעוד המצורף �?�? �?ינך יודע כיצד לעשות ז�?ת.";
...
$GLOBALS['strInstallWelcome']			= "ברוכי�? הב�?י�? ל{$PRODUCT_NAME}";
$GLOBALS['strInstallMessage']			= "לפני השימוש ב-{$PRODUCT_NAME} יש לעצב �?ת תפקודי התוכנה ויצור בסיס נתוני�?.<br>לחץ <b>המשך</b> להתקדמות.";
...
$GLOBALS['strUpdateSuccess']			= "<b>העדכון של {$PRODUCT_NAME} הסתיי�? בהצלחה.</b><br><br>כדי ש-{$PRODUCT_NAME} תתפקד נכון עליך ג�? להבטיח שקובץ התחזוקה ירוץ כל שעה (עד עתה הו�? נדרש לרוץ פע�? ביו�?) מידע נוסף בנוש�? זה ניתן למצו�? בתיעוד המצורף. <br><br>לחץ <b>המשך</b> כדי להגיע לעמוד ממשק ההנהלה. �?נ�? �?ל תשכח לנעול �?ת הקובץ  <B>config.inc.php</B> למניעת בעיות �?בטחה.";
