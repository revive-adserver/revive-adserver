...
$GLOBALS['strDeliveryCacheExplaination']		= "	זיכרון-מטמון תפוצה משמש להמהרת התפוצה של הב�?נרי�?. המטמון כולל העתק של כל הב�?נרי�? המקושרי�? ל�?יזור, מה שחוסך קרי�?ות נוספות לבסיס הנתוני�? כ�?שר הב�?נרי�? נקר�?י�? לתצוגה ממשית. המטמון מתחדש בכל פע�? שחל שינוי ל�?יזור �?ו ל�?חד מהב�?נרי�? שבתוכו, ויש �?פשרות שהו�? ייהפך למיושן. מכ�?ן שהו�? נבנה מחדש כל שעה, �?ך ניתן להפעיל ז�?ת ג�? ידנית.";
...
$GLOBALS['strForUpdatesLookOnWebsite']	= "	�?תה מריץ כעת {$PRODUCT_NAME} ".$phpAds_version_readable.".
