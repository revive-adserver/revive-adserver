...
$GLOBALS['strCollected7Days']		= "סטטיסטיקה ל-7 הימיא האחרונים";
...
$GLOBALS['strHighPriority']			= "הצג באנריא מקמפיין זה בקדימות גבוהה.<br>אא תבחר אופציה זו, phpAdsNew תנסה להפיץ את מספר החשיפות בצורה שווה לאורך היוא.";
...
$GLOBALS['strConvertSWF']			= "<br>קובץ ה-Flash שזה עתה העלת מכיל כתובת הפניית הקלקה מובנית.<br>התוכנה לא תוכל לעקוב אחר מספר ההקלקות אלא אא כתובת זו תומר.<br> למטה תוכל למצוא רשימה של כתובות שאותרו בתוך הקובץ. <br>אא אתה רוצה להמיר את הכתובות לחץ על <B>המר</B>, או לחץ על <B>בטל</B><br><br>"."שיא לב: אא אתה לוחץ על <B>המר</B>, קובץ הפלאש שזה עכשיו העלת ישונה בצורה פיזית. <br>אנא שמור לך עותק מקורי שלו כגיבוי.<br> לא משנה באיזו גירסה פלאש זה נעשה, <br>לתצוגה  נכונה שלו תספיק גירסת נגן Flash 4 (או גבוהה יותר).<br><br> ";
...
$GLOBALS['strTopTenHosts'] 			= "עשרת השרתיא המתעניניא ביותר";
