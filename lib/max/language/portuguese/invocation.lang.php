...
$GLOBALS['strInvocationWhat']			= "Selec��o de An�ncio";
...
$GLOBALS['strInvocationWithText']		= "Mostrar texto abaixo do an�ncio";
$GLOBALS['strInvocationDontShowAgain']	= "N�o repetir o an�ncio na mesma p�gina";
$GLOBALS['strInvocationTemplate'] 		= "Guardar o an�ncio numa vari�vel para que possa ser usado num <i>template</i>";

// Iframe
$GLOBALS['strIFrameRefreshAfter']		= "Renovar ap�s";
$GLOBALS['strIframeResizeToBanner']		= "Redimensionar <i>iframe</i> para as dimens�es do an�ncio";
...
$GLOBALS['strPopUpCreateInstance']		= "Criar inst�ncia quando o pop-up � criado";
$GLOBALS['strPopUpImmediately']			= "Immediatamente";
$GLOBALS['strPopUpOnClose']				= "Quando a p�gina � encerrada";
$GLOBALS['strPopUpAfterSec']			= "Ap�s";
$GLOBALS['strAutoCloseAfter']			= "Automaticamente encerrada ap�s";
$GLOBALS['strPopUpTop']					= "Posi��o Inicial (topo)";
$GLOBALS['strPopUpLeft']				= "Posi��o Inicial (esquerda)";
...
$GLOBALS['strAutoCollapseAfter']		= "Desaparece autom�ticamente ap�s";
