...
$GLOBALS['phpAds_hlp_dbhost'] = "	Vul hier het IP adres of de domeinnaam van de {$phpAds_dbmsname} database server in.";

$GLOBALS['phpAds_hlp_dbuser'] = "        Vul hier de gebruikersnaam in wat {$PRODUCT_NAME} moet gebruiken om toegang te krijgen tot de
	{$phpAds_dbmsname} database server.";

$GLOBALS['phpAds_hlp_dbpassword'] = "	Vul hier het wachtwoord in wat {$PRODUCT_NAME} moet gebruiken om toegang te krijgen tot de
	{$phpAds_dbmsname} database server.";

$GLOBALS['phpAds_hlp_dbname'] = "	Vul hier de naam van de database in welke {$PRODUCT_NAME} moet gebruiken om gegevens
	op te slaan.";
...
$GLOBALS['phpAds_hlp_tabletype'] = "	{$phpAds_dbmsname} ondersteund meerdere types tabellen. Elk type heeft unieke eigenschappen en sommige
	tabeltypen kunnen de snelheid van {$PRODUCT_NAME} ten goede beinvloeden. MyISAM is de standaard
...
$GLOBALS['phpAds_hlp_url_prefix'] = "	Om correct te functioneren moet {$PRODUCT_NAME} zijn eigen locatie op de webserver
	weten. U moet de volledige URL invoeren van de map waar {$PRODUCT_NAME} is geinstalleerd,
	bijvoorbeeld: http://www.uwwebsite.nl/{$PRODUCT_NAME}.";

$GLOBALS['phpAds_hlp_my_header'] =
$GLOBALS['phpAds_hlp_my_footer'] = "	U kunt hier het pad naar de voetnoot en eindnoot bestanden invoeren (bijv.
...
$GLOBALS['phpAds_hlp_language'] = "	Specificeer de standaard taal die {$PRODUCT_NAME} moet gebruiken. Deze taal zal
...
$GLOBALS['phpAds_hlp_name'] = "	Specificeer de naam die uw wilt gebruiken voor deze applicatie. De naam
	...
	{$PRODUCT_NAME} zelf getoond worden.";

$GLOBALS['phpAds_hlp_company_name'] = "Specificeer de naam die gebruikt moet worden in alle e-mails die {$PRODUCT_NAME} verstuurd.";

$GLOBALS['phpAds_hlp_override_gd_imageformat'] = "	Normaal gesproken zal {$PRODUCT_NAME} zelf detecteren of de GD extentie is
...
$GLOBALS['phpAds_hlp_p3p_compact_policy'] = "	Een compacte policy wordt samen met cookies meegezonden. De standaard instelling
	is: 'CUR ADM OUR NOR STA NID'. Met de standaard instelling zal Internet
	Explorer 6 de cookies die door {$PRODUCT_NAME} gebruikt worden accepteren. Indien u
	wilt kunt u deze instelling aanpassen naar uw eigen privacy verklaring.";

$GLOBALS['phpAds_hlp_p3p_policy_location'] = "	Indien u een volledige privacy policy wilt gebruiken kunt u hier de locatie
...
$GLOBALS['phpAds_hlp_log_adviews'] = "	Normaal gesproken worden alle AdViews bijgehouden, maar in het geval dat u geen
...
$GLOBALS['phpAds_hlp_block_adviews'] = "	Als een bezoeker de pagina ververst zal er iedere keer als de banner getoond wordt
	een nieuwe AdView worden opgeslagen door {$PRODUCT_NAME}. Deze optie zorgt er voor dat
	...
	zal {$PRODUCT_NAME} alleen AdViews opslaan als de banner de laatste 300 seconden niet al
...
$GLOBALS['phpAds_hlp_log_adclicks'] = "	Normaal gesproken worden alle AdViews bijgehouden, maar in het geval dat u geen
...
$GLOBALS['phpAds_hlp_reverse_lookup'] = "	Standaard slaat {$PRODUCT_NAME} het IP adres van elke gebruiker op. Indien u wilt dat
	{$PRODUCT_NAME} de domeinnaam van de gebruiker wilt bijhouden kunt u deze functie aanzetten.
	Het achterhalen van de domeinnaam kost tijd en zal daarom {$PRODUCT_NAME} vertragen.";

$GLOBALS['phpAds_hlp_proxy_lookup'] = "	Sommige gebruikers gebruiken een proxy server voor de toegang tot internet. In dat
	geval zal {$PRODUCT_NAME} het IP adres van de proxy server opslaan, inplaats het IP adres
	van de gebruiker. Als u deze functie aanzet, zal {$PRODUCT_NAME} proberen om het IP adres
	van de gebruiker achter de proxy server te achterhalen. Indien dit niet lukt zal
	{$PRODUCT_NAME} het IP adres van de proxy opslaan. Deze optie staat niet standaard aan
	omdat het achterhalen van het IP adres tijd kost en {$PRODUCT_NAME} zal vertragen.";

$GLOBALS['phpAds_hlp_ignore_hosts'] = "	Indien u van sommige computers niet de AdViews en AdClicks wilt bijhouden
...
$GLOBALS['phpAds_hlp_begin_of_week'] = "	Voor de meeste mensen start een week op de Maandag, maar indien u in een land
	woont waar het gewoonte is dat de week op een Zondag start kunt dit hier instellen.";

$GLOBALS['phpAds_hlp_percentage_decimals'] = "	Specificeer hoe nauwkeurig achter de comma {$PRODUCT_NAME} moet rekenen.";

$GLOBALS['phpAds_hlp_warn_admin'] = "	{$PRODUCT_NAME} kan u automatisch een e-mail sturen als een campagne op het staat
...
$GLOBALS['phpAds_hlp_warn_limit'] = "	Door middel van dit veld kunt u instellen wanneer waarschuwingen per e-mail
...
$GLOBALS['phpAds_hlp_allow_invocation_popup'] = "	Met deze instellingen kunt u beinvloeden welke invocatie types toegestaan zijn.
...
$GLOBALS['phpAds_hlp_con_key'] = "	{$PRODUCT_NAME} bevat een krachtig system waarmee banners direct geselecteerd kunnen
...
$GLOBALS['phpAds_hlp_mult_key'] = "	Indien u banners toont door middel van een directe selectie, kunt u een of
...
$GLOBALS['phpAds_hlp_acl'] = "	Indien u geen gebruik wilt maken van leverings beperkingen dan kunt u deze
	optie uitzetten. Dit zal {$PRODUCT_NAME} iets versnellen.";

$GLOBALS['phpAds_hlp_default_banner_url'] =
$GLOBALS['phpAds_hlp_default_banner_target'] = "	Als {$PRODUCT_NAME} geen connectie op kan bouwen met de database server, of indien
...
$GLOBALS['phpAds_hlp_zone_cache'] = "	Indien u gebruik maakt van de zonecache worden tussentijdse informatie
...
$GLOBALS['phpAds_hlp_zone_cache_limit'] = "	Indien u gebruik van de van de zonecache kan het voorkomen dat de tussentijdse
...
$GLOBALS['phpAds_hlp_type_html_allow'] = "	{$PRODUCT_NAME} kan verschillende banner typen gebruiken en deze opslaan in
...
$GLOBALS['phpAds_hlp_type_web_mode'] = "	Indien u uw banners wilt opslaan op een webserver, dan moet u deze optie
...
$GLOBALS['phpAds_hlp_type_web_dir'] = "	U kunt hier de map specificeren waar {$PRODUCT_NAME} de banners moet opslaan.
...
$GLOBALS['phpAds_hlp_type_web_url'] = "	Indien u banners opslaat op de webserver, moet u {$PRODUCT_NAME} laten weten waar
...
$GLOBALS['phpAds_hlp_type_html_auto'] = "	Als deze optie aan staat zal {$PRODUCT_NAME} automatisch de HTML banners aanpassen,
...
$GLOBALS['phpAds_hlp_type_html_php'] = "	Als deze optie aan staat is het mogelijk om PHP code te gebruiken in HTML
	banners. Deze optie staat standaard uit.";

$GLOBALS['phpAds_hlp_admin'] = "	U kunt hier de gebruikersnaam van de beheerder instellen. Met deze
	gebruikersnaam krijgt u toegang tot de administratie interface.";

$GLOBALS['phpAds_hlp_admin_pw'] =
$GLOBALS['phpAds_hlp_admin_pw2'] = "	Vul hier het wachtwoord at u wilt gebruiken om toegang te krijgen tot
	de administratie interface. U dient het wachtwoord twee maal in te vullen
	om typefouten te voorkomen.";

$GLOBALS['phpAds_hlp_pwold'] =
$GLOBALS['phpAds_hlp_pw'] =
$GLOBALS['phpAds_hlp_pw2'] = "	Om het wachtwoord van de beheerder te veranderen dient u eerst het
...
$GLOBALS['phpAds_hlp_admin_fullname'] = "        U kunt hier de volledige naam van de beheerder invullen. Deze naam wordt
	gebruikt in de e-mails die {$PRODUCT_NAME} verstuurd.";

$GLOBALS['phpAds_hlp_admin_email'] = "Het e-mail adres van de administrator. Dit wordt gebruikt als \"afzender\" adres wanneer";

$GLOBALS['phpAds_hlp_admin_email_headers'] = "	U kunt in dit veld extra headers toevoegen aan de e-mail die {$PRODUCT_NAME} verstuurd.";
...
$GLOBALS['phpAds_hlp_client_welcome_msg'] = "	Als u deze functie aanzet zal er een welkomstbericht getoond worden op de
...
$GLOBALS['phpAds_hlp_updates_frequency'] = "	Indien u wilt dat {$PRODUCT_NAME} automatisch controleerd of er nieuwere versies
...
$GLOBALS['phpAds_hlp_userlog_priority'] = "	Als u zeker wilt weten dat de prioriteit berekeningen correct verlopen zijn kunt u
	...
	u een fout wilt melden bij de makers van {$PRODUCT_NAME}. De rapporten worden opgeslagen
...
$GLOBALS['phpAds_hlp_gui_show_banner_info'] = "	Als deze optie aan staat, wordt er extra informatie over elke banner getoond op de
