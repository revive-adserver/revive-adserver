...
$GLOBALS['phpAds_hlp_dbhost'] = "        �?rja be annak a {$phpAds_dbmsname} adatbázis kiszolgálónak az állomásnevét, melyhez kapcsolódni kíván.
		";

$GLOBALS['phpAds_hlp_dbport'] = "        �?rja be a {$phpAds_dbmsname} adatbázis kiszolgáló portját, melyhez kapcsolódni
		kíván. A {$phpAds_dbmsname} adatbázis alapértelmezett port száma <i>" . ($phpAds_dbmsname == 'MySQL' ? '3306' : '5432')."</i>.
		";

$GLOBALS['phpAds_hlp_dbuser'] = "        �?rja be azt a felhasználónevet, mellyel a {$PRODUCT_NAME} hozzá tud férni a {$phpAds_dbmsname} adatbázis kiszolgálóhoz.
		";

$GLOBALS['phpAds_hlp_dbpassword'] = "        �?rja be azt a jelszót, amivel a {$PRODUCT_NAME} hozzá tud férni a {$phpAds_dbmsname} adatbázis kiszolgálóhoz.
		";

$GLOBALS['phpAds_hlp_dbname'] = "        �?rja be az adatbázis kiszolgálón lévő annak az adatbáisnak a nevét, ahol a {$PRODUCT_NAME} tárolni fogja az adatokat.
		Fontos, hogy előtte hozza létre az adatbázist az adatbázis kiszolgálón. A {$PRODUCT_NAME} <b>nem</b> hozza létre
		ezt az adatbázist, ha még nem létezik.
		";

$GLOBALS['phpAds_hlp_persistent_connections'] = "        Az állandó kapcsolat használata jelentősen felgyorsíthatja a {$PRODUCT_NAME}
		...
		függ a látogatók számától és a használt hardvertől. Ha a {$PRODUCT_NAME} túl sok
		erőforrást köt le, akkor előbb vessen egy pillantást erre a beállításra.
		";

$GLOBALS['phpAds_hlp_insert_delayed'] = "        Adatok beszúrásakor a {$phpAds_dbmsname} zárolja a táblát. Ha magas a hely látogatottsága,
		akkor lehet, hogy új sor beszúrása előtt a {$PRODUCT_NAME} várni fog, mert az adatbázis
...
$GLOBALS['phpAds_hlp_compatibility_mode'] = "				Ha problémák merülnek fel a {$PRODUCT_NAME} egy harmadik fél által készített termékbe
		integrálásakor, akkor segíthet az adatbázis kompatibilitás mód bekapcsolása. Ha helyi módú hívásokat
		használ, és az adatbázis kompatibilitás módot bekapcsolta, akkor a {$PRODUCT_NAME} az
		adatbázis kapcsolat állapotát pontosan ugyanúgy hagyja, ahogy a {$PRODUCT_NAME} futása
		előtt volt. Ez a tulajdonság egy kicsit lassú (csak némileg), és ezért alapértelmezés szerint
		kikapcsolt.
		";

$GLOBALS['phpAds_hlp_table_prefix'] = "        Ha a {$PRODUCT_NAME} adatbázis használata több szoftvertermék által megosztott, akkor
		bölcs döntés a táblák nevéhez előtagot hozzáfűzni. Ha ön a {$PRODUCT_NAME} több telepítését
		használja ugyanabban az adatbázisban, akkor győződjön meg arról, hogy ez az előtag valamennyi
		telepítés számára egyedi.
		";

$GLOBALS['phpAds_hlp_table_type'] = "        A {$phpAds_dbmsname} lehetővé teszi többféle táblatípus használatát. Mindegyik táblatípus
		egyedi tulajdonságokkal rendelkezik, és némelyik jelentősen felgyorsíthatja a {$PRODUCT_NAME}
		futását. A MyISAM az alapértelmezett táblatípus, és a {$PRODUCT_NAME} valamennyi telepítésében
		elérhető. Lehet, hogy más táblatípusok nem használhatók a kiszolgálón.
		";

$GLOBALS['phpAds_hlp_url_prefix'] = "        A {$PRODUCT_NAME} megfelelő működése szempontjából fontos információ a számára,
				hogy hol helyezkedik el a webkiszolgálón. Meg kell adnia annak a könyvtárnak a hivatkozását, melybe a {$PRODUCT_NAME}
				telepítése történt. Például: <i>http://www.az-on-hivatkozasa.com/{$PRODUCT_NAME}</i>.
		";

$GLOBALS['phpAds_hlp_my_header'] =
$GLOBALS['phpAds_hlp_my_footer'] = "        Itt adhatja meg a fejléc fájlok útvonalát (pl.: /home/login/www/header.htm),
...
$GLOBALS['phpAds_hlp_content_gzip_compression'] = "		A GZIP tartalomtönörítés engedélyezésével az adminisztrátor kezelőfelület egy oldalának
...
$GLOBALS['phpAds_hlp_language'] = "        Itt választhatja ki a {$PRODUCT_NAME} által használt alapértelmezett
...
$GLOBALS['phpAds_hlp_name'] = "        �?rja be az ehhez az alkalmazáshoz használni kívánt nevet. Ez a szöveg lesz
				látható az adminisztrátor és a hirdetű kezelőfelület valamennyi oldalán.
				Ha üresen (alapértelmezés) hagyja ezt a beállítást, akkor a	{$PRODUCT_NAME}
				jelenik meg helyette.
		";

$GLOBALS['phpAds_hlp_company_name'] = "        Ez a név kerül felhasználásra a {$PRODUCT_NAME} által küldött e-mailben.
		";

$GLOBALS['phpAds_hlp_override_gd_imageformat'] = "        A {$PRODUCT_NAME} általában felismeri, hogy a GD könyvtár telepítve
				...
				nem teszi lehetővé a támogatott képformátumok felismerését. Ha a {$PRODUCT_NAME}
...
$GLOBALS['phpAds_hlp_p3p_policies'] = "        Ha akarja engedélyezni a {$PRODUCT_NAME} P3P Adatvédelmi Nyilatkozatát,
				akkor jelölje be ezt a tulajdonságot.
		";

$GLOBALS['phpAds_hlp_p3p_compact_policy'] = "        A cookie-kkal együtt küldött tömör nyilatkozat. Az alapértelmezett beállítás:
				'CUR ADM OUR NOR STA NID', ami lehetővé teszi az Internet Explorer 6 számára,
				hogy elfogadja a {$PRODUCT_NAME} által használt cookie-kat. Változtathat
				ezeken a beállításokon, ha akar, hogy megfeleljenek a saját bizalmi
				nyilatkozatának.
		";

$GLOBALS['phpAds_hlp_p3p_policy_location'] = "        Ha teljes adatvédelmi nyilatkozatot akar használni, akkor megadhatja
				a nyilatkozat helyét.
		";

$GLOBALS['phpAds_hlp_log_beacon'] = "		A jelzőképek kis méretűek és láthatatlanok, azon az oldalon vannak elhelyezve,
		melyen a reklám is megjelenik. Ha engedélyezi ezt a funkciót, akkor a
		{$PRODUCT_NAME} ezt a jelzőképet fogja felhasználni a letöltések
...
$GLOBALS['phpAds_hlp_compact_stats'] = "        A {$PRODUCT_NAME} eredetileg eléggé terjedelmes naplózást használt,
		...
		proglémának a leküzdésére a {$PRODUCT_NAME} újfajta statisztikát is
...
$GLOBALS['phpAds_hlp_log_adviews'] = "        Normál esetben minden letöltés naplózásra kerül, viszont ha ön nem akar
				statisztikát gyűjteni a letöltésekről, kikapcsolhatja ezt.
		";

$GLOBALS['phpAds_hlp_block_adviews'] = "		Ha egy látogató frissít egy oldalt, a {$PRODUCT_NAME} minden alkalommal
		...
		akkor a {$PRODUCT_NAME} csak akkor fogja naplózni a kattintásokat, ha
...
$GLOBALS['phpAds_hlp_log_adclicks'] = "        Normál esetben minden kattintás naplózásra kerül, viszont ha ön nem akarja
				gyűjteni a kattintások statisztikáját, akkor kikapcsolhatja.
		";

$GLOBALS['phpAds_hlp_block_adclicks'] = "		Ha egy látogató többször kattint egy reklámra, a {$PRODUCT_NAME} minden
...
$GLOBALS['phpAds_hlp_log_source'] = "		Ha a forrásparamétert használja a híváskódban, akkor ezt az információt az adatbázisban
...
$GLOBALS['phpAds_hlp_log_hostname'] = "		Ha a statisztikában tárolni kívánja a látogatók állomásnevét vagy IP-címét, akkor
...
$GLOBALS['phpAds_hlp_log_iponly'] = "		A látogató állomásnevének tárolása sok helyet foglal el az adatbázisban. Ha
		engedélyezi ezt a funkciót, a {$PRODUCT_NAME} még mindig fogja tárolni
		az állomást információját, de csak a kevesebb helyet foglaló IP-címet fogja
		tárolni. Ez a tulajdonság nem működik, ha a kiszolgáló vagy a {$PRODUCT_NAME}
		nem adja meg ezt az információt, mert abban az esetben mindig az IP-cím kerül
		tárolásra.
		";

$GLOBALS['phpAds_hlp_reverse_lookup'] = "		�?ltalában a webkiszolgáló állapítja meg az állomás nevét, de lehet, hogy bizonyos
...
$GLOBALS['phpAds_hlp_proxy_lookup'] = "		Vannak olyan látogatók, akik proxy kiszolgálón keresztül kapcsolódnak az Internethez.
		Ebben az esetben a {$PRODUCT_NAME} megkísérli naplózni a proxy kiszolgáló IP-címét
		vagy állomásnevét, a felhasználóé helyett. Ha engedélyezi ezt a funkciót, akkor a
		{$PRODUCT_NAME} megpróbálja a proxy kiszolgáló mögött tartózkodó felhasználó
...
$GLOBALS['phpAds_hlp_auto_clean_tables_interval'] = "		Ha engedélyezi ezt a tulajdonságot, akkor az összegyűjtött statisztika az alábbi
...
$GLOBALS['phpAds_hlp_auto_clean_userlog_interval'] = "		Ez a tulajdonság automatikusan törli azokat a bejegyzéseket a felashználói naplóból,
		melyek régebbiek az alábbi jelölőnégyzetben megadott hetek számánál.
		";

$GLOBALS['phpAds_hlp_geotracking_type'] = "		A geotargeting lehetővé teszi, hogy a {$PRODUCT_NAME} földrajzi információvá
		...
		A {$PRODUCT_NAME} jelenleg az IP2Country
		és a <a href='http://www.maxmind.com/?rId=phpadsnew2' target='_blank'>GeoIP</a> adatbázisokat
		támogatja.
		";

$GLOBALS['phpAds_hlp_geotracking_location'] = "		Amikor nem ön a GeoIP Apache modul, akkor meg kell adnia a {$PRODUCT_NAME} számára
...
$GLOBALS['phpAds_hlp_geotracking_cookie'] = "		Az IP-cím földrajzi adatokká alakítása időigényes feladat. A {$PRODUCT_NAME}
		a reklám minden alkalommal történő továbbításának megakadályozására az eredményt egy
		cookie-ban tudja tárolni. Ha ez a cookie létezik, akkor a {$PRODUCT_NAME}
		ezt az információt használja fel az IP-cím átalakítása helyett.
		";

$GLOBALS['phpAds_hlp_ignore_hosts'] = "        Ha nem akarja számolni valamely számítógépről érkező kattintásokat és letöltéseket,
...
$GLOBALS['phpAds_hlp_begin_of_week'] = "        A legtöbb ember számára a hét első napja a hétfő, de ha a vasárnappal akarja
				kezdeni a hetet, megteheti.
		";

$GLOBALS['phpAds_hlp_percentage_decimals'] = "        Azt szabja meg, hogy hány tizes hely legyen látható a statisztikai oldalakon.
		";

$GLOBALS['phpAds_hlp_warn_admin'] = "        A {$PRODUCT_NAME} e-mailt tud önnek küldeni, ha egy kampányban már csak
				korlátozott számú kattintás vagy letöltés van hátra. Alapértelmezésként ez
				engedélyezett.
		";

$GLOBALS['phpAds_hlp_warn_client'] = "        A {$PRODUCT_NAME} e-mailt tud küldeni a hirdetőnek, ha valamelyik kampányában
		csak korlátozott számú kattintás vagy letöltés van hátra. Alapértelmezésként ez
		engedélyezett.
		";

$GLOBALS['phpAds_hlp_qmail_patch'] = "		A qmail némely verziójára egy hiba van hatással, ami a {$PRODUCT_NAME} által
		küldött e-mailben a fejlécnek az e-mail törzsében lévő megjelenítését okozza. Ha
		engedélyezi ezt a beállítást, akkor a {$PRODUCT_NAME} qmail kompatibilis
		formátumban fogja küldeni az e-mailt.
		";

$GLOBALS['phpAds_hlp_warn_limit'] = "        A határ, melynek elérésekor a {$PRODUCT_NAME} figyelmeztető e-maileket
...
$GLOBALS['phpAds_hlp_allow_invocation_popup'] = "		Ezekkel a beállításokkal szabályozhatja az engedélyezett hívástípusokat.
...
$GLOBALS['phpAds_hlp_con_key'] = "        A {$PRODUCT_NAME} közvetlen választást használó hatékony visszakereső
...
$GLOBALS['phpAds_hlp_mult_key'] = "        Ha a közvetlen kiválasztást használja a reklámok megjelenítésére, akkor mindegyikhez
...
$GLOBALS['phpAds_hlp_acl'] = "        Ha nem használja a továbbítási korlátozásokat, akkor ezzel a tulajdonsággal letilthatja
				ezt a paramétert. Ez egy kicsit felgyorsítja a {$PRODUCT_NAME} működését.
		";

$GLOBALS['phpAds_hlp_default_banner_url'] =
$GLOBALS['phpAds_hlp_default_banner_target'] = "        Ha a {$PRODUCT_NAME} nem tud kapcsolódni az adatbázis kiszolgálóhoz, vagy
...
$GLOBALS['phpAds_hlp_delivery_caching'] = "		A továbbítás felgyorsításának előmozdítására a {$PRODUCT_NAME} gyorsítótárat
...
$GLOBALS['phpAds_hlp_type_txt_allow'] = "        A {$PRODUCT_NAME} különféle típusú reklámokat tud felhasználni, ezeket
				...
				{$PRODUCT_NAME} az SQL adatbázisban vagy a webkiszolgálón fog tárolni.
		Külső webkiszolgálón tárolt reklámot is használhat, ill. használhat HTML-t vagy
		egyszerű szöveget a reklám generálásához.
		";

$GLOBALS['phpAds_hlp_type_web_mode'] = "        Ha a webkiszolgálón tárolt reklámokat akar használni, akkor konfigurálnia
...
$GLOBALS['phpAds_hlp_type_web_dir'] = "        Adja meg a mappát, melybe a {$PRODUCT_NAME} a feltöltött reklámokat
...
$GLOBALS['phpAds_hlp_type_web_ftp_host'] = "		Ha a <i>Külső FTP-kiszolgáló</i> tárolási módot választotta, akkor meg
		kell adnia annak az FTP-kiszolgálónak az IP-címét vagy tartománynevét, melyre a
		{$PRODUCT_NAME} a feltöltött reklámokat másolni fogja.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_path'] = "		Ha a <i>Külső FTP-kiszolgáló</i> tárolási módot választotta, akkor meg
		kell adnia az FTP-kiszolgálón azt a könyvtárat, melybe a {$PRODUCT_NAME}
		a feltöltött reklámokat másolni fogja.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_user'] = "		Ha a <i>Külső FTP-kiszolgáló</i> tárolási módot választotta, akkor meg
		kell adnia azt a felhasználónevet, melyet a {$PRODUCT_NAME} használni
		fog a külső FTP-kiszolgálóhoz történő csatlakozáskor.
		";

$GLOBALS['phpAds_hlp_type_web_ftp_password'] = "		Ha a <i>Külső FTP-kiszolgáló</i> tárolási módot választotta, akkor meg
		kell adnia azt a jelszót, melyet a {$PRODUCT_NAME} használni
		fog a külső FTP-kiszolgálóhoz történő csatlakozáskor.
		";

$GLOBALS['phpAds_hlp_type_web_url'] = "        Ha webkiszolgálón tárol reklámokat, akkor a {$PRODUCT_NAME} számára
				meg kell adnia, hogy melyik nyilvános hivatkozás tartozik az alább megadott
				könyvtárhoz. Ne írjon be per jelet (/).
		";

$GLOBALS['phpAds_hlp_type_html_auto'] = "        Ha engedélyezi ezt a tulajdonságot, akkor a {$PRODUCT_NAME} automatikusan
...
$GLOBALS['phpAds_hlp_type_html_php'] = "        Lehetőség van arra, hogy a {$PRODUCT_NAME} a HTML-reklámokba ágyazott
				PHP-kódot hajtson végre. A funkció alapértelmezésként tiltva.
		";

$GLOBALS['phpAds_hlp_admin'] = "        �?rja be az adminisztrátor felhasználónevét. Ezzel a felhasználónévvel
				jelentkezhet be ön az adminisztrátor kezelőfelületre.
		";

$GLOBALS['phpAds_hlp_admin_pw'] =
$GLOBALS['phpAds_hlp_admin_pw2'] = "        �?rja be az adminisztrátor kezelőfelületre történő bejelentkezéshez szükséges
				jelszót. A gépelési hibák megelőzése céljából kétszer kell beírnia.
		";

$GLOBALS['phpAds_hlp_pwold'] =
$GLOBALS['phpAds_hlp_pw'] =
$GLOBALS['phpAds_hlp_pw2'] = "        Az adminisztrátor jelszavának megváltoztatásához meg kell adnia a
				fentiekben a régi jelszót. Továbbá, a gépelési hibák elkerülése végett
				kétszer meg kell adnia az új jelszót.
		";

$GLOBALS['phpAds_hlp_admin_fullname'] = "        Adja meg az adminisztrátor teljes nevét. Ez a név kerül felhasználásra
				a statisztika e-mailben történő küldésekor.
		";

$GLOBALS['phpAds_hlp_admin_email'] = "        Az adminisztrátor e-mail címe. Ez kerül felhasználásra a Feladó mezőben
				a statisztika	e-mailben történő küldésekor.
		";

$GLOBALS['phpAds_hlp_admin_email_headers'] = "        Módosíthatja a {$PRODUCT_NAME} által küldött e-mailekben használt fejléceket.
		";

$GLOBALS['phpAds_hlp_admin_novice'] = "        Ha szeretne figyelmeztetést kapni a hirdetők, kampányok, reklámok, kiadók és zónák
				törlése előtt, akkor válassza az igaz tulajdonságot.
		";

$GLOBALS['phpAds_hlp_client_welcome'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a hirdető bejelentkezése utáni első
...
$GLOBALS['phpAds_hlp_client_welcome_msg'] = "		A welcome.html fájl átszerkesztése helyett itt adhat meg egy rövid szöveget. Ha ide
		szöveget ír be, akkor a welcome.html fájl kihagyásra kerül. Használhat HTML elemeket is.
		";

$GLOBALS['phpAds_hlp_updates_frequency'] = "		Ha szeretné ellenőrizni a {$PRODUCT_NAME} új verzióit, akkor érdemes engedélyezni
		ezt a tulajdonságot. Meghatározhatja azt is, hogy a {$PRODUCT_NAME} milyen
...
$GLOBALS['phpAds_hlp_userlog_email'] = "		Ha szeretné a {$PRODUCT_NAME} által küldött elektronikus üzenetek másolatait
		megtartani, akkor engedélyezze ezt a funkciót. Az elküldött üzenetek a felhasználói naplóban
		kerülnek tárolásra.
		";

$GLOBALS['phpAds_hlp_userlog_priority'] = "		Ha meg akar győződni arról, hogy a prioritás kiszámítása megfelelő volt, akkor
...
$GLOBALS['phpAds_hlp_userlog_autoclean'] = "		Ha meg akar győződni arról, hogy az adatbázis tisztítása megfelelő volt, akkor
...
$GLOBALS['phpAds_hlp_default_banner_weight'] = "		Ha magasabbra kívánja állítani az alapértelmezett reklám fontosságot, akkor itt
		adhatja meg az óhajtott fontossági értéket. Ez az érték 1 alapértelmezésként.
		";

$GLOBALS['phpAds_hlp_default_campaign_weight'] = "		Ha magasabbra kívánja állítani az alapértelmezett kampány fontosságot, akkor itt
		adhatja meg az óhajtott fontossági értéket. Ez az érték 1 alapértelmezésként.
		";

$GLOBALS['phpAds_hlp_gui_show_campaign_info'] = "		Ha engedélyezi ezt a tulajdonságot, akkor <i>Kampány áttekintése</i> oldalon további
...
$GLOBALS['phpAds_hlp_gui_show_banner_info'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a <i>Reklám áttekintése</i> oldalon további
...
$GLOBALS['phpAds_hlp_gui_show_campaign_preview'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a <i>Reklám áttekintése</i> oldalon látható lesz
...
$GLOBALS['phpAds_hlp_gui_show_banner_html'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a tényleges HTML-reklám fog megjelenni a HTML-kód
...
$GLOBALS['phpAds_hlp_gui_show_banner_preview'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a <i>Reklám tulajdonságai</i>,
...
$GLOBALS['phpAds_hlp_gui_hide_inactive'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a <i>Hirdetők és kampányok</i>, ill. a
...
$GLOBALS['phpAds_hlp_gui_show_matching'] = "		Ha engedélyezi a tulajdonságot, akkor a megfelelő reklám fog megjelenni a
...
$GLOBALS['phpAds_hlp_gui_show_parents'] = "		Ha engedélyezi ezt a tulajdonságot, akkor a reklámok szülő kampányai láthatók lesznek
...
$GLOBALS['phpAds_hlp_gui_link_compact_limit'] = "		Alapértelmezésként valamennyi létező reklám vagy kampány látható a <i>Kapcsolt reklámok</i>
