...
+---------------------------------------------------------------------------+
$Id: Core.php 5631 2006-10-09 18:21:43Z andrew@m3.net $
*/
 ...
 */
class MAX_Table_Core extends MAX_Table
{

    /**
     * The class constructor method.
     */
    function MAX_Table_Core()
    {
        parent::MAX_Table();
    }
     ...
     * of the {@link MAX_Table_Core} object.
     *
     * @static
     * @param string $dbType The database type. Default value is taken from the parsed
     *                       Max config file.
     * @return {@link MAX_Table_Core} The created {@link MAX_Table_Core} object.
     */
    function &singleton($dbType = null)
    {
        ...
        if (!isset($static)) {
            $static = new MAX_Table_Core(); // No reference here!
            $static->init(MAX_PATH . '/etc/tables_core.' . $dbType . '.sql');
        }
        return $static;
    }
    ...
    function destroy()
    {
        if (isset($GLOBALS['_MAX']['TABLES'][__CLASS__])) {
