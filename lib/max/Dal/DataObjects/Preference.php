...
class DataObjects_Preference extends DB_DataObjectCommon
{
    ...
    var $updates_cs_data_enabled;         // string(1)  enum
    var $ad_clicks_sum;                   // int(11)  
    var $ad_views_sum;                    // int(11)  
    var $ad_clicks_per_second;            // real(12)  
    var $ad_views_per_second;             // real(12)  
    var $ad_cs_data_last_sent;            // datetime(19)  binary
    var $ad_cs_data_last_received;        // datetime(19)  binary
