...
/**
 * A class for testing non standard DataObjects_Clients methods
 *
 * @package    MaxDal
 * @subpackage TestSuite
 *
 */
class DataObjects_ClientsTest extends DataObjectsUnitTestCase
{
     /**
     * The constructor method.
     */
    function DataObjects_ClientsTest()
    {
        $this->UnitTestCase();
    }
