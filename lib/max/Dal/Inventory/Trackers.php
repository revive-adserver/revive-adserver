...
{
    public function getAppendCodes($tracker_id)
    {
    ...
    public function setAppendCodes($tracker_id, $codes)
    {
        ...
        foreach ($codes as $v) {
            ...
            $appendcodes[] = ['tagcode' => $tagcode, 'paused' => $paused, 'autotrack' => $autotrack];
        }
    ...
    public function generateAppendCode($codes)
    {
    ...
    public function recompileAppendCodes($ids = null)
    {
        if (is_null($ids)) {
