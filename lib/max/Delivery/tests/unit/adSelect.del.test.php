 ...
 */
$GLOBALS['test_MAX_cacheGetAd_val'] = [];
...
class Test_DeliveryAdSelect extends UnitTestCase
{
     ...
     *
     */
    public function test_MAX_adSelect()
    {
     ...
     *
     */
    public function test_adSelectDirect()
    {
     ...
     *
     */
    public function test_adSelectZone()
    {
     ...
     *
     */
    public function test_adSelect2()
    {
     ...
     */
    public function test_adSelectBuildContext_companion()
    {
        ...
        $aBanner = ['placement_id' => '56', 'client_id' => '1', 'advertiser_limitation' => '0'];
        $context = [];
        $ret = _adSelectBuildContext($aBanner, $context);
    ...
    public function test_CheckCriteria()
    {
        $context = [];
        $source = [];
        $richMedia = true;
