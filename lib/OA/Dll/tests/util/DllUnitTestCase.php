...
class DllUnitTestCase extends UnitTestCase
{
     ...
     *
     */
    public $wrongDateError = 'The start date is after the end date';
     ...
     */
    public function _getMethodShouldReturnError($errorMessage)
    {
     ...
     */
    public function assertFieldEqual($oObj1, $oObj2, $fieldName)
    {
