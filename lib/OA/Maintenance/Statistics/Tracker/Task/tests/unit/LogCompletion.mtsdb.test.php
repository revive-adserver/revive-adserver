...
require_once MAX_PATH . '/lib/OA/Maintenance/Statistics/Tracker/Task/LogCompletion.php';
require_once MAX_PATH . '/lib/OA/ServiceLocator.php';
require_once MAX_PATH . '/lib/pear/Date.php';

/**
 * A class for testing the OA_Maintenance_Statistics_Tracker_Task_LogCompletion class.
 *
 * @package    OpenXMaintenance
 * @subpackage TestSuite
 * @author     Andrew Hill <andrew.hill@openx.org>
 */
class Test_OA_Maintenance_Statistics_Tracker_Task_LogCompletion extends UnitTestCase
{

    /**
     * The constructor method.
     */
    function Test_OA_Maintenance_Statistics_Tracker_Task_LogCompletion()
    {
        $this->UnitTestCase();
    }
    ...
    function testCreate()
    {
        $oLogCompletion = new OA_Maintenance_Statistics_Tracker_Task_LogCompletion();
        $this->assertTrue(is_a($oLogCompletion, 'OA_Maintenance_Statistics_Tracker_Task_LogCompletion'));
    }
    ...
    function testRun()
    {
        ...
        // Create a new OA_Maintenance_Statistics_Tracker_Task_LogCompletion object
        $oLogCompletion = new OA_Maintenance_Statistics_Tracker_Task_LogCompletion();
