...
class Test_VersionController extends UnitTestCase
{
    ...
    public function test_putSchemaVersion()
    {
        $oVerCtrl = new OA_Version_Controller();
        $oVerCtrl->init(OA_DB::singleton(OA_DB::getDsn()));
    ...
    public function test_getApplicationVersion()
    {
    ...
    public function test_getApplicationVersionMax()
    {
    ...
    public function test_putApplicationVersion()
    {
        $oVerCtrl = new OA_Version_Controller();
        $oVerCtrl->init(OA_DB::singleton(OA_DB::getDsn()));
    ...
    public function test_putComponentGroupVersion()
    {
        $oVerCtrl = new OA_Version_Controller();
        $oVerCtrl->init(OA_DB::singleton(OA_DB::getDsn()));
    ...
    public function _createTestRecord($name, $value)
    {
    ...
    public function _deleteTestRecord($name)
    {
        $doApplicationVariable = OA_Dal::factoryDO('application_variable');
        $doApplicationVariable->name = $name;
