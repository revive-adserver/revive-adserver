...
class Test_OA_DB_UpgradeAuditor extends Test_OA_BaseUpgradeAuditor
{
    ...
    public function test_queryAuditByDBUpgradeId()
    {
        $oAuditor = $this->_getAuditObject('OA_DB_UpgradeAuditor');
    ...
    public function test_updateAuditBackupDroppedById()
    {
        $oAuditor = $this->_getAuditObject('OA_DB_UpgradeAuditor');
    ...
    public function test_getTableStatus()
    {
    ...
    */
    public function test_listBackups()
    {
        $oAuditor = $this->_getAuditObject('OA_DB_UpgradeAuditor');
