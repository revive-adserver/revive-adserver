...
class Test_OA_Upgrade extends UnitTestCase
{
    ...
    public function test_initDatabaseConnection()
    {
        $oUpgrade = new OA_Upgrade();
    ...
    public function test_disableAllPlugins()
    {
        $aConf = &$GLOBALS['_MAX']['CONF'];
        $aConf['plugins'] = ['testPlugin' => 1];
...
//        $GLOBALS['_MAX']['CONF']['table']    = $aTblOld;
    ...
    public function testcheckPermissionToCreateTable()
    {
        $oUpgrade = new OA_Upgrade();
        $oUpgrade->initDatabaseConnection();
        $this->assertIsA($oUpgrade->oDbh, 'MDB2_driver_Common', 'class mismatch: MDB2_driver_Common');
    ...
    public function test_parseUpgradePackageFile()
    {
        $oUpgrade = new OA_Upgrade();
     ...
     *
     */
    public function test_checkPermissionToCreateTable()
    {
        $oUpgrade = new OA_Upgrade();
        $oUpgrade->initDatabaseConnection();
     ...
     *
     */
    public function test_checkExistingTables()
    {
        $oUpgrade = new OA_Upgrade();
        $oUpgrade->initDatabaseConnection();
    ...
    public function _createTestTableConfig($oDbh, $name)
    {
    ...
    public function _dropTestTable($oDbh, $name)
    {
        $oTable = new OA_DB_Table();
        $testpath = MAX_PATH . '/lib/OA/Upgrade/tests/data/';
        $oTable->init($testpath . 'schema_test_config.xml');
    ...
    public function _dropAuditTables($oDbh)
    {
        $oTable = new OA_DB_Table();
        $testpath = MAX_PATH . '/lib/OA/Upgrade/tests/data/';
        $oTable->init($testpath . 'schema_test_config.xml');
     ...
     *
     */
    public function test_detectPAN()
    {
...
//        $oUpgrade->oIntegrity->tally();
     ...
     *
     */
    public function test_detectMAX01()
    {
        Mock::generatePartial(
            'OA_Upgrade',
...
//        $oUpgrade->oIntegrity->tally();
     ...
     *
     */
    public function test_detectMax()
    {
        $oUpgrade = new OA_Upgrade();
        $oUpgrade->initDatabaseConnection();
...
//        $oUpgrade->oIntegrity->tally();
     ...
     *
     */
    public function test_detectOpenads()
    {
        $oUpgrade = new OA_Upgrade();
...
//        $oUpgrade->oIntegrity->tally();
     ...
     *
     */
    public function test_upgradeSchemas()
    {
     ...
     *
     */
    public function test_upgradeIncremental()
    {
        $oUpgrade = new OA_Upgrade();
...
//        $this->_deleteTestAppVarRecordAllNames('oa_version');
    ...
    public function _checkTablesUpgraded($oUpgrade)
    {
    ...
    public function _createTestAppVarRecord($name, $value)
    {
    ...
    public function _getTestAppVarValue($name)
    {
        $doApplicationVariable = OA_Dal::factoryDO('application_variable');
        $doApplicationVariable->name = $name;
    ...
    public function _deleteTestAppVarRecord($name, $value)
    {
        $doApplicationVariable = OA_Dal::factoryDO('application_variable');
        $doApplicationVariable->name = $name;
        //$doApplicationVariable->value   = $value;
    ...
    public function _deleteTestAppVarRecordAllNames($name)
    {
        $doApplicationVariable = OA_Dal::factoryDO('application_variable');
        $doApplicationVariable->name = $name;
        $doApplicationVariable->delete();
    ...
    public function _writeTestRecoveryFile()
    {
