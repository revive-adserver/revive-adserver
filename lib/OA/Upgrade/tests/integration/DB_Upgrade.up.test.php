...
class Test_DB_Upgrade extends UnitTestCase
{
    ...
    public function test_initMDB2Schema()
    {
        $this->path = MAX_PATH . '/lib/OA/Upgrade/tests/data/';
        $oDB_Upgrade = new OA_DB_Upgrade();
     ...
     */
    public function test_stripPrefixesFromDatabaseDefinition()
    {
        // Test 1
        ...
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        $aDefinition['tables'][$this->prefix . 'table1'] = [];
        $aDefinition['tables'][$this->prefix . 'table1']['indexes'][$this->prefix . 'table1_pkey'] = [];
        $aDefinition['tables'][$this->prefix . 'table1']['indexes'][$this->prefix . 'table1_pkey']['primary'] = true;
        $aDefinition['tables'][$this->prefix . 'table1']['indexes'][$this->prefix . 'table1_index'] = [];
        ...
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        $aDefinition = [];
        $aDefinition['tables']['table1'] = [];
        $aDefinition['tables']['table1']['indexes']['table1_pkey'] = [];
        $aDefinition['tables']['table1']['indexes']['table1_pkey']['primary'] = true;
        $aDefinition['tables']['table1']['indexes']['table1_index'] = [];
        ...
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        $aDefinition = [];
        $aDefinition['tables']['my_my_table1'] = [];
        $aDefinition['tables']['my_my_table1']['indexes']['my_my_table1_pkey'] = [];
        $aDefinition['tables']['my_my_table1']['indexes']['my_my_table1_pkey']['primary'] = true;
        $aDefinition['tables']['my_my_table1']['indexes']['my_my_table1_index'] = [];
     ...
     *
     */
    public function test_getDefinitionFromDatabase1()
    {
     ...
     *
     */
    public function test_getDefinitionFromDatabase2()
    {
        if ('pgsql' === $GLOBALS['_MAX']['CONF']['database']['type']) {
            $this->skip();
            return;
     ...
     *
     */
    public function test_getDefinitionFromDatabase3()
    {
        if ('pgsql' === $GLOBALS['_MAX']['CONF']['database']['type']) {
            $this->skip();
            return;
    ...
    public function test_checkSchemaIntegrity()
    {
    ...
    public function test_UpgradeWithNoBackups()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        $oDB_Upgrade->doBackups = false;
        $oDB_Upgrade->aChanges['affected_tables']['constructive'] = ['table1'];
...
//        TestEnv::restoreEnv();
    ...
    public function test_rollback()
    {
        ...
        $aTbl_def_orig = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . 'table1']);
        $aTbl_def_bak = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . $table_bak]);
        ...
        OA_DB::setCaseSensitive();
        $aTbl_def_rest = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . 'table1']);
...
//        so don't slip another test in between these
     ...
     *
     */
    public function test_rollbackAddedTables()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
     ...
     *
     */
    public function test_BackupAndRollbackDroppedTables()
    {
     ...
     *
     */
    public function test_BackupAndRollback_restoreAutoIncrement()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        ...
        $oDB_Upgrade->aChanges['affected_tables']['constructive'] = ['table1_autoinc'];

        OA_DB::setCaseSensitive();
        $aTbl_def_orig = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . 'table1_autoinc']);
        OA_DB::disableCaseSensitive();
        ...
        OA_DB::setCaseSensitive();
        $aTbl_def_rest = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . 'table1_autoinc']);
        OA_DB::disableCaseSensitive();
    ...
    public function test_verifyTasksIndexesRemove()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
     ...
     *
     */
    public function test_verifyTasksIndexesAdd()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
    ...
    public function test_verifyTasksTablesAdd()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
    ...
    public function test_verifyTasksTablesRemove()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject('destructive');
    ...
    public function test_verifyTasksTablesRename()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
     ...
     *
     */
    public function test_verifyTasksTablesAlter()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
     ...
     *
     */
    public function test_executeTasksIndexesRemove()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
     ...
     *
     */
    public function test_executeTasksIndexesAdd()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
    ...
    public function test_executeTasksTablesAdd()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
        $oDB_Upgrade->aChanges['affected_tables']['constructive'] = ['table2'];
    ...
    public function test_executeTasksTablesRemove()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject('destructive');
    ...
    public function test_executeTasksTablesRename()
    {
        $oDB_Upgrade = $this->_newDBUpgradeObject();
    ...
    public function test_executeTasksTablesAlter()
    {
        ...
        OA_DB::setCaseSensitive();
        $aDef = $oDB_Upgrade->oSchema->getDefinitionFromDatabase([$this->prefix . 'table1']);
        OA_DB::disableCaseSensitive();
    ...
    public function _dropTestTables($oDbh)
    {
        $conf = &$GLOBALS['_MAX']['CONF'];
        $conf['table']['split'] = false;
        $oTable = new OA_DB_Table();
     ...
     * @param mdb2 connection $oDbh
     */
    public function _createTestTableAutoInc($oDbh)
    {
        $this->_dropTestTables($oDbh);
        $conf = &$GLOBALS['_MAX']['CONF'];
        $conf['table']['split'] = false;
    ...
    public function _dropTestTableAutoInc($oDbh)
    {
        $conf = &$GLOBALS['_MAX']['CONF'];
        $conf['table']['split'] = false;
        $oTable = new OA_DB_Table();
     ...
     */
    public function _editChangesetTableRename(&$oDB_Upgrade, $table_name, $table_name_was)
    {
     ...
     */
    public function _editChangesetFieldRename(&$oDB_Upgrade, $table_name, $field_name, $field_name_was)
    {
