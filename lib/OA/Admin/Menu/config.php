    ...
    switch ($accountType) {
        case OA_ACCOUNT_ADMIN:
            ...
            $oMenu->add(new OA_Admin_Menu_Section("2", 'Stats', "stats.php", false, "statistics"));
                ...
                $oMenu->addTo("2.1.2.2.3", new OA_Admin_Menu_Section("2.1.2.2.3.1", 'DailyStats', "stats.php?entity=banner&breakdown=targeting-daily&clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "statistics/targetingStatistics/daily"));
                ...
                $oMenu->addTo("2.1.2.4", new OA_Admin_Menu_Section("2.1.2.4.1", 'DailyStats', "stats.php?entity=campaign&breakdown=targeting-daily&clientid={clientid}&campaignid={campaignid}", false, "statistics/targetingStatistics/daily"));
        ...
        case OA_ACCOUNT_ADVERTISER:
            ...
            $oMenu->addTo("1.2.2", new OA_Admin_Menu_Section("1.2.2.2", 'BannerProperties', "banner-edit.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false));
