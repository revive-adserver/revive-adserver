    ...
    switch ($accountType) {
        case OA_ACCOUNT_ADMIN:
            ...
            $oMenu->add(new OA_Admin_Menu_Section("2", $GLOBALS['strStats'], "stats.php", false, "statistics"));
                ...
                $oMenu->addTo("2.1.2.2.2", new OA_Admin_Menu_Section("2.1.2.2.2.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=banner&breakdown=affiliate-history&clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/history"));
                ...
                $oMenu->addTo("2.1.2.2.2", new OA_Admin_Menu_Section("2.1.2.2.2.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=banner&breakdown=zone-history&clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
                ...
                $oMenu->addTo("2.1.2.3", new OA_Admin_Menu_Section("2.1.2.3.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=campaign&breakdown=affiliate-history&clientid={clientid}&campaignid={campaignid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/history"));
                ...
                $oMenu->addTo("2.1.2.3", new OA_Admin_Menu_Section("2.1.2.3.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=campaign&breakdown=zone-history&clientid={clientid}&campaignid={campaignid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
                ...
                $oMenu->addTo("2.1.3", new OA_Admin_Menu_Section("2.1.3.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=advertiser&breakdown=affiliate-history&clientid={clientid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/history"));
                ...
                $oMenu->addTo("2.1.3", new OA_Admin_Menu_Section("2.1.3.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=advertiser&breakdown=zone-history&clientid={clientid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
                ...
                $oMenu->addTo("2.4.2.2", new OA_Admin_Menu_Section("2.4.2.2.1", $GLOBALS['strDistributionHistoryCampaign'], "stats.php?entity=zone&breakdown=campaign-history&affiliateid={affiliateid}&zoneid={zoneid}&campaignid={campaignid}", true, "statistics/campaignDistribution/history"));
                ...
                $oMenu->addTo("2.4.2.2", new OA_Admin_Menu_Section("2.4.2.2.2", $GLOBALS['strDistributionHistoryBanner'], "stats.php?entity=zone&breakdown=banner-history&affiliateid={affiliateid}&zoneid={zoneid}&campaignid={campaignid}&bannerid={bannerid}", true));
                ...
                $oMenu->addTo("2.4.3", new OA_Admin_Menu_Section("2.4.3.1", $GLOBALS['strDistributionHistoryCampaign'], "stats.php?entity=affiliate&breakdown=campaign-history&affiliateid={affiliateid}&campaignid={campaignid}", true, "statistics/campaignDistribution/history"));
                ...
                $oMenu->addTo("2.4.3", new OA_Admin_Menu_Section("2.4.3.2", $GLOBALS['strDistributionHistoryBanner'], "stats.php?entity=affiliate&breakdown=banner-history&affiliateid={affiliateid}&campaignid={campaignid}&bannerid={bannerid}", true));
            ...
            $oMenu->add(new OA_Admin_Menu_Section("inventory", $GLOBALS['strAdminstration'], "agency-index.php", false, "inventory"));
                ...
                $oMenu->addTo("agency-index", new OA_Admin_Menu_Section("agency-edit_new", $GLOBALS['strAddAgency'], "agency-edit.php", true, "settings/agencyManagement/addagency"));
        ...
        case OA_ACCOUNT_MANAGER:
            ...
            $oMenu->addTo("inventory", new OA_Admin_Menu_Section("advertiser-index", $GLOBALS['strClients'], "advertiser-index.php", false, "inventory", null, 1, false, 'g_adv'));
            ...
            $oMenu->addTo("inventory", new OA_Admin_Menu_Section("advertiser-campaigns", $GLOBALS['strCampaigns'], "advertiser-campaigns.php", false, "inventory/advertiserAndCampaings/campaigns", null, 1, false, 'g_adv'));
            ...
            $oMenu->addTo("inventory", new OA_Admin_Menu_Section("website-index", $GLOBALS['strAffiliates'], "website-index.php", false, "inventory/publishersAndZones", null, 1, false, 'g_website'));
                $oMenu->addTo("website-index", new OA_Admin_Menu_Section("affiliate-edit_new", $GLOBALS['strAddNewAffiliate'], "affiliate-edit.php", true, "inventory/publishersAndZones/addPublisher"));
                $oMenu->addTo("website-index", new OA_Admin_Menu_Section("affiliate-edit", $GLOBALS['strAffiliateProperties'], "affiliate-edit.php?affiliateid={affiliateid}", false, "inventory/publishersAndZones/editPublisher"));
                $oMenu->addTo('website-index', new OA_Admin_Menu_Section('affiliate-invocation', $GLOBALS['strInvocationcode'], 'affiliate-invocation.php?affiliateid={affiliateid}', false, "inventory/affiliateInvocation"));
                $oMenu->addTo('website-index', new OA_Admin_Menu_Section('affiliate-access', $GLOBALS['strUserAccess'], 'affiliate-access.php?affiliateid={affiliateid}'));

            $oMenu->addTo('inventory', new OA_Admin_Menu_Section('affiliate-zones', $GLOBALS['strZones'], 'affiliate-zones.php', false, "inventory/publishersAndZones/zones", null, 1, false, 'g_website'));
            ...
            $oMenu->addTo('inventory', new OA_Admin_Menu_Section('affiliate-channels', $GLOBALS['strChannels'], 'affiliate-channels.php', false, "inventory/publishersAndZones/channels", null, 1, false, 'g_website'));
        ...
        case OA_ACCOUNT_TRAFFICKER:
            ...
            $oMenu->add(new OA_Admin_Menu_Section("1", $GLOBALS['strStats'], "stats.php?entity=affiliate&breakdown=history&affiliateid={affiliateid}", false, "statistics/publisherHistory"));
                ...
                $oMenu->addTo("1.2.2", new OA_Admin_Menu_Section("1.2.2.1", $GLOBALS['strDistributionHistoryCampaign'], "stats.php?entity=zone&breakdown=campaign-history&affiliateid={affiliateid}&zoneid={zoneid}&campaignid={campaignid}", true, "statistics/campaignDistribution"));
                ...
                $oMenu->addTo("1.2.2", new OA_Admin_Menu_Section("1.2.2.2", $GLOBALS['strDistributionHistoryBanner'], "stats.php?entity=zone&breakdown=banner-history&affiliateid={affiliateid}&zoneid={zoneid}&campaignid={campaignid}&bannerid={bannerid}", true, "statistics/campaignDistribution/history/daily"));
                ...
                $oMenu->addTo("1.3", new OA_Admin_Menu_Section("1.3.1", $GLOBALS['strDistributionHistoryCampaign'], "stats.php?entity=affiliate&breakdown=campaign-history&affiliateid={affiliateid}&campaignid={campaignid}", true, "statistics/campaignDistribution/history"));
                ...
                $oMenu->addTo("1.3", new OA_Admin_Menu_Section("1.3.2", $GLOBALS['strDistributionHistoryBanner'], "stats.php?entity=affiliate&breakdown=banner-history&affiliateid={affiliateid}&campaignid={campaignid}&bannerid={bannerid}", true));
                $oMenu->addTo("1.3.2", new OA_Admin_Menu_Section("1.3.2.1", $GLOBALS['strDailyStats'], "stats.php?entity=affiliate&breakdown=daily&affiliateid={affiliateid}&campaignid={campaignid}&bannerid={bannerid}&day={day}", true));
        ...
        case OA_ACCOUNT_ADVERTISER:
            ...
            $oMenu->addTo("1.2.2.4", new OA_Admin_Menu_Section("1.2.2.4.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=banner&breakdown=affiliate-history&clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/history"));
            ...
            $oMenu->addTo("1.2.2.4", new OA_Admin_Menu_Section("1.2.2.4.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=banner&breakdown=zone-history&clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
            ...
            $oMenu->addTo("1.2.3", new OA_Admin_Menu_Section("1.2.3.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=campaign&breakdown=affiliate-history&clientid={clientid}&campaignid={campaignid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/history"));
            ...
            $oMenu->addTo("1.2.3", new OA_Admin_Menu_Section("1.2.3.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=campaign&breakdown=zone-history&clientid={clientid}&campaignid={campaignid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
            ...
            $oMenu->addTo("1.3", new OA_Admin_Menu_Section("1.3.1", $GLOBALS['strDistributionHistoryWebsite'], "stats.php?entity=advertiser&breakdown=affiliate-history&clientid={clientid}&affiliateid={affiliateid}", true, "statistics/publisherDistribution/hisotry"));
            ...
            $oMenu->addTo("1.3", new OA_Admin_Menu_Section("1.3.2", $GLOBALS['strDistributionHistoryZone'], "stats.php?entity=advertiser&breakdown=zone-history&clientid={clientid}&affiliateid={affiliateid}&zoneid={zoneid}", true));
