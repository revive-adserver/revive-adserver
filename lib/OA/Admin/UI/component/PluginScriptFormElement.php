...
class OA_Admin_UI_Component_PluginScriptFormElement extends OA_Admin_UI_Component_CustomPluginFormElement
{
    /**
     * Class constructor
     *
     ...
     */
    public function __construct($elementName = null, $pluginName = null, $vars = null)
    {
