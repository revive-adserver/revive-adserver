...
class OA_Admin_MenuSection
{
     ...
     * @return OA_Admin_MenuSection
     */
    function OA_Admin_MenuSection($id, $name, $link, $helpLink = null, $aAccountPermissions = array(), $rank = 1, $exclusive = false, $affixed = false)
    {
        $this->id = $id;
        $this->name = $name;
        $this->link = $link;
     ...
     * @param OA_ADMIN_MenuSection $newSection
     */
    ...
    function _createSecurityChecker($aAccountPermissionPairs)
    {
        ...
        //        * an array of permissions eg. array(OA_PERM_ZONE_INVOCATION, OA_PERM_SUPER_ACCOUNT)
            ...
            for ($i = 0; $i <  count($aPairAccounts); $i++) {
    			  $checkers[] = &new OA_Admin_AndChecker(
    			    array(
        ...
        return new OA_Admin_OrChecker($checkers);
    }
