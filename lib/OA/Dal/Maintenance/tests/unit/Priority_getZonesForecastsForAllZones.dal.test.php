...
class Test_OA_Dal_Maintenance_Priority_getZonesForecastsForAllZones extends UnitTestCase
{
     ...
     * @access private
     */
    public function _generateTestHistory($idZone, $aDates, $forecast, $actual)
    {
     ...
     * @access private
     */
    public function _generateTestZones($numZones)
    {
     ...
     *         table.
     */
    public function testGetAllZonesImpInv()
    {
        $conf = $GLOBALS['_MAX']['CONF'];
        ...
        $result = $oMaxDalMaintenance->getZonesForecastsForAllZones();
        $this->assertEqual($result, [0 => $zoneForecastDefaultZoneImpressions]); // Zone 0
