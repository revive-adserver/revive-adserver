...
class OA_Dal_Statistics_BannerTest extends DalStatisticsUnitTestCase
{
     ...
     *
     */
    public function testGetBannerDailyStatistics()
    {
    ...
    /**
     * Test banner hourly statistics.
     *
     */
    public function testGetBannerHourlyStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
     ...
     *
     */
    public function testGetBannerPublisherStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
     ...
     *
     */
    public function testGetBannerZoneStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
