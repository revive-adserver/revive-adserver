...
class OA_Dal_Statistics_AdvertiserTest extends DalStatisticsUnitTestCase
{
     ...
     */
    public $_dalAdvertiserStatistics;
     ...
     *
     */
    public function testGetAdvertiserDailyStatistics()
    {
     ...
     *
     */
    public function testGetAdvertiserHourlyStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
     ...
     *
     */
    public function testGetAdvertiserCampaignStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
     ...
     *
     */
    public function testGetAdvertiserBannerStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
     ...
     *
     */
    public function testGetAdvertiserPublisherStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
     ...
     *
     */
    public function testGetAdvertiserZoneStatistics()
    {
        $doAgency = OA_Dal::factoryDO('agency');
        $doAdvertiser = OA_Dal::factoryDO('clients');
        $doCampaign = OA_Dal::factoryDO('campaigns');
