...
class OX_Upgrade_PostUpgradeTask_ControllerTest extends UnitTestCase
{
    public function testgetTasksUrls()
    {
        ...
        $oUpgrade->setReturnValue('getPostUpgradeTasks', ['task_1', 'task_2']);
        ...
        $expected = [
            ['id' => 'task:task_1', 'name' => 'Running task: task_1', 'url' => $baseInstallUrl . 'install-runtask.php?task=task_1'],
            ['id' => 'task:task_2', 'name' => 'Running task: task_2', 'url' => $baseInstallUrl . 'install-runtask.php?task=task_2']];
