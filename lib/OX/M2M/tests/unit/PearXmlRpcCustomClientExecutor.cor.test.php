...
+---------------------------------------------------------------------------+
$Id: mergeCopyTarget55214.tmp 42506 2009-09-02 09:33:27Z lukasz.wikierski $
*/
 ...
 */
class OX_M2M_PearXmlRpcCustomClientExecutorTest extends UnitTestCase
{
    ...
    function testCall()
    {
        ...
        $oXmlRpCExec = new OX_M2M_PearXmlRpcCustomClientExecutor(
                            $oXmlRpcClient);
        ...
        } catch (OX_M2M_PearXmlRpcCustomClientException $e) {
