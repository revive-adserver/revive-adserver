...
class Test_OX_ExtensionCommon extends UnitTestCase
{
    ...
    public function test_cacheComponentHooks()
    {
    ...
    public function test_cachePreferenceOptions()
    {
        $oExtension = new OX_Extension_Common();
    ...
    public function _backupCacheFile($name)
    {
    ...
    public function _restoreCacheFile($name)
    {
        $filename = MAX_PATH . '/var/cache/cache_' . $name;
        if (file_exists($filename)) {
