...
class Test_OX_PluginManager extends UnitTestCase
{
    ...
    public $testpathPlugins = '/lib/OX/Plugin/tests/data/plugins/';
    ...
    public function test_checkPackageContents()
    {
    ...
    public function test_decompressFile()
    {
    ...
    public function test_installPackage()
    {
        ...
        //install
        $this->assertTrue($oPkgMgr->installPackage(['tmp_name' => $file, 'name' => 'testPluginPackage.zip']));
        ...
        // try reinstalling
        $this->assertFalse($oPkgMgr->installPackage(['tmp_name' => $file, 'name' => 'testPluginPackage.zip']));
    ...
    public function test_getPackageDiagnostics()
    {
        $oPkgMgr = new OX_PluginManager();
