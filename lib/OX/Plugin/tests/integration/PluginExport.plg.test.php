...
class Test_OX_PluginExport extends UnitTestCase
{
    ...
    public function test_backupTables()
    {
    ...
    public function test_compileContents_admin_with_schema()
    {
    ...
    public function test_compileContents_extension_no_schema()
    {
    ...
    public function test_compressFiles()
    {
        $dirOut = MAX_PATH . '/var/';
    ...
    public function test_exportPlugin()
    {
        TestEnv::installPluginPackage('openXTests', false);
