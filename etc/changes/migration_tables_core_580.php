...
class Migration_580 extends Migration
{
    public function __construct()
    {
        ...
        $this->aObjectMap['users']['sso_user_id'] = ['fromTable' => 'users', 'fromField' => 'sso_user_id'];
    }



    public function beforeAddField__users__sso_user_id()
    {
        return $this->beforeAddField('users', 'sso_user_id');
    }

    public function afterAddField__users__sso_user_id()
    {
