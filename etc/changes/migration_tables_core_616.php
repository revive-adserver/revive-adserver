...
class Migration_616 extends Migration
{
    ...
    public function beforeRemoveField__banners__an_banner_id()
    {
        return $this->beforeRemoveField('banners', 'an_banner_id');
    }

    public function afterRemoveField__banners__an_banner_id()
    {
        return $this->afterRemoveField('banners', 'an_banner_id');
    }

    public function beforeRemoveField__banners__as_banner_id()
    {
        return $this->beforeRemoveField('banners', 'as_banner_id');
    }

    public function afterRemoveField__banners__as_banner_id()
    {
        return $this->afterRemoveField('banners', 'as_banner_id');
    }

    public function beforeRemoveField__banners__ad_direct_status()
    {
        return $this->beforeRemoveField('banners', 'ad_direct_status');
    }

    public function afterRemoveField__banners__ad_direct_status()
    {
        return $this->afterRemoveField('banners', 'ad_direct_status');
    }

    public function beforeRemoveField__banners__ad_direct_rejection_reason_id()
    {
        return $this->beforeRemoveField('banners', 'ad_direct_rejection_reason_id');
    }

    public function afterRemoveField__banners__ad_direct_rejection_reason_id()
    {
