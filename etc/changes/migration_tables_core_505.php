...
class Migration_505 extends Migration
{
    ...
    public function beforeAlterField__acls_channel__logical()
    {
        return $this->beforeAlterField('acls_channel', 'logical');
    }

    public function afterAlterField__acls_channel__logical()
    {
        return $this->afterAlterField('acls_channel', 'logical');
    }

    public function beforeAddIndex__ad_zone_assoc__ad_zone_assoc_zone_id()
    {
        return $this->beforeAddIndex('ad_zone_assoc', 'ad_zone_assoc_zone_id');
    }

    public function afterAddIndex__ad_zone_assoc__ad_zone_assoc_zone_id()
    {
        return $this->afterAddIndex('ad_zone_assoc', 'ad_zone_assoc_zone_id');
    }

    public function beforeRemoveIndex__ad_zone_assoc__zone_id()
    {
        return $this->beforeRemoveIndex('ad_zone_assoc', 'zone_id');
    }

    public function afterRemoveIndex__ad_zone_assoc__zone_id()
    {
    ...
    public function beforeRemoveIndex__affiliates__agencyid()
    {
        return $this->beforeRemoveIndex('affiliates', 'agencyid');
    }

    public function afterRemoveIndex__affiliates__agencyid()
    {
    ...
    public function beforeRemoveIndex__banners__campaignid()
    {
        return $this->beforeRemoveIndex('banners', 'campaignid');
    }

    public function afterRemoveIndex__banners__campaignid()
    {
    ...
    public function beforeAddIndex__campaigns__campaigns_clientid()
    {
        return $this->beforeAddIndex('campaigns', 'campaigns_clientid');
    }

    public function afterAddIndex__campaigns__campaigns_clientid()
    {
        return $this->afterAddIndex('campaigns', 'campaigns_clientid');
    }

    public function beforeRemoveIndex__campaigns__clientid()
    {
        return $this->beforeRemoveIndex('campaigns', 'clientid');
    }

    public function afterRemoveIndex__campaigns__clientid()
    {
        return $this->afterRemoveIndex('campaigns', 'clientid');
    }

    public function beforeAddIndex__campaigns_trackers__campaigns_trackers_campaignid()
    {
        return $this->beforeAddIndex('campaigns_trackers', 'campaigns_trackers_campaignid');
    }

    public function afterAddIndex__campaigns_trackers__campaigns_trackers_campaignid()
    {
        return $this->afterAddIndex('campaigns_trackers', 'campaigns_trackers_campaignid');
    }

    public function beforeAddIndex__campaigns_trackers__campaigns_trackers_trackerid()
    {
        return $this->beforeAddIndex('campaigns_trackers', 'campaigns_trackers_trackerid');
    }

    public function afterAddIndex__campaigns_trackers__campaigns_trackers_trackerid()
    {
        return $this->afterAddIndex('campaigns_trackers', 'campaigns_trackers_trackerid');
    }

    public function beforeRemoveIndex__campaigns_trackers__campaignid()
    {
        return $this->beforeRemoveIndex('campaigns_trackers', 'campaignid');
    }

    public function afterRemoveIndex__campaigns_trackers__campaignid()
    {
        return $this->afterRemoveIndex('campaigns_trackers', 'campaignid');
    }

    public function beforeRemoveIndex__campaigns_trackers__trackerid()
    {
        return $this->beforeRemoveIndex('campaigns_trackers', 'trackerid');
    }

    public function afterRemoveIndex__campaigns_trackers__trackerid()
    {
    ...
    public function beforeRemoveIndex__clients__agencyid()
    {
        return $this->beforeRemoveIndex('clients', 'agencyid');
    }

    public function afterRemoveIndex__clients__agencyid()
    {
        return $this->afterRemoveIndex('clients', 'agencyid');
    }

    public function beforeAlterField__data_intermediate_ad__total_num_items()
    {
        return $this->beforeAlterField('data_intermediate_ad', 'total_num_items');
    }

    public function afterAlterField__data_intermediate_ad__total_num_items()
    {
    ...
    public function beforeAlterField__data_summary_ad_hourly__total_num_items()
    {
        return $this->beforeAlterField('data_summary_ad_hourly', 'total_num_items');
    }

    public function afterAlterField__data_summary_ad_hourly__total_num_items()
    {
        return $this->afterAlterField('data_summary_ad_hourly', 'total_num_items');
    }

    public function beforeAddIndex__data_summary_zone_country_daily__data_summary_zone_country_daily_day()
    {
        return $this->beforeAddIndex('data_summary_zone_country_daily', 'data_summary_zone_country_daily_day');
    }

    public function afterAddIndex__data_summary_zone_country_daily__data_summary_zone_country_daily_day()
    {
        return $this->afterAddIndex('data_summary_zone_country_daily', 'data_summary_zone_country_daily_day');
    }

    public function beforeAddIndex__data_summary_zone_country_daily__data_summary_zone_country_daily_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_country_daily', 'data_summary_zone_country_daily_zone_id');
    }

    public function afterAddIndex__data_summary_zone_country_daily__data_summary_zone_country_daily_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_country_daily', 'data_summary_zone_country_daily_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_country_daily__day()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_daily', 'day');
    }

    public function afterRemoveIndex__data_summary_zone_country_daily__day()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_daily', 'day');
    }

    public function beforeRemoveIndex__data_summary_zone_country_daily__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_daily', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_country_daily__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_daily', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_country_forecast__data_summary_zone_country_forecast_day_of_week()
    {
        return $this->beforeAddIndex('data_summary_zone_country_forecast', 'data_summary_zone_country_forecast_day_of_week');
    }

    public function afterAddIndex__data_summary_zone_country_forecast__data_summary_zone_country_forecast_day_of_week()
    {
        return $this->afterAddIndex('data_summary_zone_country_forecast', 'data_summary_zone_country_forecast_day_of_week');
    }

    public function beforeAddIndex__data_summary_zone_country_forecast__data_summary_zone_country_forecast_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_country_forecast', 'data_summary_zone_country_forecast_zone_id');
    }

    public function afterAddIndex__data_summary_zone_country_forecast__data_summary_zone_country_forecast_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_country_forecast', 'data_summary_zone_country_forecast_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_country_forecast__day_of_week()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_forecast', 'day_of_week');
    }

    public function afterRemoveIndex__data_summary_zone_country_forecast__day_of_week()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_forecast', 'day_of_week');
    }

    public function beforeRemoveIndex__data_summary_zone_country_forecast__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_forecast', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_country_forecast__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_forecast', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_country_monthly__data_summary_zone_country_monthly_yearmonth()
    {
        return $this->beforeAddIndex('data_summary_zone_country_monthly', 'data_summary_zone_country_monthly_yearmonth');
    }

    public function afterAddIndex__data_summary_zone_country_monthly__data_summary_zone_country_monthly_yearmonth()
    {
        return $this->afterAddIndex('data_summary_zone_country_monthly', 'data_summary_zone_country_monthly_yearmonth');
    }

    public function beforeAddIndex__data_summary_zone_country_monthly__data_summary_zone_country_monthly_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_country_monthly', 'data_summary_zone_country_monthly_zone_id');
    }

    public function afterAddIndex__data_summary_zone_country_monthly__data_summary_zone_country_monthly_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_country_monthly', 'data_summary_zone_country_monthly_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_country_monthly__yearmonth()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_monthly', 'yearmonth');
    }

    public function afterRemoveIndex__data_summary_zone_country_monthly__yearmonth()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_monthly', 'yearmonth');
    }

    public function beforeRemoveIndex__data_summary_zone_country_monthly__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_country_monthly', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_country_monthly__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_country_monthly', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_daily__data_summary_zone_domain_page_daily_day()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_daily', 'data_summary_zone_domain_page_daily_day');
    }

    public function afterAddIndex__data_summary_zone_domain_page_daily__data_summary_zone_domain_page_daily_day()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_daily', 'data_summary_zone_domain_page_daily_day');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_daily__data_summary_zone_domain_page_daily_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_daily', 'data_summary_zone_domain_page_daily_zone_id');
    }

    public function afterAddIndex__data_summary_zone_domain_page_daily__data_summary_zone_domain_page_daily_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_daily', 'data_summary_zone_domain_page_daily_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_daily__day()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_daily', 'day');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_daily__day()
    {
        return $this->afterRemoveIndex('data_summary_zone_domain_page_daily', 'day');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_daily__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_daily', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_daily__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_domain_page_daily', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_forecast__data_summary_zone_domain_page_forecast_day_of_week()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_forecast', 'data_summary_zone_domain_page_forecast_day_of_week');
    }

    public function afterAddIndex__data_summary_zone_domain_page_forecast__data_summary_zone_domain_page_forecast_day_of_week()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_forecast', 'data_summary_zone_domain_page_forecast_day_of_week');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_forecast__data_summary_zone_domain_page_forecast_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_forecast', 'data_summary_zone_domain_page_forecast_zone_id');
    }

    public function afterAddIndex__data_summary_zone_domain_page_forecast__data_summary_zone_domain_page_forecast_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_forecast', 'data_summary_zone_domain_page_forecast_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_forecast__day_of_week()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_forecast', 'day_of_week');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_forecast__day_of_week()
    {
        return $this->afterRemoveIndex('data_summary_zone_domain_page_forecast', 'day_of_week');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_forecast__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_forecast', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_forecast__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_domain_page_forecast', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_monthly__data_summary_zone_domain_page_monthly_yearmonth()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_monthly', 'data_summary_zone_domain_page_monthly_yearmonth');
    }

    public function afterAddIndex__data_summary_zone_domain_page_monthly__data_summary_zone_domain_page_monthly_yearmonth()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_monthly', 'data_summary_zone_domain_page_monthly_yearmonth');
    }

    public function beforeAddIndex__data_summary_zone_domain_page_monthly__data_summary_zone_domain_page_monthly_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_domain_page_monthly', 'data_summary_zone_domain_page_monthly_zone_id');
    }

    public function afterAddIndex__data_summary_zone_domain_page_monthly__data_summary_zone_domain_page_monthly_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_domain_page_monthly', 'data_summary_zone_domain_page_monthly_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_monthly__yearmonth()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_monthly', 'yearmonth');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_monthly__yearmonth()
    {
        return $this->afterRemoveIndex('data_summary_zone_domain_page_monthly', 'yearmonth');
    }

    public function beforeRemoveIndex__data_summary_zone_domain_page_monthly__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_domain_page_monthly', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_domain_page_monthly__zone_id()
    {
    ...
    public function beforeAddIndex__data_summary_zone_site_keyword_daily__data_summary_zone_site_keyword_daily_day()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_daily', 'data_summary_zone_site_keyword_daily_day');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_daily__data_summary_zone_site_keyword_daily_day()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_daily', 'data_summary_zone_site_keyword_daily_day');
    }

    public function beforeAddIndex__data_summary_zone_site_keyword_daily__data_summary_zone_site_keyword_daily_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_daily', 'data_summary_zone_site_keyword_daily_zone_id');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_daily__data_summary_zone_site_keyword_daily_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_daily', 'data_summary_zone_site_keyword_daily_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_daily__day()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_daily', 'day');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_daily__day()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_daily', 'day');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_daily__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_daily', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_daily__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_daily', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_site_keyword_forecast__data_summary_zone_site_keyword_forecast_day_of_week()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_forecast', 'data_summary_zone_site_keyword_forecast_day_of_week');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_forecast__data_summary_zone_site_keyword_forecast_day_of_week()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_forecast', 'data_summary_zone_site_keyword_forecast_day_of_week');
    }

    public function beforeAddIndex__data_summary_zone_site_keyword_forecast__data_summary_zone_site_keyword_forecast_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_forecast', 'data_summary_zone_site_keyword_forecast_zone_id');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_forecast__data_summary_zone_site_keyword_forecast_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_forecast', 'data_summary_zone_site_keyword_forecast_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_forecast__day_of_week()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_forecast', 'day_of_week');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_forecast__day_of_week()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_forecast', 'day_of_week');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_forecast__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_forecast', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_forecast__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_forecast', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_site_keyword_monthly__data_summary_zone_site_keyword_monthly_yearmonth()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_monthly', 'data_summary_zone_site_keyword_monthly_yearmonth');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_monthly__data_summary_zone_site_keyword_monthly_yearmonth()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_monthly', 'data_summary_zone_site_keyword_monthly_yearmonth');
    }

    public function beforeAddIndex__data_summary_zone_site_keyword_monthly__data_summary_zone_site_keyword_monthly_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_site_keyword_monthly', 'data_summary_zone_site_keyword_monthly_zone_id');
    }

    public function afterAddIndex__data_summary_zone_site_keyword_monthly__data_summary_zone_site_keyword_monthly_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_site_keyword_monthly', 'data_summary_zone_site_keyword_monthly_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_monthly__yearmonth()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_monthly', 'yearmonth');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_monthly__yearmonth()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_monthly', 'yearmonth');
    }

    public function beforeRemoveIndex__data_summary_zone_site_keyword_monthly__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_site_keyword_monthly', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_site_keyword_monthly__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_site_keyword_monthly', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_source_daily__data_summary_zone_source_daily_day()
    {
        return $this->beforeAddIndex('data_summary_zone_source_daily', 'data_summary_zone_source_daily_day');
    }

    public function afterAddIndex__data_summary_zone_source_daily__data_summary_zone_source_daily_day()
    {
        return $this->afterAddIndex('data_summary_zone_source_daily', 'data_summary_zone_source_daily_day');
    }

    public function beforeAddIndex__data_summary_zone_source_daily__data_summary_zone_source_daily_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_source_daily', 'data_summary_zone_source_daily_zone_id');
    }

    public function afterAddIndex__data_summary_zone_source_daily__data_summary_zone_source_daily_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_source_daily', 'data_summary_zone_source_daily_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_source_daily__day()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_daily', 'day');
    }

    public function afterRemoveIndex__data_summary_zone_source_daily__day()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_daily', 'day');
    }

    public function beforeRemoveIndex__data_summary_zone_source_daily__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_daily', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_source_daily__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_daily', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_source_forecast__data_summary_zone_source_forecast_day_of_week()
    {
        return $this->beforeAddIndex('data_summary_zone_source_forecast', 'data_summary_zone_source_forecast_day_of_week');
    }

    public function afterAddIndex__data_summary_zone_source_forecast__data_summary_zone_source_forecast_day_of_week()
    {
        return $this->afterAddIndex('data_summary_zone_source_forecast', 'data_summary_zone_source_forecast_day_of_week');
    }

    public function beforeAddIndex__data_summary_zone_source_forecast__data_summary_zone_source_forecast_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_source_forecast', 'data_summary_zone_source_forecast_zone_id');
    }

    public function afterAddIndex__data_summary_zone_source_forecast__data_summary_zone_source_forecast_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_source_forecast', 'data_summary_zone_source_forecast_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_source_forecast__day_of_week()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_forecast', 'day_of_week');
    }

    public function afterRemoveIndex__data_summary_zone_source_forecast__day_of_week()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_forecast', 'day_of_week');
    }

    public function beforeRemoveIndex__data_summary_zone_source_forecast__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_forecast', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_source_forecast__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_forecast', 'zone_id');
    }

    public function beforeAddIndex__data_summary_zone_source_monthly__data_summary_zone_source_monthly_yearmonth()
    {
        return $this->beforeAddIndex('data_summary_zone_source_monthly', 'data_summary_zone_source_monthly_yearmonth');
    }

    public function afterAddIndex__data_summary_zone_source_monthly__data_summary_zone_source_monthly_yearmonth()
    {
        return $this->afterAddIndex('data_summary_zone_source_monthly', 'data_summary_zone_source_monthly_yearmonth');
    }

    public function beforeAddIndex__data_summary_zone_source_monthly__data_summary_zone_source_monthly_zone_id()
    {
        return $this->beforeAddIndex('data_summary_zone_source_monthly', 'data_summary_zone_source_monthly_zone_id');
    }

    public function afterAddIndex__data_summary_zone_source_monthly__data_summary_zone_source_monthly_zone_id()
    {
        return $this->afterAddIndex('data_summary_zone_source_monthly', 'data_summary_zone_source_monthly_zone_id');
    }

    public function beforeRemoveIndex__data_summary_zone_source_monthly__yearmonth()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_monthly', 'yearmonth');
    }

    public function afterRemoveIndex__data_summary_zone_source_monthly__yearmonth()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_monthly', 'yearmonth');
    }

    public function beforeRemoveIndex__data_summary_zone_source_monthly__zone_id()
    {
        return $this->beforeRemoveIndex('data_summary_zone_source_monthly', 'zone_id');
    }

    public function afterRemoveIndex__data_summary_zone_source_monthly__zone_id()
    {
        return $this->afterRemoveIndex('data_summary_zone_source_monthly', 'zone_id');
    }

    public function beforeAddIndex__placement_zone_assoc__placement_zone_assoc_zone_id()
    {
        return $this->beforeAddIndex('placement_zone_assoc', 'placement_zone_assoc_zone_id');
    }

    public function afterAddIndex__placement_zone_assoc__placement_zone_assoc_zone_id()
    {
        return $this->afterAddIndex('placement_zone_assoc', 'placement_zone_assoc_zone_id');
    }

    public function beforeRemoveIndex__placement_zone_assoc__zone_id()
    {
        return $this->beforeRemoveIndex('placement_zone_assoc', 'zone_id');
    }

    public function afterRemoveIndex__placement_zone_assoc__zone_id()
    {
        return $this->afterRemoveIndex('placement_zone_assoc', 'zone_id');
    }

    public function beforeAddIndex__trackers__trackers_clientid()
    {
        return $this->beforeAddIndex('trackers', 'trackers_clientid');
    }

    public function afterAddIndex__trackers__trackers_clientid()
    {
        return $this->afterAddIndex('trackers', 'trackers_clientid');
    }

    public function beforeRemoveIndex__trackers__clientid()
    {
        return $this->beforeRemoveIndex('trackers', 'clientid');
    }

    public function afterRemoveIndex__trackers__clientid()
    {
        return $this->afterRemoveIndex('trackers', 'clientid');
    }

    public function beforeAddIndex__variables__variables_trackerid()
    {
        return $this->beforeAddIndex('variables', 'variables_trackerid');
    }

    public function afterAddIndex__variables__variables_trackerid()
    {
        return $this->afterAddIndex('variables', 'variables_trackerid');
    }

    public function beforeRemoveIndex__variables__trackerid()
    {
        return $this->beforeRemoveIndex('variables', 'trackerid');
    }

    public function afterRemoveIndex__variables__trackerid()
    {
