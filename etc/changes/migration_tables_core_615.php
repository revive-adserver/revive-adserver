...
class Migration_615 extends Migration
{
    ...
    public function beforeRemoveField__affiliates__an_website_id()
    {
        return $this->beforeRemoveField('affiliates', 'an_website_id');
    }

    public function afterRemoveField__affiliates__an_website_id()
    {
        return $this->afterRemoveField('affiliates', 'an_website_id');
    }

    public function beforeRemoveField__affiliates__as_website_id()
    {
        return $this->beforeRemoveField('affiliates', 'as_website_id');
    }

    public function afterRemoveField__affiliates__as_website_id()
    {
