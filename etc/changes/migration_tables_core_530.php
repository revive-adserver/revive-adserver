...
class Migration_530 extends Migration
{
    ...
    public function beforeAddIndex__application_variable__application_variable_pkey()
    {
        return $this->beforeAddIndex('application_variable', 'application_variable_pkey');
    }

    public function afterAddIndex__application_variable__application_variable_pkey()
    {
