...
class migration_tables_core_122Test extends MigrationTest
{
    public function testMigrateData()
    {
        ...
        $this->initDatabase(121, ['clients', 'campaigns']);

        $aCampaigns = [
            ['clientid' => 3, 'parent' => 1, 'views' => '100', 'target' => '1000'],
            ['clientid' => 4, 'parent' => 1, 'views' => '200', 'target' => '1'],
            ['clientid' => 5, 'parent' => 1, 'views' => '200', 'target' => '0'],
        ];
        $cCampaigns = count($aCampaigns);
        $aAValues = [
            ['clientid' => 1, 'parent' => 0, 'views' => '0', 'target' => '0'],
            ['clientid' => 2, 'parent' => 0, 'views' => '0', 'target' => '0'],
        ];
