...
class Migration_546Test extends MigrationTest
{
    ...
    function testMigrateStatus()
    {
        ...
        $this->oDbh->exec("INSERT INTO {$tblAgency} (agencyid, name, contact, email, logout_url, active, updated, account_id) VALUES (1, 'Default account', NULL, '', NULL, 1, '2008-05-16 11:01:56', 2)");
        ...
        $this->oDbh->exec("INSERT INTO {$tblAccounts} (account_id, account_type, account_name) VALUES (1, 'ADMIN', 'System Administrator')");
        $this->oDbh->exec("INSERT INTO {$tblAccounts} (account_id, account_type, account_name) VALUES (2, 'MANAGER', 'Default account')");
