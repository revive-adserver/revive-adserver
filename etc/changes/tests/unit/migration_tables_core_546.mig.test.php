...
class Migration_546Test extends MigrationTest
{
   ...
   function _getPrefsExpectations()
   {
    return array(
                ...
                'ui_column_id' => array('value'=>$this->aPrefsOld['gui_column_id']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_requests' => array('value'=>$this->aPrefsOld['gui_column_requests']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_impressions' => array('value'=>$this->aPrefsOld['gui_column_impressions']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_clicks' => array('value'=>$this->aPrefsOld['gui_column_clicks']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ctr' => array('value'=>$this->aPrefsOld['gui_column_ctr']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions' => array('value'=>$this->aPrefsOld['gui_column_conversions']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions_pending' => array('value'=>$this->aPrefsOld['gui_column_conversions_pending']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_views' => array('value'=>$this->aPrefsOld['gui_column_sr_views']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_clicks' => array('value'=>$this->aPrefsOld['gui_column_sr_clicks']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revenue' => array('value'=>$this->aPrefsOld['gui_column_revenue']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_cost' => array('value'=>$this->aPrefsOld['gui_column_cost']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_bv' => array('value'=>$this->aPrefsOld['gui_column_bv']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_num_items' => array('value'=>$this->aPrefsOld['gui_column_num_items']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revcpc' => array('value'=>$this->aPrefsOld['gui_column_revcpc']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_costcpc' => array('value'=>$this->aPrefsOld['gui_column_costcpc']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_technology_cost' => array('value'=>$this->aPrefsOld['gui_column_technology_cost']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income' => array('value'=>$this->aPrefsOld['gui_column_income']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income_margin' => array('value'=>$this->aPrefsOld['gui_column_income_margin']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_profit' => array('value'=>$this->aPrefsOld['gui_column_profit']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_margin' => array('value'=>$this->aPrefsOld['gui_column_margin']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpm' => array('value'=>$this->aPrefsOld['gui_column_erpm']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpc' => array('value'=>$this->aPrefsOld['gui_column_erpc']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erps' => array('value'=>$this->aPrefsOld['gui_column_erps']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipm' => array('value'=>$this->aPrefsOld['gui_column_eipm']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipc' => array('value'=>$this->aPrefsOld['gui_column_eipc']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eips' => array('value'=>$this->aPrefsOld['gui_column_eips']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpm' => array('value'=>$this->aPrefsOld['gui_column_ecpm']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpc' => array('value'=>$this->aPrefsOld['gui_column_ecpc']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecps' => array('value'=>$this->aPrefsOld['gui_column_ecps']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_epps' => array('value'=>$this->aPrefsOld['gui_column_epps']['show'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_id_label' => array('value'=>$this->aPrefsOld['gui_column_id']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_requests_label' => array('value'=>$this->aPrefsOld['gui_column_requests']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_impressions_label' => array('value'=>$this->aPrefsOld['gui_column_impressions']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_clicks_label' => array('value'=>$this->aPrefsOld['gui_column_clicks']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ctr_label' => array('value'=>$this->aPrefsOld['gui_column_ctr']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions_label' => array('value'=>$this->aPrefsOld['gui_column_conversions']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions_pending_label' => array('value'=>$this->aPrefsOld['gui_column_conversions_pending']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_views_label' => array('value'=>$this->aPrefsOld['gui_column_sr_views']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_clicks_label' => array('value'=>$this->aPrefsOld['gui_column_sr_clicks']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revenue_label' => array('value'=>$this->aPrefsOld['gui_column_revenue']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_cost_label' => array('value'=>$this->aPrefsOld['gui_column_cost']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_bv_label' => array('value'=>$this->aPrefsOld['gui_column_bv']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_num_items_label' => array('value'=>$this->aPrefsOld['gui_column_num_items']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revcpc_label' => array('value'=>$this->aPrefsOld['gui_column_revcpc']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_costcpc_label' => array('value'=>$this->aPrefsOld['gui_column_costcpc']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_technology_cost_label' => array('value'=>$this->aPrefsOld['gui_column_technology_cost']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income_label' => array('value'=>$this->aPrefsOld['gui_column_income']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income_margin_label' => array('value'=>$this->aPrefsOld['gui_column_income_margin']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_profit_label' => array('value'=>$this->aPrefsOld['gui_column_profit']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_margin_label' => array('value'=>$this->aPrefsOld['gui_column_margin']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpm_label' => array('value'=>$this->aPrefsOld['gui_column_erpm']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpc_label' => array('value'=>$this->aPrefsOld['gui_column_erpc']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erps_label' => array('value'=>$this->aPrefsOld['gui_column_erps']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipm_label' => array('value'=>$this->aPrefsOld['gui_column_eipm']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipc_label' => array('value'=>$this->aPrefsOld['gui_column_eipc']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eips_label' => array('value'=>$this->aPrefsOld['gui_column_eips']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpm_label' => array('value'=>$this->aPrefsOld['gui_column_ecpm']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpc_label' => array('value'=>$this->aPrefsOld['gui_column_ecpc']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecps_label' => array('value'=>$this->aPrefsOld['gui_column_ecps']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_epps_label' => array('value'=>$this->aPrefsOld['gui_column_epps']['label'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_id_rank' => array('value'=>$this->aPrefsOld['gui_column_id']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_requests_rank' => array('value'=>$this->aPrefsOld['gui_column_requests']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_impressions_rank' => array('value'=>$this->aPrefsOld['gui_column_impressions']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_clicks_rank' => array('value'=>$this->aPrefsOld['gui_column_clicks']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ctr_rank' => array('value'=>$this->aPrefsOld['gui_column_ctr']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions_rank' => array('value'=>$this->aPrefsOld['gui_column_conversions']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_conversions_pending_rank' => array('value'=>$this->aPrefsOld['gui_column_conversions_pending']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_views_rank' => array('value'=>$this->aPrefsOld['gui_column_sr_views']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_sr_clicks_rank' => array('value'=>$this->aPrefsOld['gui_column_sr_clicks']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revenue_rank' => array('value'=>$this->aPrefsOld['gui_column_revenue']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_cost_rank' => array('value'=>$this->aPrefsOld['gui_column_cost']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_bv_rank' => array('value'=>$this->aPrefsOld['gui_column_bv']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_num_items_rank' => array('value'=>$this->aPrefsOld['gui_column_num_items']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_revcpc_rank' => array('value'=>$this->aPrefsOld['gui_column_revcpc']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_costcpc_rank' => array('value'=>$this->aPrefsOld['gui_column_costcpc']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_technology_cost_rank' => array('value'=>$this->aPrefsOld['gui_column_technology_cost']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income_rank' => array('value'=>$this->aPrefsOld['gui_column_income']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_income_margin_rank' => array('value'=>$this->aPrefsOld['gui_column_income_margin']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_profit_rank' => array('value'=>$this->aPrefsOld['gui_column_profit']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_margin_rank' => array('value'=>$this->aPrefsOld['gui_column_margin']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpm_rank' => array('value'=>$this->aPrefsOld['gui_column_erpm']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erpc_rank' => array('value'=>$this->aPrefsOld['gui_column_erpc']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_erps_rank' => array('value'=>$this->aPrefsOld['gui_column_erps']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipm_rank' => array('value'=>$this->aPrefsOld['gui_column_eipm']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eipc_rank' => array('value'=>$this->aPrefsOld['gui_column_eipc']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_eips_rank' => array('value'=>$this->aPrefsOld['gui_column_eips']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpm_rank' => array('value'=>$this->aPrefsOld['gui_column_ecpm']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecpc_rank' => array('value'=>$this->aPrefsOld['gui_column_ecpc']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_ecps_rank' => array('value'=>$this->aPrefsOld['gui_column_ecps']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
                'ui_column_epps_rank' => array('value'=>$this->aPrefsOld['gui_column_epps']['rank'], 'level'=>OA_ACCOUNT_MANAGER),
