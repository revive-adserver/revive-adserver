...
class Test_postscript_2_7_11_dev extends UnitTestCase
{
    ...
    public function _assertTestData($aExpectation)
    {
    ...
    public function _generateTestData()
    {
        ...
        $result[$campaignId1] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPM];
        ...
        $result[$campaignId2] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPC];
        ...
        $result[$campaignId3] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPA];
        ...
        $result[$campaignId4] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPM];
        ...
        $result[$campaignId5] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPC];
        ...
        $result[$campaignId6] = ['campaignname' => $doCampaigns->campaignname, 'revenue_type' => MAX_FINANCE_CPA];
