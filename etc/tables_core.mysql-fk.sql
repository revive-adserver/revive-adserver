...
CREATE TABLE IF NOT EXISTS clients (
  ...
  agencyid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  ...
  FOREIGN KEY (agencyid) REFERENCES agency (agencyid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS campaigns (
  campaignid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS banners (
  bannerid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  campaignid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  active ENUM('t','f') NOT NULL DEFAULT 't',
  ...
  FOREIGN KEY (campaignid) REFERENCES campaigns (campaignid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (filename) REFERENCES images (filename) ON UPDATE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS affiliates (
  affiliateid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  agencyid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  name VARCHAR(255) NOT NULL DEFAULT '',
  ...
  INDEX agencyid (agencyid),
  FOREIGN KEY (affiliateid) REFERENCES affiliates (affiliateid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (agencyid) REFERENCES agency (agencyid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS zones (
  zoneid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  affiliateid INTEGER UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS channel (
  channelid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  agencyid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  affiliateid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  name VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS trackers (
  trackerid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS variables (
  variableid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  trackerid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  ...
  FOREIGN KEY (trackerid) REFERENCES trackers (trackerid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS acls_channel (
  channelid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  logical VARCHAR(3) NOT NULL DEFAULT 'and',
  type VARCHAR(32) NOT NULL DEFAULT '',
  comparison CHAR(2) NOT NULL DEFAULT '==',
  data TEXT NOT NULL,
  ...
  FOREIGN KEY (channelid) REFERENCES channel (channelid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS ad_category_assoc (
  ...
  FOREIGN KEY (ad_id) REFERENCES banners (bannerid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (category_id) REFERENCES category (category_id) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS ad_zone_assoc (
  ad_zone_assoc_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  zone_id INTEGER UNSIGNED DEFAULT NULL,
  ad_id INTEGER UNSIGNED DEFAULT NULL,
  priority DOUBLE NULL DEFAULT 0,
  link_type SMALLINT(6) NOT NULL DEFAULT 1,
  PRIMARY KEY (ad_zone_assoc_id),
  INDEX zone_id (zone_id),
  INDEX ad_id (ad_id),
  FOREIGN KEY (zone_id) REFERENCES zones (zoneid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (ad_id) REFERENCES banners (bannerid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS affiliates_extra (
  affiliateid INTEGER UNSIGNED NOT NULL,
  address TEXT,
  city VARCHAR(255),
  postcode VARCHAR(64),
  country VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS campaigns_trackers (
  campaign_trackerid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  campaignid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  trackerid INTEGER UNSIGNED NOT NULL DEFAULT '0',
  viewwindow MEDIUMINT(9) NOT NULL DEFAULT '0',
  clickwindow MEDIUMINT(9) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS data_intermediate_ad_connection (
  ...
  FOREIGN KEY (ad_id) REFERENCES banners (bannerid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (zone_id) REFERENCES zones (zoneid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (tracker_id) REFERENCES trackers (trackerid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS data_intermediate_ad_variable_value (
  ...
  tracker_variable_id INTEGER UNSIGNED NOT NULL,
  ...
  FOREIGN KEY (data_intermediate_ad_connection_id) REFERENCES data_intermediate_ad_connection (data_intermediate_ad_connection_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (tracker_variable_id) REFERENCES variables (variableid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS data_summary_channel_daily (
  ...
  FOREIGN KEY (channel_id) REFERENCES channel (channelid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (zone_id) REFERENCES zones (zoneid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS placement_zone_assoc (
  placement_zone_assoc_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  zone_id INTEGER UNSIGNED DEFAULT NULL,
  placement_id INTEGER UNSIGNED DEFAULT NULL,
  PRIMARY KEY (placement_zone_assoc_id),
  INDEX zone_id (zone_id),
  INDEX placement_id (placement_id),
  FOREIGN KEY (placement_id) REFERENCES campaigns (campaignid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS plugins_channel_delivery_assoc (
  ...
  FOREIGN KEY (rule_id) REFERENCES plugins_channel_delivery_rules (rule_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (domain_id) REFERENCES plugins_channel_delivery_domains (domain_id) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS preference_advertiser (
  ...
  FOREIGN KEY (advertiser_id) REFERENCES clients (clientid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS preference_publisher (
  ...
  FOREIGN KEY (publisher_id) REFERENCES affiliates (affiliateid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
...
CREATE TABLE IF NOT EXISTS tracker_append (
  tracker_append_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  tracker_id INTEGER UNSIGNED NOT NULL DEFAULT '0',
  rank INT(11) NOT NULL DEFAULT '0',
  tagcode TEXT NOT NULL,
  paused ENUM('t','f') NOT NULL DEFAULT 'f',
  autotrack ENUM('t', 'f') NOT NULL DEFAULT 'f',
  PRIMARY KEY (tracker_append_id),
  INDEX (tracker_id, rank),
  FOREIGN KEY (tracker_id) REFERENCES trackers (trackerid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;

CREATE TABLE IF NOT EXISTS userlog (
  userlogid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS variable_publisher (
  ...
  FOREIGN KEY (variable_id) REFERENCES variables (variableid) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (publisher_id) REFERENCES affiliates (affiliateid) ON UPDATE CASCADE ON DELETE CASCADE
) TYPE=InnoDB;
