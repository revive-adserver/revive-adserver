...
username                            =
password                            =
name                                = max_simpletest ; Don't set this to be your Max
                                                     ; database - the test database is
                                                     ; often dropped during testing!
persistent                          = false


[database_cc_MySQL-5.0.373]
#[database]
type                                = mysql
version                             = 5.0.373
host                                = build.openads.org
port                                = 3308
...
#if setting a pgsql db don't forget to set
#[table]
#type = ''

[database_cc_PostgreSQ- 8.0.12]
#[database]
type                                = pgsql
version                             = 8.0.12
host                                = build.openads.org
...
;------------------------------------------------------------------------------------------;
; To make the web-test suite function the entries below must reference valid virtual hosts ;
; and there must be a <hostname>.conf.ini file containing the single line: realConfig=test ;
;------------------------------------------------------------------------------------------;
...
paramsUsername      =
paramsPassword      =
fileMode            = 0666 ; The commandline runner and the Web runner both need write access
...
;------------------------------------------------------------------------------------------;
; Load balancing / Distributed stats                                                       ;
;------------------------------------------------------------------------------------------;
